...
/** @internal */
export const ArtifactQueryResponseBody1$inboundSchema = z.object({
    size: types.number(),
...
/** @internal */
export const ArtifactQueryResponseBody1$outboundSchema = z.object({
    size: z.number(),
...
export function artifactQueryResponseBody1ToJSON(artifactQueryResponseBody1) {
    return JSON.stringify(ArtifactQueryResponseBody1$outboundSchema.parse(artifactQueryResponseBody1));
}
export function artifactQueryResponseBody1FromJSON(jsonString) {
    return safeParse(jsonString, (x) => ArtifactQueryResponseBody1$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ArtifactQueryResponseBody1' from JSON`);
}
/** @internal */
