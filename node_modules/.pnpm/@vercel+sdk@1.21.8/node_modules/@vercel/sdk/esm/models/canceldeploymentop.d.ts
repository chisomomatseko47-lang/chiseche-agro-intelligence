...
/** @internal */
export declare const CancelDeploymentGitSourceDeploymentsResponse200ApplicationJSONResponseBody17Type$outboundSchema: z.ZodNativeEnum<typeof CancelDeploymentGitSourceDeploymentsResponse200ApplicationJSONResponseBody17Type>;
/** @internal */
...
/** @internal */
export declare const GitSource17$outboundSchema: z.ZodType<GitSource17$Outbound, z.ZodTypeDef, GitSource17>;
export declare function gitSource17ToJSON(gitSource17: GitSource17): string;
...
/** @internal */
export declare const CancelDeploymentGitSourceDeploymentsResponse200ApplicationJSONResponseBody16Type$outboundSchema: z.ZodNativeEnum<typeof CancelDeploymentGitSourceDeploymentsResponse200ApplicationJSONResponseBody16Type>;
/** @internal */
...
/** @internal */
export declare const GitSource16$outboundSchema: z.ZodType<GitSource16$Outbound, z.ZodTypeDef, GitSource16>;
export declare function gitSource16ToJSON(gitSource16: GitSource16): string;
...
/** @internal */
export declare const CancelDeploymentGitSource8$outboundSchema: z.ZodType<CancelDeploymentGitSource8$Outbound, z.ZodTypeDef, CancelDeploymentGitSource8>;
export declare function cancelDeploymentGitSource8ToJSON(cancelDeploymentGitSource8: CancelDeploymentGitSource8): string;
...
/** @internal */
export type CancelDeploymentGitSource$Outbound = GitSource13$Outbound | GitSource16$Outbound | GitSource17$Outbound | CancelDeploymentGitSource4$Outbound | GitSource11$Outbound | GitSource12$Outbound | GitSource14$Outbound | GitSource15$Outbound | CancelDeploymentGitSource2$Outbound | CancelDeploymentGitSource3$Outbound | CancelDeploymentGitSource6$Outbound | GitSource9$Outbound | CancelDeploymentGitSource1$Outbound | CancelDeploymentGitSource5$Outbound | CancelDeploymentGitSource7$Outbound | CancelDeploymentGitSource8$Outbound | GitSource10$Outbound;
/** @internal */
...
/** @internal */
export declare const CancelDeploymentMaxDuration2$outboundSchema: z.ZodNativeEnum<typeof CancelDeploymentMaxDuration2>;
/** @internal */
...
/** @internal */
export declare const CancelDeploymentMaxDuration$outboundSchema: z.ZodType<CancelDeploymentMaxDuration$Outbound, z.ZodTypeDef, CancelDeploymentMaxDuration>;
export declare function cancelDeploymentMaxDurationToJSON(cancelDeploymentMaxDuration: CancelDeploymentMaxDuration): string;
...
/** @internal */
export declare const CancelDeploymentGitRepoDeploymentsResponse200OwnerType$outboundSchema: z.ZodNativeEnum<typeof CancelDeploymentGitRepoDeploymentsResponse200OwnerType>;
/** @internal */
...
/** @internal */
export declare const CancelDeploymentGitRepo4$outboundSchema: z.ZodType<CancelDeploymentGitRepo4$Outbound, z.ZodTypeDef, CancelDeploymentGitRepo4>;
export declare function cancelDeploymentGitRepo4ToJSON(cancelDeploymentGitRepo4: CancelDeploymentGitRepo4): string;
...
/** @internal */
export type CancelDeploymentGitRepo$Outbound = CancelDeploymentGitRepo1$Outbound | CancelDeploymentGitRepo2$Outbound | CancelDeploymentGitRepo3$Outbound | CancelDeploymentGitRepo4$Outbound;
/** @internal */
...
/** @internal */
export declare const CancelDeploymentGitUserId$outboundSchema: z.ZodType<CancelDeploymentGitUserId$Outbound, z.ZodTypeDef, CancelDeploymentGitUserId>;
export declare function cancelDeploymentGitUserIdToJSON(cancelDeploymentGitUserId: CancelDeploymentGitUserId): string;
...
/** @internal */
export declare const CancelDeploymentGitProvider$outboundSchema: z.ZodNativeEnum<typeof CancelDeploymentGitProvider>;
/** @internal */
...
/** @internal */
export declare const CancelDeploymentCommitMeta$outboundSchema: z.ZodType<CancelDeploymentCommitMeta$Outbound, z.ZodTypeDef, CancelDeploymentCommitMeta>;
export declare function cancelDeploymentCommitMetaToJSON(cancelDeploymentCommitMeta: CancelDeploymentCommitMeta): string;
...
/** @internal */
export declare const CancelDeploymentId$outboundSchema: z.ZodType<CancelDeploymentId$Outbound, z.ZodTypeDef, CancelDeploymentId>;
export declare function cancelDeploymentIdToJSON(cancelDeploymentId: CancelDeploymentId): string;
...
/** @internal */
export declare const CancelDeploymentGitUser$outboundSchema: z.ZodType<CancelDeploymentGitUser$Outbound, z.ZodTypeDef, CancelDeploymentGitUser>;
export declare function cancelDeploymentGitUserToJSON(cancelDeploymentGitUser: CancelDeploymentGitUser): string;
...
/** @internal */
export declare const CancelDeploymentVercelUser$outboundSchema: z.ZodType<CancelDeploymentVercelUser$Outbound, z.ZodTypeDef, CancelDeploymentVercelUser>;
export declare function cancelDeploymentVercelUserToJSON(cancelDeploymentVercelUser: CancelDeploymentVercelUser): string;
...
/** @internal */
export declare const CancelDeploymentAttribution$outboundSchema: z.ZodType<CancelDeploymentAttribution$Outbound, z.ZodTypeDef, CancelDeploymentAttribution>;
export declare function cancelDeploymentAttributionToJSON(cancelDeploymentAttribution: CancelDeploymentAttribution): string;
...
export type CancelDeploymentResponseBody$Outbound = {
    ...
    errorStep?: string | undefined;
    passiveRegions?: Array<string> | undefined;
    gitSource?: GitSource13$Outbound | GitSource16$Outbound | GitSource17$Outbound | CancelDeploymentGitSource4$Outbound | GitSource11$Outbound | GitSource12$Outbound | GitSource14$Outbound | GitSource15$Outbound | CancelDeploymentGitSource2$Outbound | CancelDeploymentGitSource3$Outbound | CancelDeploymentGitSource6$Outbound | GitSource9$Outbound | CancelDeploymentGitSource1$Outbound | CancelDeploymentGitSource5$Outbound | CancelDeploymentGitSource7$Outbound | CancelDeploymentGitSource8$Outbound | GitSource10$Outbound | undefined;
    ...
    gitRepo?: CancelDeploymentGitRepo1$Outbound | CancelDeploymentGitRepo2$Outbound | CancelDeploymentGitRepo3$Outbound | CancelDeploymentGitRepo4$Outbound | null | undefined;
