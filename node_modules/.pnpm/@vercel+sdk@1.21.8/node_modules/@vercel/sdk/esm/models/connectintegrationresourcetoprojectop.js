...
/** @internal */
export const EnvVarEnvironments$inboundSchema = z.nativeEnum(EnvVarEnvironments);
/** @internal */
export const EnvVarEnvironments$outboundSchema = EnvVarEnvironments$inboundSchema;
/** @internal */
export const ConnectIntegrationResourceToProjectRequestBody$inboundSchema = z.object({
    projectId: types.string(),
    envVarEnvironments: types.optional(z.array(EnvVarEnvironments$inboundSchema)),
