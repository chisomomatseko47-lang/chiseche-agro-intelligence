...
export declare const ProjectAccessManagedBy: {
...
/** @internal */
export declare const ResponseBodyAiGateway$inboundSchema: z.ZodType<ResponseBodyAiGateway, z.ZodTypeDef, unknown>;
/** @internal */
export type ResponseBodyAiGateway$Outbound = {};
/** @internal */
export declare const ResponseBodyAiGateway$outboundSchema: z.ZodType<ResponseBodyAiGateway$Outbound, z.ZodTypeDef, ResponseBodyAiGateway>;
export declare function responseBodyAiGatewayToJSON(responseBodyAiGateway: ResponseBodyAiGateway): string;
export declare function responseBodyAiGatewayFromJSON(jsonString: string): SafeParseResult<ResponseBodyAiGateway, SDKValidationError>;
/** @internal */
export declare const ResponseBodyAuditLog$inboundSchema: z.ZodType<ResponseBodyAuditLog, z.ZodTypeDef, unknown>;
/** @internal */
export type ResponseBodyAuditLog$Outbound = {};
/** @internal */
export declare const ResponseBodyAuditLog$outboundSchema: z.ZodType<ResponseBodyAuditLog$Outbound, z.ZodTypeDef, ResponseBodyAuditLog>;
export declare function responseBodyAuditLogToJSON(responseBodyAuditLog: ResponseBodyAuditLog): string;
export declare function responseBodyAuditLogFromJSON(jsonString: string): SafeParseResult<ResponseBodyAuditLog, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const CreateDrainDeliveryDrainsResponseEndpoint$inboundSchema: z.ZodType<CreateDrainDeliveryDrainsResponseEndpoint, z.ZodTypeDef, unknown>;
/** @internal */
export type CreateDrainDeliveryDrainsResponseEndpoint$Outbound = {
    traces: string;
};
/** @internal */
export declare const CreateDrainDeliveryDrainsResponseEndpoint$outboundSchema: z.ZodType<CreateDrainDeliveryDrainsResponseEndpoint$Outbound, z.ZodTypeDef, CreateDrainDeliveryDrainsResponseEndpoint>;
export declare function createDrainDeliveryDrainsResponseEndpointToJSON(createDrainDeliveryDrainsResponseEndpoint: CreateDrainDeliveryDrainsResponseEndpoint): string;
export declare function createDrainDeliveryDrainsResponseEndpointFromJSON(jsonString: string): SafeParseResult<CreateDrainDeliveryDrainsResponseEndpoint, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const ProjectAccessManagedBy$inboundSchema: z.ZodNativeEnum<typeof ProjectAccessManagedBy>;
/** @internal */
export declare const ProjectAccessManagedBy$outboundSchema: z.ZodNativeEnum<typeof ProjectAccessManagedBy>;
/** @internal */
...
/** @internal */
export declare const ManagedBy$inboundSchema: z.ZodNativeEnum<typeof ManagedBy>;
/** @internal */
export declare const ManagedBy$outboundSchema: z.ZodNativeEnum<typeof ManagedBy>;
/** @internal */
...
/** @internal */
export declare const AiGateway$inboundSchema: z.ZodType<AiGateway, z.ZodTypeDef, unknown>;
/** @internal */
export type AiGateway$Outbound = {};
/** @internal */
export declare const AiGateway$outboundSchema: z.ZodType<AiGateway$Outbound, z.ZodTypeDef, AiGateway>;
export declare function aiGatewayToJSON(aiGateway: AiGateway): string;
export declare function aiGatewayFromJSON(jsonString: string): SafeParseResult<AiGateway, SDKValidationError>;
/** @internal */
export declare const AuditLog$inboundSchema: z.ZodType<AuditLog, z.ZodTypeDef, unknown>;
/** @internal */
export type AuditLog$Outbound = {};
/** @internal */
export declare const AuditLog$outboundSchema: z.ZodType<AuditLog$Outbound, z.ZodTypeDef, AuditLog>;
export declare function auditLogToJSON(auditLog: AuditLog): string;
