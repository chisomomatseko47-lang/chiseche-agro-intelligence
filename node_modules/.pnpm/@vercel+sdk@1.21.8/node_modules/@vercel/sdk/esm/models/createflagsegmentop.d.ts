...
/** @internal */
export declare const CreateFlagSegmentCmpOptions$inboundSchema: z.ZodType<CreateFlagSegmentCmpOptions, z.ZodTypeDef, unknown>;
/** @internal */
export type CreateFlagSegmentCmpOptions$Outbound = {
    ignoreCase?: boolean | undefined;
};
/** @internal */
export declare const CreateFlagSegmentCmpOptions$outboundSchema: z.ZodType<CreateFlagSegmentCmpOptions$Outbound, z.ZodTypeDef, CreateFlagSegmentCmpOptions>;
export declare function createFlagSegmentCmpOptionsToJSON(createFlagSegmentCmpOptions: CreateFlagSegmentCmpOptions): string;
export declare function createFlagSegmentCmpOptionsFromJSON(jsonString: string): SafeParseResult<CreateFlagSegmentCmpOptions, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const CreateFlagSegmentFeatureFlagsCmpOptions$inboundSchema: z.ZodType<CreateFlagSegmentFeatureFlagsCmpOptions, z.ZodTypeDef, unknown>;
/** @internal */
export type CreateFlagSegmentFeatureFlagsCmpOptions$Outbound = {
    ignoreCase?: boolean | undefined;
};
/** @internal */
export declare const CreateFlagSegmentFeatureFlagsCmpOptions$outboundSchema: z.ZodType<CreateFlagSegmentFeatureFlagsCmpOptions$Outbound, z.ZodTypeDef, CreateFlagSegmentFeatureFlagsCmpOptions>;
export declare function createFlagSegmentFeatureFlagsCmpOptionsToJSON(createFlagSegmentFeatureFlagsCmpOptions: CreateFlagSegmentFeatureFlagsCmpOptions): string;
export declare function createFlagSegmentFeatureFlagsCmpOptionsFromJSON(jsonString: string): SafeParseResult<CreateFlagSegmentFeatureFlagsCmpOptions, SDKValidationError>;
/** @internal */
