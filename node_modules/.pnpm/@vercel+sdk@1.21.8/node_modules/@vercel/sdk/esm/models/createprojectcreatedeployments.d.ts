...
export type CreateProjectProjectsTo = CreateProjectToProjects1 | CreateProjectToProjects2;
/**
...
export declare const CreateProjectToProjectsPreset: {
    readonly AllCustom: "all-custom";
};
export type CreateProjectToProjectsPreset = ClosedEnum<typeof CreateProjectToProjectsPreset>;
/**
 * The target envs on the current project that may be accessed.
 */
...
export declare const CreateProjectToPreset: {
    readonly AllCustom: "all-custom";
};
...
export type CreateProjectTrustedSources = {
    projects?: {
        [k: string]: CreateProjectProjects;
    } | undefined;
    oidcProviders?: {
...
/** @internal */
export declare const CreateProjectSource$outboundSchema: z.ZodNativeEnum<typeof CreateProjectSource>;
/** @internal */
...
/** @internal */
export declare const DelegatedProtection$inboundSchema: z.ZodType<DelegatedProtection, z.ZodTypeDef, unknown>;
/** @internal */
export type DelegatedProtection$Outbound = {};
/** @internal */
export declare const DelegatedProtection$outboundSchema: z.ZodType<DelegatedProtection$Outbound, z.ZodTypeDef, DelegatedProtection>;
export declare function delegatedProtectionToJSON(delegatedProtection: DelegatedProtection): string;
export declare function delegatedProtectionFromJSON(jsonString: string): SafeParseResult<DelegatedProtection, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const CreateProjectLint$outboundSchema: z.ZodType<CreateProjectLint$Outbound, z.ZodTypeDef, CreateProjectLint>;
export declare function createProjectLintToJSON(createProjectLint: CreateProjectLint): string;
...
/** @internal */
export declare const CreateProjectTypecheck$outboundSchema: z.ZodType<CreateProjectTypecheck$Outbound, z.ZodTypeDef, CreateProjectTypecheck>;
export declare function createProjectTypecheckToJSON(createProjectTypecheck: CreateProjectTypecheck): string;
...
/** @internal */
export declare const Jobs$outboundSchema: z.ZodType<Jobs$Outbound, z.ZodTypeDef, Jobs>;
export declare function jobsToJSON(jobs: Jobs): string;
...
/** @internal */
export declare const Link6$outboundSchema: z.ZodType<Link6$Outbound, z.ZodTypeDef, Link6>;
export declare function link6ToJSON(link6: Link6): string;
...
/** @internal */
export type Link$Outbound = Link1$Outbound | Link2$Outbound | Link3$Outbound | Link4$Outbound | Link5$Outbound | Link6$Outbound;
/** @internal */
...
/** @internal */
export declare const CreateProjectFromPreset$outboundSchema: z.ZodNativeEnum<typeof CreateProjectFromPreset>;
/** @internal */
...
/** @internal */
export declare const CreateProjectFrom2$outboundSchema: z.ZodType<CreateProjectFrom2$Outbound, z.ZodTypeDef, CreateProjectFrom2>;
export declare function createProjectFrom2ToJSON(createProjectFrom2: CreateProjectFrom2): string;
...
/** @internal */
export declare const CreateProjectFromProjectsPreset$outboundSchema: z.ZodNativeEnum<typeof CreateProjectFromProjectsPreset>;
/** @internal */
...
/** @internal */
export declare const CreateProjectFrom1$outboundSchema: z.ZodType<CreateProjectFrom1$Outbound, z.ZodTypeDef, CreateProjectFrom1>;
export declare function createProjectFrom1ToJSON(createProjectFrom1: CreateProjectFrom1): string;
...
/** @internal */
export type CreateProjectFrom$Outbound = CreateProjectFrom1$Outbound | CreateProjectFrom2$Outbound;
/** @internal */
export declare const CreateProjectFrom$outboundSchema: z.ZodType<CreateProjectFrom$Outbound, z.ZodTypeDef, CreateProjectFrom>;
export declare function createProjectFromToJSON(createProjectFrom: CreateProjectFrom): string;
...
/** @internal */
export declare const CreateProjectToProjectsResponse200Preset$outboundSchema: z.ZodNativeEnum<typeof CreateProjectToProjectsResponse200Preset>;
/** @internal */
...
/** @internal */
export declare const CreateProjectToProjects2$outboundSchema: z.ZodType<CreateProjectToProjects2$Outbound, z.ZodTypeDef, CreateProjectToProjects2>;
export declare function createProjectToProjects2ToJSON(createProjectToProjects2: CreateProjectToProjects2): string;
...
/** @internal */
export declare const CreateProjectToProjectsResponsePreset$outboundSchema: z.ZodNativeEnum<typeof CreateProjectToProjectsResponsePreset>;
/** @internal */
export declare const CreateProjectToProjects1$inboundSchema: z.ZodType<CreateProjectToProjects1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CreateProjectToProjects1$outboundSchema: z.ZodType<CreateProjectToProjects1$Outbound, z.ZodTypeDef, CreateProjectToProjects1>;
export declare function createProjectToProjects1ToJSON(createProjectToProjects1: CreateProjectToProjects1): string;
export declare function createProjectToProjects1FromJSON(jsonString: string): SafeParseResult<CreateProjectToProjects1, SDKValidationError>;
/** @internal */
export declare const CreateProjectProjectsTo$inboundSchema: z.ZodType<CreateProjectProjectsTo, z.ZodTypeDef, unknown>;
/** @internal */
export type CreateProjectProjectsTo$Outbound = CreateProjectToProjects1$Outbound | CreateProjectToProjects2$Outbound;
/** @internal */
export declare const CreateProjectProjectsTo$outboundSchema: z.ZodType<CreateProjectProjectsTo$Outbound, z.ZodTypeDef, CreateProjectProjectsTo>;
export declare function createProjectProjectsToToJSON(createProjectProjectsTo: CreateProjectProjectsTo): string;
export declare function createProjectProjectsToFromJSON(jsonString: string): SafeParseResult<CreateProjectProjectsTo, SDKValidationError>;
/** @internal */
export declare const CreateProjectCustomAllow$inboundSchema: z.ZodType<CreateProjectCustomAllow, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CreateProjectCustomAllow$outboundSchema: z.ZodType<CreateProjectCustomAllow$Outbound, z.ZodTypeDef, CreateProjectCustomAllow>;
export declare function createProjectCustomAllowToJSON(createProjectCustomAllow: CreateProjectCustomAllow): string;
export declare function createProjectCustomAllowFromJSON(jsonString: string): SafeParseResult<CreateProjectCustomAllow, SDKValidationError>;
/** @internal */
export declare const CreateProjectProjects$inboundSchema: z.ZodType<CreateProjectProjects, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CreateProjectProjects$outboundSchema: z.ZodType<CreateProjectProjects$Outbound, z.ZodTypeDef, CreateProjectProjects>;
export declare function createProjectProjectsToJSON(createProjectProjects: CreateProjectProjects): string;
export declare function createProjectProjectsFromJSON(jsonString: string): SafeParseResult<CreateProjectProjects, SDKValidationError>;
/** @internal */
export declare const CreateProjectToProjectsPreset$inboundSchema: z.ZodNativeEnum<typeof CreateProjectToProjectsPreset>;
/** @internal */
export declare const CreateProjectToProjectsPreset$outboundSchema: z.ZodNativeEnum<typeof CreateProjectToProjectsPreset>;
/** @internal */
export declare const CreateProjectTo2$inboundSchema: z.ZodType<CreateProjectTo2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CreateProjectTo2$outboundSchema: z.ZodType<CreateProjectTo2$Outbound, z.ZodTypeDef, CreateProjectTo2>;
export declare function createProjectTo2ToJSON(createProjectTo2: CreateProjectTo2): string;
export declare function createProjectTo2FromJSON(jsonString: string): SafeParseResult<CreateProjectTo2, SDKValidationError>;
/** @internal */
export declare const CreateProjectToPreset$inboundSchema: z.ZodNativeEnum<typeof CreateProjectToPreset>;
/** @internal */
export declare const CreateProjectToPreset$outboundSchema: z.ZodNativeEnum<typeof CreateProjectToPreset>;
/** @internal */
export declare const CreateProjectTo1$inboundSchema: z.ZodType<CreateProjectTo1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CreateProjectTo1$outboundSchema: z.ZodType<CreateProjectTo1$Outbound, z.ZodTypeDef, CreateProjectTo1>;
export declare function createProjectTo1ToJSON(createProjectTo1: CreateProjectTo1): string;
export declare function createProjectTo1FromJSON(jsonString: string): SafeParseResult<CreateProjectTo1, SDKValidationError>;
/** @internal */
export declare const CreateProjectTo$inboundSchema: z.ZodType<CreateProjectTo, z.ZodTypeDef, unknown>;
/** @internal */
export type CreateProjectTo$Outbound = CreateProjectTo1$Outbound | CreateProjectTo2$Outbound;
/** @internal */
export declare const CreateProjectTo$outboundSchema: z.ZodType<CreateProjectTo$Outbound, z.ZodTypeDef, CreateProjectTo>;
export declare function createProjectToToJSON(createProjectTo: CreateProjectTo): string;
export declare function createProjectToFromJSON(jsonString: string): SafeParseResult<CreateProjectTo, SDKValidationError>;
/** @internal */
export declare const CreateProjectOidcProviders$inboundSchema: z.ZodType<CreateProjectOidcProviders, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CreateProjectOidcProviders$outboundSchema: z.ZodType<CreateProjectOidcProviders$Outbound, z.ZodTypeDef, CreateProjectOidcProviders>;
export declare function createProjectOidcProvidersToJSON(createProjectOidcProviders: CreateProjectOidcProviders): string;
export declare function createProjectOidcProvidersFromJSON(jsonString: string): SafeParseResult<CreateProjectOidcProviders, SDKValidationError>;
/** @internal */
export declare const CreateProjectTrustedSources$inboundSchema: z.ZodType<CreateProjectTrustedSources, z.ZodTypeDef, unknown>;
/** @internal */
export type CreateProjectTrustedSources$Outbound = {
    projects?: {
        [k: string]: CreateProjectProjects$Outbound;
    } | undefined;
    oidcProviders?: {
...
/** @internal */
export declare const CreateProjectTrustedSources$outboundSchema: z.ZodType<CreateProjectTrustedSources$Outbound, z.ZodTypeDef, CreateProjectTrustedSources>;
export declare function createProjectTrustedSourcesToJSON(createProjectTrustedSources: CreateProjectTrustedSources): string;
export declare function createProjectTrustedSourcesFromJSON(jsonString: string): SafeParseResult<CreateProjectTrustedSources, SDKValidationError>;
/** @internal */
...
//# sourceMappingURL=createprojectcreatedeployments.d.ts.map