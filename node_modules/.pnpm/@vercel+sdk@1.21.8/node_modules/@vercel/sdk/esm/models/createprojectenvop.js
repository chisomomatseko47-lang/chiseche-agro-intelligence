...
/** @internal */
export const CreateProjectEnvContentHintProjects17$inboundSchema = z.object({
    type: types.literal("flags-connection-string"),
    projectId: types.string(),
});
/** @internal */
export const CreateProjectEnvContentHintProjects17$outboundSchema = z.object({
    type: z.literal("flags-connection-string"),
    projectId: z.string(),
});
export function createProjectEnvContentHintProjects17ToJSON(createProjectEnvContentHintProjects17) {
    return JSON.stringify(CreateProjectEnvContentHintProjects17$outboundSchema.parse(createProjectEnvContentHintProjects17));
}
export function createProjectEnvContentHintProjects17FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateProjectEnvContentHintProjects17$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateProjectEnvContentHintProjects17' from JSON`);
}
/** @internal */
export const CreateProjectEnvContentHintProjects16$inboundSchema = z.object({
...
/** @internal */
export const CreateProjectEnvContentHintProjects16$outboundSchema = z.object({
...
export function createProjectEnvContentHintProjects16ToJSON(createProjectEnvContentHintProjects16) {
    return JSON.stringify(CreateProjectEnvContentHintProjects16$outboundSchema.parse(createProjectEnvContentHintProjects16));
}
export function createProjectEnvContentHintProjects16FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateProjectEnvContentHintProjects16$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateProjectEnvContentHintProjects16' from JSON`);
}
/** @internal */
...
/** @internal */
export const CreateProjectEnvContentHint17$inboundSchema = z.object({
    type: types.literal("flags-connection-string"),
    projectId: types.string(),
});
/** @internal */
export const CreateProjectEnvContentHint17$outboundSchema = z.object({
    type: z.literal("flags-connection-string"),
    projectId: z.string(),
});
export function createProjectEnvContentHint17ToJSON(createProjectEnvContentHint17) {
    return JSON.stringify(CreateProjectEnvContentHint17$outboundSchema.parse(createProjectEnvContentHint17));
}
export function createProjectEnvContentHint17FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateProjectEnvContentHint17$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateProjectEnvContentHint17' from JSON`);
}
/** @internal */
export const CreateProjectEnvContentHint16$inboundSchema = z.object({
    type: types.literal("integration-store-secret"),
    storeId: types.string(),
    integrationId: types.string(),
    integrationProductId: types.string(),
...
/** @internal */
export const CreateProjectEnvContentHint16$outboundSchema = z.object({
    type: z.literal("integration-store-secret"),
    storeId: z.string(),
    integrationId: z.string(),
    integrationProductId: z.string(),
...
export function createProjectEnvContentHint16ToJSON(createProjectEnvContentHint16) {
    return JSON.stringify(CreateProjectEnvContentHint16$outboundSchema.parse(createProjectEnvContentHint16));
}
export function createProjectEnvContentHint16FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateProjectEnvContentHint16$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateProjectEnvContentHint16' from JSON`);
}
/** @internal */
