...
/** @internal */
export declare const Expiration2$outboundSchema: z.ZodType<Expiration2$Outbound, z.ZodTypeDef, Expiration2>;
export declare function expiration2ToJSON(expiration2: Expiration2): string;
...
/** @internal */
export declare const Expiration1$outboundSchema: z.ZodType<Expiration1$Outbound, z.ZodTypeDef, Expiration1>;
export declare function expiration1ToJSON(expiration1: Expiration1): string;
...
/** @internal */
export type CreateProjectExpiration$Outbound = Expiration2$Outbound | Expiration1$Outbound;
/** @internal */
export declare const CreateProjectExpiration$outboundSchema: z.ZodType<CreateProjectExpiration$Outbound, z.ZodTypeDef, CreateProjectExpiration>;
export declare function createProjectExpirationToJSON(createProjectExpiration: CreateProjectExpiration): string;
...
/** @internal */
export declare const CreateProjectContentHint17$outboundSchema: z.ZodType<CreateProjectContentHint17$Outbound, z.ZodTypeDef, CreateProjectContentHint17>;
export declare function createProjectContentHint17ToJSON(createProjectContentHint17: CreateProjectContentHint17): string;
...
/** @internal */
export declare const CreateProjectContentHint16$outboundSchema: z.ZodType<CreateProjectContentHint16$Outbound, z.ZodTypeDef, CreateProjectContentHint16>;
export declare function createProjectContentHint16ToJSON(createProjectContentHint16: CreateProjectContentHint16): string;
...
export type CreateProjectEnv$Outbound = {
    ...
    edgeConfigId?: string | null | undefined;
    edgeConfigTokenId?: string | null | undefined;
    contentHint?: CreateProjectContentHint1$Outbound | CreateProjectContentHint2$Outbound | CreateProjectContentHint3$Outbound | CreateProjectContentHint4$Outbound | CreateProjectContentHint5$Outbound | CreateProjectContentHint6$Outbound | CreateProjectContentHint7$Outbound | CreateProjectContentHint8$Outbound | CreateProjectContentHint9$Outbound | CreateProjectContentHint10$Outbound | CreateProjectContentHint11$Outbound | CreateProjectContentHint12$Outbound | CreateProjectContentHint13$Outbound | CreateProjectContentHint14$Outbound | CreateProjectContentHint15$Outbound | CreateProjectContentHint16$Outbound | CreateProjectContentHint17$Outbound | null | undefined;
...
/** @internal */
export declare const CreateProjectApril2026SecurityIncidentMigrationAppliedFrom$outboundSchema: z.ZodNativeEnum<typeof CreateProjectApril2026SecurityIncidentMigrationAppliedFrom>;
/** @internal */
...
//# sourceMappingURL=createprojecttopreset.d.ts.map