...
import { PayloadGitUserId, PayloadGitUserId$Outbound, UserEventPayload151Role, UserEventPayloadOrigin } from "./payloadgituserid.js";
...
export declare const UserEventPayload148Type: {
    readonly Header: "header";
};
export type UserEventPayload148Type = ClosedEnum<typeof UserEventPayload148Type>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload122Configuration: {
    readonly SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE";
    readonly WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE";
};
export type UserEventPayload122Configuration = ClosedEnum<typeof UserEventPayload122Configuration>;
...
export declare const PayloadMachineSelectionType: {
    readonly Fixed: "fixed";
    readonly Elastic: "elastic";
};
export type PayloadMachineSelectionType = ClosedEnum<typeof PayloadMachineSelectionType>;
...
export declare const UserEventPayload122Origin: {
    readonly Link: "link";
...
export type UserEventPayload122Origin = ClosedEnum<typeof UserEventPayload122Origin>;
...
/** @internal */
export declare const UserEventPayload148Type$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload148Type>;
/** @internal */
export declare const UserEventPayload148Type$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload148Type>;
/** @internal */
...
/** @internal */
export declare const NewResourceBlockingPolicy$outboundSchema: z.ZodNativeEnum<typeof NewResourceBlockingPolicy>;
/** @internal */
...
/** @internal */
export declare const PayloadNewResourceBlockingPolicy$outboundSchema: z.ZodNativeEnum<typeof PayloadNewResourceBlockingPolicy>;
/** @internal */
...
/** @internal */
export declare const PayloadIntegration$outboundSchema: z.ZodType<PayloadIntegration$Outbound, z.ZodTypeDef, PayloadIntegration>;
export declare function payloadIntegrationToJSON(payloadIntegration: PayloadIntegration): string;
...
/** @internal */
export declare const UserEventPayload122Configuration$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122Configuration>;
/** @internal */
export declare const UserEventPayload122Configuration$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122Configuration>;
/** @internal */
...
/** @internal */
export declare const PayloadMachineSelectionType$inboundSchema: z.ZodNativeEnum<typeof PayloadMachineSelectionType>;
/** @internal */
export declare const PayloadMachineSelectionType$outboundSchema: z.ZodNativeEnum<typeof PayloadMachineSelectionType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122Origin$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122Origin>;
/** @internal */
export declare const UserEventPayload122Origin$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122Origin>;
/** @internal */
...
//# sourceMappingURL=fluidduration.d.ts.map