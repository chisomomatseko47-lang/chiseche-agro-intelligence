...
import { PayloadGitUserId$inboundSchema, PayloadGitUserId$outboundSchema, UserEventPayload151Role$inboundSchema, UserEventPayload151Role$outboundSchema, UserEventPayloadOrigin$inboundSchema, UserEventPayloadOrigin$outboundSchema, } from "./payloadgituserid.js";
...
/** @internal */
export const UserEventPayload148Type$inboundSchema = z.nativeEnum(UserEventPayload148Type);
/** @internal */
export const UserEventPayload148Type$outboundSchema = UserEventPayload148Type$inboundSchema;
/** @internal */
...
/** @internal */
export const NewResourceBlockingPolicy$inboundSchema = z.nativeEnum(NewResourceBlockingPolicy);
/** @internal */
export const NewResourceBlockingPolicy$outboundSchema = NewResourceBlockingPolicy$inboundSchema;
/** @internal */
...
/** @internal */
export const PayloadNewResourceBlockingPolicy$inboundSchema = z.nativeEnum(PayloadNewResourceBlockingPolicy);
/** @internal */
export const PayloadNewResourceBlockingPolicy$outboundSchema = PayloadNewResourceBlockingPolicy$inboundSchema;
/** @internal */
...
/** @internal */
export const PayloadIntegration$inboundSchema = z.object({
    id: types.string(),
    slug: types.string(),
    name: types.string(),
    configurationId: types.string(),
...
/** @internal */
export const PayloadIntegration$outboundSchema = z.object({
    id: z.string(),
    slug: z.string(),
    name: z.string(),
    configurationId: z.string(),
});
export function payloadIntegrationToJSON(payloadIntegration) {
    return JSON.stringify(PayloadIntegration$outboundSchema.parse(payloadIntegration));
}
export function payloadIntegrationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => PayloadIntegration$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'PayloadIntegration' from JSON`);
}
/** @internal */
...
export const Credentials$inboundSchema = z.union([
    z.lazy(() => Credentials1$inboundSchema).and(z.object({ type: z.literal("vercel") })),
    ...
    z.lazy(() => Credentials1$inboundSchema).and(z.object({ type: z.literal("chatgpt") })),
...
export const Credentials$outboundSchema = z.union([
    z.lazy(() => Credentials1$outboundSchema).and(z.object({ type: z.literal("vercel") })),
    ...
    z.lazy(() => Credentials1$outboundSchema).and(z.object({ type: z.literal("chatgpt") })),
...
/** @internal */
export const UserEventPayload122Configuration$inboundSchema = z.nativeEnum(UserEventPayload122Configuration);
/** @internal */
export const UserEventPayload122Configuration$outboundSchema = UserEventPayload122Configuration$inboundSchema;
/** @internal */
...
/** @internal */
export const PayloadMachineSelectionType$inboundSchema = z.nativeEnum(PayloadMachineSelectionType);
/** @internal */
export const PayloadMachineSelectionType$outboundSchema = PayloadMachineSelectionType$inboundSchema;
/** @internal */
export const PayloadBuildMachine$inboundSchema = z.object({
    ...
    machineSelectionType: types.optional(PayloadMachineSelectionType$inboundSchema),
});
/** @internal */
...
/** @internal */
export const UserEventPayload122Origin$inboundSchema = z.nativeEnum(UserEventPayload122Origin);
/** @internal */
export const UserEventPayload122Origin$outboundSchema = UserEventPayload122Origin$inboundSchema;
/** @internal */
...
//# sourceMappingURL=fluidduration.js.map