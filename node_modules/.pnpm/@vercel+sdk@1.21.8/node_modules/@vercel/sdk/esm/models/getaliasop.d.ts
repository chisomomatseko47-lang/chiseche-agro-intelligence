...
/** @internal */
export declare const GetAliasDefaultApp$outboundSchema: z.ZodType<GetAliasDefaultApp$Outbound, z.ZodTypeDef, GetAliasDefaultApp>;
export declare function getAliasDefaultAppToJSON(getAliasDefaultApp: GetAliasDefaultApp): string;
...
/** @internal */
export declare const GetAliasApplications2$outboundSchema: z.ZodType<GetAliasApplications2$Outbound, z.ZodTypeDef, GetAliasApplications2>;
export declare function getAliasApplications2ToJSON(getAliasApplications2: GetAliasApplications2): string;
...
/** @internal */
export declare const GetAliasApplications1$outboundSchema: z.ZodType<GetAliasApplications1$Outbound, z.ZodTypeDef, GetAliasApplications1>;
export declare function getAliasApplications1ToJSON(getAliasApplications1: GetAliasApplications1): string;
...
/** @internal */
export type GetAliasApplications$Outbound = Array<GetAliasApplications1$Outbound> | Array<GetAliasApplications2$Outbound> | Array<Applications3$Outbound>;
/** @internal */
export declare const GetAliasApplications$outboundSchema: z.ZodType<GetAliasApplications$Outbound, z.ZodTypeDef, GetAliasApplications>;
export declare function getAliasApplicationsToJSON(getAliasApplications: GetAliasApplications): string;
...
export type GetAliasMicrofrontends$Outbound = {
    ...
    applications: Array<GetAliasApplications1$Outbound> | Array<GetAliasApplications2$Outbound> | Array<Applications3$Outbound>;
};
/** @internal */
