...
/** @internal */
export const GetAliasDefaultApp$inboundSchema = z.object({
    projectId: types.string(),
});
/** @internal */
export const GetAliasDefaultApp$outboundSchema = z.object({
    projectId: z.string(),
});
export function getAliasDefaultAppToJSON(getAliasDefaultApp) {
    return JSON.stringify(GetAliasDefaultApp$outboundSchema.parse(getAliasDefaultApp));
}
export function getAliasDefaultAppFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetAliasDefaultApp$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetAliasDefaultApp' from JSON`);
}
/** @internal */
...
/** @internal */
export const GetAliasApplications2$inboundSchema = z.object({
    fallbackHost: types.string(),
    branchAlias: types.string(),
    projectId: types.string(),
});
/** @internal */
export const GetAliasApplications2$outboundSchema = z.object({
    fallbackHost: z.string(),
    branchAlias: z.string(),
    projectId: z.string(),
});
export function getAliasApplications2ToJSON(getAliasApplications2) {
    return JSON.stringify(GetAliasApplications2$outboundSchema.parse(getAliasApplications2));
}
export function getAliasApplications2FromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetAliasApplications2$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetAliasApplications2' from JSON`);
}
/** @internal */
export const GetAliasApplications1$inboundSchema = z.object({
    fallbackHost: types.string(),
    projectId: types.string(),
});
/** @internal */
export const GetAliasApplications1$outboundSchema = z.object({
    fallbackHost: z.string(),
    projectId: z.string(),
});
export function getAliasApplications1ToJSON(getAliasApplications1) {
    return JSON.stringify(GetAliasApplications1$outboundSchema.parse(getAliasApplications1));
}
export function getAliasApplications1FromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetAliasApplications1$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetAliasApplications1' from JSON`);
}
/** @internal */
export const GetAliasApplications$inboundSchema = smartUnion([
...
/** @internal */
export const GetAliasApplications$outboundSchema = smartUnion([
...
export function getAliasApplicationsToJSON(getAliasApplications) {
    return JSON.stringify(GetAliasApplications$outboundSchema.parse(getAliasApplications));
}
export function getAliasApplicationsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetAliasApplications$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetAliasApplications' from JSON`);
}
/** @internal */
