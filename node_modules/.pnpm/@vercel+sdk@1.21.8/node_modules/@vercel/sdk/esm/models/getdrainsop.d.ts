...
export declare const GetDrainsProjectAccessDrainsManagedBy: {
    readonly Integration: "integration";
    readonly Drain: "drain";
};
export type GetDrainsProjectAccessDrainsManagedBy = ClosedEnum<typeof GetDrainsProjectAccessDrainsManagedBy>;
export type GetDrainsProjectAccess2 = {
    access: "some";
    projectIds: Array<string>;
    managedBy: GetDrainsProjectAccessDrainsManagedBy;
};
export declare const GetDrainsProjectAccessManagedBy: {
    readonly Integration: "integration";
    readonly Drain: "drain";
};
export type GetDrainsProjectAccessManagedBy = ClosedEnum<typeof GetDrainsProjectAccessManagedBy>;
...
/** @internal */
export declare const GetDrainsDrainsAiGateway$inboundSchema: z.ZodType<GetDrainsDrainsAiGateway, z.ZodTypeDef, unknown>;
/** @internal */
export type GetDrainsDrainsAiGateway$Outbound = {};
/** @internal */
export declare const GetDrainsDrainsAiGateway$outboundSchema: z.ZodType<GetDrainsDrainsAiGateway$Outbound, z.ZodTypeDef, GetDrainsDrainsAiGateway>;
export declare function getDrainsDrainsAiGatewayToJSON(getDrainsDrainsAiGateway: GetDrainsDrainsAiGateway): string;
export declare function getDrainsDrainsAiGatewayFromJSON(jsonString: string): SafeParseResult<GetDrainsDrainsAiGateway, SDKValidationError>;
/** @internal */
export declare const GetDrainsDrainsAuditLog$inboundSchema: z.ZodType<GetDrainsDrainsAuditLog, z.ZodTypeDef, unknown>;
/** @internal */
export type GetDrainsDrainsAuditLog$Outbound = {};
/** @internal */
export declare const GetDrainsDrainsAuditLog$outboundSchema: z.ZodType<GetDrainsDrainsAuditLog$Outbound, z.ZodTypeDef, GetDrainsDrainsAuditLog>;
export declare function getDrainsDrainsAuditLogToJSON(getDrainsDrainsAuditLog: GetDrainsDrainsAuditLog): string;
export declare function getDrainsDrainsAuditLogFromJSON(jsonString: string): SafeParseResult<GetDrainsDrainsAuditLog, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetDrainsProjectAccessDrainsManagedBy$inboundSchema: z.ZodNativeEnum<typeof GetDrainsProjectAccessDrainsManagedBy>;
/** @internal */
export declare const GetDrainsProjectAccessDrainsManagedBy$outboundSchema: z.ZodNativeEnum<typeof GetDrainsProjectAccessDrainsManagedBy>;
/** @internal */
...
/** @internal */
export declare const GetDrainsProjectAccessManagedBy$inboundSchema: z.ZodNativeEnum<typeof GetDrainsProjectAccessManagedBy>;
/** @internal */
export declare const GetDrainsProjectAccessManagedBy$outboundSchema: z.ZodNativeEnum<typeof GetDrainsProjectAccessManagedBy>;
/** @internal */
...
/** @internal */
export declare const DrainsAiGateway$inboundSchema: z.ZodType<DrainsAiGateway, z.ZodTypeDef, unknown>;
/** @internal */
export type DrainsAiGateway$Outbound = {};
/** @internal */
export declare const DrainsAiGateway$outboundSchema: z.ZodType<DrainsAiGateway$Outbound, z.ZodTypeDef, DrainsAiGateway>;
export declare function drainsAiGatewayToJSON(drainsAiGateway: DrainsAiGateway): string;
export declare function drainsAiGatewayFromJSON(jsonString: string): SafeParseResult<DrainsAiGateway, SDKValidationError>;
/** @internal */
export declare const DrainsAuditLog$inboundSchema: z.ZodType<DrainsAuditLog, z.ZodTypeDef, unknown>;
/** @internal */
export type DrainsAuditLog$Outbound = {};
/** @internal */
export declare const DrainsAuditLog$outboundSchema: z.ZodType<DrainsAuditLog$Outbound, z.ZodTypeDef, DrainsAuditLog>;
export declare function drainsAuditLogToJSON(drainsAuditLog: DrainsAuditLog): string;
export declare function drainsAuditLogFromJSON(jsonString: string): SafeParseResult<DrainsAuditLog, SDKValidationError>;
/** @internal */
