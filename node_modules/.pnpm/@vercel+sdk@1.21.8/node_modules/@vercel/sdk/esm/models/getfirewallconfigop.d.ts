...
/** @internal */
export declare const GetFirewallConfigLogHeaders$inboundSchema: z.ZodType<GetFirewallConfigLogHeaders, z.ZodTypeDef, unknown>;
/** @internal */
export type GetFirewallConfigLogHeaders$Outbound = Array<string> | string;
/** @internal */
export declare const GetFirewallConfigLogHeaders$outboundSchema: z.ZodType<GetFirewallConfigLogHeaders$Outbound, z.ZodTypeDef, GetFirewallConfigLogHeaders>;
export declare function getFirewallConfigLogHeadersToJSON(getFirewallConfigLogHeaders: GetFirewallConfigLogHeaders): string;
export declare function getFirewallConfigLogHeadersFromJSON(jsonString: string): SafeParseResult<GetFirewallConfigLogHeaders, SDKValidationError>;
/** @internal */
