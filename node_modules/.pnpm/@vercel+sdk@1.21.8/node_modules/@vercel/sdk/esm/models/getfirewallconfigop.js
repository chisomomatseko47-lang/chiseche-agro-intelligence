...
/** @internal */
export const GetFirewallConfigLogHeaders$inboundSchema = smartUnion([z.array(types.string()), LogHeaders2$inboundSchema]);
/** @internal */
export const GetFirewallConfigLogHeaders$outboundSchema = smartUnion([z.array(z.string()), LogHeaders2$outboundSchema]);
export function getFirewallConfigLogHeadersToJSON(getFirewallConfigLogHeaders) {
    return JSON.stringify(GetFirewallConfigLogHeaders$outboundSchema.parse(getFirewallConfigLogHeaders));
}
export function getFirewallConfigLogHeadersFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetFirewallConfigLogHeaders$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetFirewallConfigLogHeaders' from JSON`);
}
/** @internal */
export const GetFirewallConfigResponseBody$inboundSchema = z.object({
    ...
    logHeaders: types.optional(smartUnion([z.array(types.string()), LogHeaders2$inboundSchema])),
});
/** @internal */
