...
/** @internal */
export const GetProjectEnvContentHintProjects17$inboundSchema = z.object({
    type: types.literal("flags-connection-string"),
    projectId: types.string(),
});
/** @internal */
export const GetProjectEnvContentHintProjects17$outboundSchema = z.object({
    type: z.literal("flags-connection-string"),
    projectId: z.string(),
});
export function getProjectEnvContentHintProjects17ToJSON(getProjectEnvContentHintProjects17) {
    return JSON.stringify(GetProjectEnvContentHintProjects17$outboundSchema.parse(getProjectEnvContentHintProjects17));
}
export function getProjectEnvContentHintProjects17FromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectEnvContentHintProjects17$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectEnvContentHintProjects17' from JSON`);
}
/** @internal */
export const GetProjectEnvContentHintProjects16$inboundSchema = z.object({
...
/** @internal */
export const GetProjectEnvContentHintProjects16$outboundSchema = z.object({
...
export function getProjectEnvContentHintProjects16ToJSON(getProjectEnvContentHintProjects16) {
    return JSON.stringify(GetProjectEnvContentHintProjects16$outboundSchema.parse(getProjectEnvContentHintProjects16));
}
export function getProjectEnvContentHintProjects16FromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectEnvContentHintProjects16$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectEnvContentHintProjects16' from JSON`);
}
/** @internal */
...
/** @internal */
export const GetProjectEnvContentHint17$inboundSchema = z.object({
    type: types.literal("flags-connection-string"),
    projectId: types.string(),
});
/** @internal */
export const GetProjectEnvContentHint17$outboundSchema = z.object({
    type: z.literal("flags-connection-string"),
    projectId: z.string(),
});
export function getProjectEnvContentHint17ToJSON(getProjectEnvContentHint17) {
    return JSON.stringify(GetProjectEnvContentHint17$outboundSchema.parse(getProjectEnvContentHint17));
}
export function getProjectEnvContentHint17FromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectEnvContentHint17$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectEnvContentHint17' from JSON`);
}
/** @internal */
export const GetProjectEnvContentHint16$inboundSchema = z.object({
    type: types.literal("integration-store-secret"),
    storeId: types.string(),
    integrationId: types.string(),
    integrationProductId: types.string(),
...
/** @internal */
export const GetProjectEnvContentHint16$outboundSchema = z.object({
    type: z.literal("integration-store-secret"),
    storeId: z.string(),
    integrationId: z.string(),
    integrationProductId: z.string(),
...
export function getProjectEnvContentHint16ToJSON(getProjectEnvContentHint16) {
    return JSON.stringify(GetProjectEnvContentHint16$outboundSchema.parse(getProjectEnvContentHint16));
}
export function getProjectEnvContentHint16FromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectEnvContentHint16$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectEnvContentHint16' from JSON`);
}
/** @internal */
