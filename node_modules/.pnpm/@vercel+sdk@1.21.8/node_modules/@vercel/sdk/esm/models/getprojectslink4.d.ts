...
import { GetProjectsResponseBodyAnalytics, GetProjectsResponseBodyAnalytics$Outbound, GetProjectsResponseBodyDeploymentExpiration, GetProjectsResponseBodyDeploymentExpiration$Outbound, GetProjectsResponseBodyEnv, GetProjectsResponseBodyEnv$Outbound, GetProjectsResponseBodyFramework, GetProjectsResponseBodyIpBuckets, GetProjectsResponseBodyIpBuckets$Outbound, GetProjectsResponseBodyLatestDeployments, GetProjectsResponseBodyLatestDeployments$Outbound, GetProjectsResponseBodyLink, GetProjectsResponseBodyLink$Outbound, GetProjectsResponseBodyPasswordProtection, GetProjectsResponseBodyPasswordProtection$Outbound, GetProjectsResponseBodyProjectsNodeVersion, GetProjectsResponseBodyResourceConfig, GetProjectsResponseBodyResourceConfig$Outbound, GetProjectsResponseBodyRollingRelease, GetProjectsResponseBodyRollingRelease$Outbound, GetProjectsResponseBodySpeedInsights, GetProjectsResponseBodySpeedInsights$Outbound, GetProjectsResponseBodySsoProtection, GetProjectsResponseBodySsoProtection$Outbound, GetProjectsResponseBodyTargets, GetProjectsResponseBodyTargets$Outbound, ResponseBodyAlias, ResponseBodyAlias$Outbound } from "./getprojectsresponsebodytargets.js";
...
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBodyPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBodyPreset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBodyPreset>;
/**
 * The target envs on the current project that may be accessed.
 */
...
export declare const GetProjectsToProjectsResponse200ApplicationJSONPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONPreset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONPreset>;
/**
 * The target envs on the current project that may be accessed.
 */
...
export type GetProjectsResponseBodyProjectsTo = GetProjectsToProjectsResponse1 | GetProjectsToProjectsResponse2;
...
export type GetProjectsResponseBodyGitProviderOptions = {
     ...
     * Configuration for consolidated git commit status reporting. When enabled, Vercel will post a single consolidated commit status instead of individual statuses for each deployment.
     */
    consolidatedGitCommitStatus?: GetProjectsResponseBodyConsolidatedGitCommitStatus | undefined;
};
...
export declare const GetProjectsLogHeadersProjectsResponse200ApplicationJson2: {
    readonly Wildcard: "*";
};
export type GetProjectsLogHeadersProjectsResponse200ApplicationJson2 = ClosedEnum<typeof GetProjectsLogHeadersProjectsResponse200ApplicationJson2>;
export type GetProjectsResponseBodyProjectsResponse200LogHeaders = Array<string> | GetProjectsLogHeadersProjectsResponse200ApplicationJson2;
export type GetProjectsResponseBodyProjectsMitigate = {
    ...
    logHeaders?: Array<string> | GetProjectsLogHeadersProjectsResponse200ApplicationJson2 | undefined;
};
...
export declare const GetProjectsLogHeadersProjects2: {
    readonly Wildcard: "*";
};
export type GetProjectsLogHeadersProjects2 = ClosedEnum<typeof GetProjectsLogHeadersProjects2>;
export type GetProjectsResponseBodyLogHeaders = Array<string> | GetProjectsLogHeadersProjects2;
...
export type GetProjectsResponseBodySecurity = {
    ...
    securityPlusMetadata?: GetProjectsResponseBodySecurityPlusMetadata | undefined;
    /**
...
export type GetProjectsRouteProjectsResponse200Has = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody21 | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody22;
...
export type GetProjectsRouteProjectsResponseHas = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody1 | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody2;
...
export type GetProjectsResponseBodyBlockHistory = GetProjectsBlockHistoryProjects1 | GetProjectsBlockHistoryProjects2 | GetProjectsBlockHistoryProjects3 | GetProjectsBlockHistoryProjects4;
...
export type GetProjectsInternalRoutesProjectsHas = GetProjectsHasProjects1 | GetProjectsHasProjects2;
...
export type ResponseBodyEnv = {
    ...
    contentHint?: GetProjectsContentHint1 | GetProjectsContentHint2 | GetProjectsContentHint3 | GetProjectsContentHint4 | GetProjectsContentHint5 | GetProjectsContentHint6 | GetProjectsContentHint7 | GetProjectsContentHint8 | GetProjectsContentHint9 | GetProjectsContentHint10 | GetProjectsContentHint11 | GetProjectsContentHint12 | GetProjectsContentHint13 | GetProjectsContentHint14 | GetProjectsContentHint15 | GetProjectsContentHint16 | GetProjectsContentHint17 | null | undefined;
    /**
     * Similar to `contentHints`, but should not be exposed to the user.
     */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200Projects$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200Projects, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200Projects$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200Projects$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsResponse200Projects>;
export declare function getProjectsResponseBodyProjectsResponse200ProjectsToJSON(getProjectsResponseBodyProjectsResponse200Projects: GetProjectsResponseBodyProjectsResponse200Projects): string;
export declare function getProjectsResponseBodyProjectsResponse200ProjectsFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsResponse200Projects, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBodyPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBodyPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBodyPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBodyPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse2$inboundSchema: z.ZodType<GetProjectsToProjectsResponse2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse2$outboundSchema: z.ZodType<GetProjectsToProjectsResponse2$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse2>;
export declare function getProjectsToProjectsResponse2ToJSON(getProjectsToProjectsResponse2: GetProjectsToProjectsResponse2): string;
export declare function getProjectsToProjectsResponse2FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse2, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse1$inboundSchema: z.ZodType<GetProjectsToProjectsResponse1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse1$outboundSchema: z.ZodType<GetProjectsToProjectsResponse1$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse1>;
export declare function getProjectsToProjectsResponse1ToJSON(getProjectsToProjectsResponse1: GetProjectsToProjectsResponse1): string;
export declare function getProjectsToProjectsResponse1FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse1, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsTo$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsTo, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsTo$Outbound = GetProjectsToProjectsResponse1$Outbound | GetProjectsToProjectsResponse2$Outbound;
/** @internal */
export declare const GetProjectsResponseBodyProjectsTo$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsTo$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsTo>;
export declare function getProjectsResponseBodyProjectsToToJSON(getProjectsResponseBodyProjectsTo: GetProjectsResponseBodyProjectsTo): string;
export declare function getProjectsResponseBodyProjectsToFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsTo, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyOidcProviders$inboundSchema: z.ZodType<GetProjectsResponseBodyOidcProviders, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyOidcProviders$Outbound = {
    to: GetProjectsToProjectsResponse1$Outbound | GetProjectsToProjectsResponse2$Outbound;
    label?: string | undefined;
    claims: {
        [k: string]: Array<string>;
    };
...
/** @internal */
export declare const GetProjectsResponseBodyOidcProviders$outboundSchema: z.ZodType<GetProjectsResponseBodyOidcProviders$Outbound, z.ZodTypeDef, GetProjectsResponseBodyOidcProviders>;
export declare function getProjectsResponseBodyOidcProvidersToJSON(getProjectsResponseBodyOidcProviders: GetProjectsResponseBodyOidcProviders): string;
export declare function getProjectsResponseBodyOidcProvidersFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyOidcProviders, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyTrustedSources$inboundSchema: z.ZodType<GetProjectsResponseBodyTrustedSources, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyTrustedSources$outboundSchema: z.ZodType<GetProjectsResponseBodyTrustedSources$Outbound, z.ZodTypeDef, GetProjectsResponseBodyTrustedSources>;
export declare function getProjectsResponseBodyTrustedSourcesToJSON(getProjectsResponseBodyTrustedSources: GetProjectsResponseBodyTrustedSources): string;
export declare function getProjectsResponseBodyTrustedSourcesFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyTrustedSources, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyConsolidatedGitCommitStatus$inboundSchema: z.ZodType<GetProjectsResponseBodyConsolidatedGitCommitStatus, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyConsolidatedGitCommitStatus$outboundSchema: z.ZodType<GetProjectsResponseBodyConsolidatedGitCommitStatus$Outbound, z.ZodTypeDef, GetProjectsResponseBodyConsolidatedGitCommitStatus>;
export declare function getProjectsResponseBodyConsolidatedGitCommitStatusToJSON(getProjectsResponseBodyConsolidatedGitCommitStatus: GetProjectsResponseBodyConsolidatedGitCommitStatus): string;
export declare function getProjectsResponseBodyConsolidatedGitCommitStatusFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyConsolidatedGitCommitStatus, SDKValidationError>;
/** @internal */
...
export type GetProjectsResponseBodyGitProviderOptions$Outbound = {
    ...
    requireVerifiedCommits?: boolean | undefined;
    gitCommitStatus?: boolean | undefined;
    consolidatedGitCommitStatus?: GetProjectsResponseBodyConsolidatedGitCommitStatus$Outbound | undefined;
};
/** @internal */
...
/** @internal */
export declare const GetProjectsLogHeadersProjectsResponse200ApplicationJson2$inboundSchema: z.ZodNativeEnum<typeof GetProjectsLogHeadersProjectsResponse200ApplicationJson2>;
/** @internal */
export declare const GetProjectsLogHeadersProjectsResponse200ApplicationJson2$outboundSchema: z.ZodNativeEnum<typeof GetProjectsLogHeadersProjectsResponse200ApplicationJson2>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200LogHeaders$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200LogHeaders, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsResponse200LogHeaders$Outbound = Array<string> | string;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200LogHeaders$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200LogHeaders$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsResponse200LogHeaders>;
export declare function getProjectsResponseBodyProjectsResponse200LogHeadersToJSON(getProjectsResponseBodyProjectsResponse200LogHeaders: GetProjectsResponseBodyProjectsResponse200LogHeaders): string;
export declare function getProjectsResponseBodyProjectsResponse200LogHeadersFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsResponse200LogHeaders, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLogHeadersProjects2$inboundSchema: z.ZodNativeEnum<typeof GetProjectsLogHeadersProjects2>;
/** @internal */
export declare const GetProjectsLogHeadersProjects2$outboundSchema: z.ZodNativeEnum<typeof GetProjectsLogHeadersProjects2>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodySecurityPlusMetadata$inboundSchema: z.ZodType<GetProjectsResponseBodySecurityPlusMetadata, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodySecurityPlusMetadata$outboundSchema: z.ZodType<GetProjectsResponseBodySecurityPlusMetadata$Outbound, z.ZodTypeDef, GetProjectsResponseBodySecurityPlusMetadata>;
export declare function getProjectsResponseBodySecurityPlusMetadataToJSON(getProjectsResponseBodySecurityPlusMetadata: GetProjectsResponseBodySecurityPlusMetadata): string;
export declare function getProjectsResponseBodySecurityPlusMetadataFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodySecurityPlusMetadata, SDKValidationError>;
/** @internal */
...
export type GetProjectsResponseBodySecurity$Outbound = {
    ...
    log_headers?: Array<string> | string | undefined;
    securityPlus?: boolean | undefined;
    securityPlusMetadata?: GetProjectsResponseBodySecurityPlusMetadata$Outbound | undefined;
    pageIntegrityEnabled?: boolean | undefined;
};
/** @internal */
...
/** @internal */
export type GetProjectsRouteProjectsResponse200Has$Outbound = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody21$Outbound | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody22$Outbound;
/** @internal */
...
/** @internal */
export type GetProjectsRouteProjectsResponseHas$Outbound = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody1$Outbound | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody2$Outbound;
/** @internal */
...
/** @internal */
export type GetProjectsResponseBodyBlockHistory$Outbound = GetProjectsBlockHistoryProjects1$Outbound | GetProjectsBlockHistoryProjects2$Outbound | GetProjectsBlockHistoryProjects3$Outbound | GetProjectsBlockHistoryProjects4$Outbound;
/** @internal */
...
/** @internal */
export type GetProjectsInternalRoutesProjectsHas$Outbound = GetProjectsHasProjects1$Outbound | GetProjectsHasProjects2$Outbound;
/** @internal */
...
export type ResponseBodyProjects$Outbound = {
    ...
    transferToAccountId?: string | undefined;
    transferredFromAccountId?: string | undefined;
    trustedSources?: GetProjectsResponseBodyTrustedSources$Outbound | null | undefined;
    updatedAt?: number | undefined;
    live?: boolean | undefined;
    hasActiveBranches?: boolean | undefined;
...
/** @internal */
export declare const GetProjectsContentHint17$inboundSchema: z.ZodType<GetProjectsContentHint17, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsContentHint17$outboundSchema: z.ZodType<GetProjectsContentHint17$Outbound, z.ZodTypeDef, GetProjectsContentHint17>;
export declare function getProjectsContentHint17ToJSON(getProjectsContentHint17: GetProjectsContentHint17): string;
export declare function getProjectsContentHint17FromJSON(jsonString: string): SafeParseResult<GetProjectsContentHint17, SDKValidationError>;
/** @internal */
export declare const GetProjectsContentHint16$inboundSchema: z.ZodType<GetProjectsContentHint16, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsContentHint16$outboundSchema: z.ZodType<GetProjectsContentHint16$Outbound, z.ZodTypeDef, GetProjectsContentHint16>;
export declare function getProjectsContentHint16ToJSON(getProjectsContentHint16: GetProjectsContentHint16): string;
export declare function getProjectsContentHint16FromJSON(jsonString: string): SafeParseResult<GetProjectsContentHint16, SDKValidationError>;
/** @internal */
...
/** @internal */
export type GetProjectsResponseBodyContentHint$Outbound = GetProjectsContentHint1$Outbound | GetProjectsContentHint2$Outbound | GetProjectsContentHint3$Outbound | GetProjectsContentHint4$Outbound | GetProjectsContentHint5$Outbound | GetProjectsContentHint6$Outbound | GetProjectsContentHint7$Outbound | GetProjectsContentHint8$Outbound | GetProjectsContentHint9$Outbound | GetProjectsContentHint10$Outbound | GetProjectsContentHint11$Outbound | GetProjectsContentHint12$Outbound | GetProjectsContentHint13$Outbound | GetProjectsContentHint14$Outbound | GetProjectsContentHint15$Outbound | GetProjectsContentHint16$Outbound | GetProjectsContentHint17$Outbound;
/** @internal */
...
export type ResponseBodyEnv$Outbound = {
    ...
    edgeConfigId?: string | null | undefined;
    edgeConfigTokenId?: string | null | undefined;
    contentHint?: GetProjectsContentHint1$Outbound | GetProjectsContentHint2$Outbound | GetProjectsContentHint3$Outbound | GetProjectsContentHint4$Outbound | GetProjectsContentHint5$Outbound | GetProjectsContentHint6$Outbound | GetProjectsContentHint7$Outbound | GetProjectsContentHint8$Outbound | GetProjectsContentHint9$Outbound | GetProjectsContentHint10$Outbound | GetProjectsContentHint11$Outbound | GetProjectsContentHint12$Outbound | GetProjectsContentHint13$Outbound | GetProjectsContentHint14$Outbound | GetProjectsContentHint15$Outbound | GetProjectsContentHint16$Outbound | GetProjectsContentHint17$Outbound | null | undefined;
...
/** @internal */
export declare const GetProjectsLink6$inboundSchema: z.ZodType<GetProjectsLink6, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLink6$outboundSchema: z.ZodType<GetProjectsLink6$Outbound, z.ZodTypeDef, GetProjectsLink6>;
export declare function getProjectsLink6ToJSON(getProjectsLink6: GetProjectsLink6): string;
export declare function getProjectsLink6FromJSON(jsonString: string): SafeParseResult<GetProjectsLink6, SDKValidationError>;
/** @internal */
...
//# sourceMappingURL=getprojectslink4.d.ts.map