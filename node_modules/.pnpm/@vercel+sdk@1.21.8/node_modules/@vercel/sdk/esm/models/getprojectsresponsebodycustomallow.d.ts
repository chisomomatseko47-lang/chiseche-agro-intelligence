...
import { GetProjectsResponseBodyCrons, GetProjectsResponseBodyCrons$Outbound, GetProjectsResponseBodyMicrofrontends, GetProjectsResponseBodyMicrofrontends$Outbound, GetProjectsResponseBodyProjectsAiBots, GetProjectsResponseBodyProjectsAiBots$Outbound, GetProjectsResponseBodyProjectsAnalytics, GetProjectsResponseBodyProjectsAnalytics$Outbound, GetProjectsResponseBodyProjectsBotFilter, GetProjectsResponseBodyProjectsBotFilter$Outbound, GetProjectsResponseBodyProjectsDeploymentExpiration, GetProjectsResponseBodyProjectsDeploymentExpiration$Outbound, GetProjectsResponseBodyProjectsEnv, GetProjectsResponseBodyProjectsEnv$Outbound, GetProjectsResponseBodyProjectsFramework, GetProjectsResponseBodyProjectsGitComments, GetProjectsResponseBodyProjectsGitComments$Outbound, GetProjectsResponseBodyProjectsGitProviderOptions, GetProjectsResponseBodyProjectsGitProviderOptions$Outbound, GetProjectsResponseBodyProjectsIpBuckets, GetProjectsResponseBodyProjectsIpBuckets$Outbound, GetProjectsResponseBodyProjectsLatestDeployments, GetProjectsResponseBodyProjectsLatestDeployments$Outbound, GetProjectsResponseBodyProjectsLink, GetProjectsResponseBodyProjectsLink$Outbound, GetProjectsResponseBodyProjectsOwasp, GetProjectsResponseBodyProjectsOwasp$Outbound, GetProjectsResponseBodyProjectsPasswordProtection, GetProjectsResponseBodyProjectsPasswordProtection$Outbound, GetProjectsResponseBodyProjectsResourceConfig, GetProjectsResponseBodyProjectsResourceConfig$Outbound, GetProjectsResponseBodyProjectsResponseNodeVersion, GetProjectsResponseBodyProjectsRollingRelease, GetProjectsResponseBodyProjectsRollingRelease$Outbound, GetProjectsResponseBodyProjectsSpeedInsights, GetProjectsResponseBodyProjectsSpeedInsights$Outbound, GetProjectsResponseBodyProjectsSsoProtection, GetProjectsResponseBodyProjectsSsoProtection$Outbound, GetProjectsResponseBodyProjectsTargets, GetProjectsResponseBodyProjectsTargets$Outbound, GetProjectsResponseBodyProjectsTrustedSources, GetProjectsResponseBodyProjectsTrustedSources$Outbound, GetProjectsResponseBodyProjectsVercelRuleset, GetProjectsResponseBodyProjectsVercelRuleset$Outbound, GetProjectsResponseBodyProjectsWebAnalytics, GetProjectsResponseBodyProjectsWebAnalytics$Outbound, ResponseBodyConnectConfigurations, ResponseBodyConnectConfigurations$Outbound, ResponseBodyCustomEnvironments, ResponseBodyCustomEnvironments$Outbound, ResponseBodyDataCache, ResponseBodyDataCache$Outbound, ResponseBodyDefaultResourceConfig, ResponseBodyDefaultResourceConfig$Outbound, ResponseBodyDelegatedProtection, ResponseBodyDelegatedProtection$Outbound, ResponseBodyExpiration, ResponseBodyExpiration$Outbound, ResponseBodyJobs, ResponseBodyJobs$Outbound, ResponseBodyLastAliasRequest, ResponseBodyLastAliasRequest$Outbound, ResponseBodyLastRollbackTarget, ResponseBodyLastRollbackTarget$Outbound, ResponseBodyOptionsAllowlist, ResponseBodyOptionsAllowlist$Outbound, ResponseBodyPermissions, ResponseBodyPermissions$Outbound, ResponseBodyProtectionBypass, ResponseBodyProtectionBypass$Outbound, ResponseBodyRollbackDescription, ResponseBodyRollbackDescription$Outbound, ResponseBodyStaticIps, ResponseBodyStaticIps$Outbound, ResponseBodyTrustedIps, ResponseBodyTrustedIps$Outbound } from "./getprojectsresponsebodyprojectsowasp.js";
...
export declare const GetProjectsLogHeadersProjectsResponse2: {
    readonly Wildcard: "*";
};
export type GetProjectsLogHeadersProjectsResponse2 = ClosedEnum<typeof GetProjectsLogHeadersProjectsResponse2>;
export type GetProjectsResponseBodyProjectsLogHeaders = Array<string> | GetProjectsLogHeadersProjectsResponse2;
...
export type GetProjectsResponseBodyProjectsSecurity = {
    ...
    logHeaders?: Array<string> | GetProjectsLogHeadersProjectsResponse2 | undefined;
    securityPlus?: boolean | undefined;
    securityPlusMetadata?: GetProjectsResponseBodyProjectsSecurityPlusMetadata | undefined;
    /**
...
export declare const ResponseBodyFlatRateTier: {
    readonly Standard: "standard";
    readonly Base: "base";
    readonly Advanced: "advanced";
    readonly Critical: "critical";
};
export type ResponseBodyFlatRateTier = ClosedEnum<typeof ResponseBodyFlatRateTier>;
/**
...
export declare const GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey: {
    readonly XVercelIpCountry: "x-vercel-ip-country";
};
export type GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey = ClosedEnum<typeof GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey>;
...
export type GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3Projects1 = {
    type: "header";
    key: GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey;
    value: GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsAbuseValue;
};
export type GetProjectsRouteProjectsResponse200ApplicationJSONResponseBodyHas = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3Projects1 | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3Projects2;
...
export type GetProjectsRouteProjectsResponse200ApplicationJSONHas = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody31 | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody32;
...
export type GetProjectsResponseBodyProjectsBlockHistory = GetProjectsBlockHistoryProjectsResponse1 | GetProjectsBlockHistoryProjectsResponse2 | GetProjectsBlockHistoryProjectsResponse3 | GetProjectsBlockHistoryProjectsResponse4;
...
export type GetProjectsInternalRoutesProjectsResponseHas = GetProjectsHasProjectsResponse1 | GetProjectsHasProjectsResponse2;
...
export declare const GetProjectsResponseBodyProjectsResponseEnv: {
    readonly Production: "production";
    readonly Preview: "preview";
};
export type GetProjectsResponseBodyProjectsResponseEnv = ClosedEnum<typeof GetProjectsResponseBodyProjectsResponseEnv>;
...
export type GetProjectsResponseBodyProjects = {
    ...
    protectionBypass?: {
        [k: string]: ResponseBodyProtectionBypass;
    } | undefined;
    hasActiveBranches?: boolean | undefined;
    trustedIps?: ResponseBodyTrustedIps | null | undefined;
    trustedSources?: GetProjectsResponseBodyProjectsTrustedSources | null | undefined;
...
export type GetProjectsLinkProjects6 = {
    ...
    type: "vercel";
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks>;
...
export type GetProjectsLinkProjects5 = {
    ...
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
export type GetProjectsLinkProjects4 = {
    ...
    type: "gitlab";
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
export type GetProjectsLinkProjects3 = {
    ...
    host: string;
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
export type GetProjectsResponseBodyLink = GetProjectsLinkProjects1 | GetProjectsLinkProjects2 | GetProjectsLinkProjects3 | GetProjectsLinkProjects4 | GetProjectsLinkProjects5 | GetProjectsLinkProjects6;
...
export declare const GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom: {
    readonly Preview: "preview";
    readonly All: "all";
    readonly ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews";
    readonly AllExceptCustomDomains: "all_except_custom_domains";
};
export type GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom = ClosedEnum<typeof GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom>;
export type GetProjectsResponseBodySsoProtection = {
    ...
    april2026SecurityIncidentMigrationAppliedFrom?: GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom | null | undefined;
};
...
export declare const GetProjectsFromProjectsResponse200Preset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsFromProjectsResponse200Preset = ClosedEnum<typeof GetProjectsFromProjectsResponse200Preset>;
/**
...
export declare const GetProjectsFromProjectsResponsePreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsFromProjectsResponsePreset = ClosedEnum<typeof GetProjectsFromProjectsResponsePreset>;
/**
 * The source envs on the trusted project that are allowed to access `to`.
 */
...
export type GetProjectsResponseBodyFrom = GetProjectsFromProjects1 | GetProjectsFromProjects2;
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset>;
/**
...
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody2 = {
     ...
     */
    slugs?: Array<string> | undefined;
    preset: GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset;
};
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset>;
/**
 * The target envs on the current project that may be accessed.
 */
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody1 = {
     ...
     */
    slugs: Array<string>;
    preset?: GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset | undefined;
};
export type GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo = GetProjectsToProjectsResponse200ApplicationJSONResponseBody1 | GetProjectsToProjectsResponse200ApplicationJSONResponseBody2;
/**
...
export type GetProjectsResponseBodyCustomAllow = {
    ...
    to: GetProjectsToProjectsResponse200ApplicationJSONResponseBody1 | GetProjectsToProjectsResponse200ApplicationJSONResponseBody2;
};
/** @internal */
...
/** @internal */
export declare const GetProjectsLogHeadersProjectsResponse2$inboundSchema: z.ZodNativeEnum<typeof GetProjectsLogHeadersProjectsResponse2>;
/** @internal */
export declare const GetProjectsLogHeadersProjectsResponse2$outboundSchema: z.ZodNativeEnum<typeof GetProjectsLogHeadersProjectsResponse2>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsLogHeaders$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsLogHeaders, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsLogHeaders$Outbound = Array<string> | string;
/** @internal */
export declare const GetProjectsResponseBodyProjectsLogHeaders$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsLogHeaders$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsLogHeaders>;
export declare function getProjectsResponseBodyProjectsLogHeadersToJSON(getProjectsResponseBodyProjectsLogHeaders: GetProjectsResponseBodyProjectsLogHeaders): string;
export declare function getProjectsResponseBodyProjectsLogHeadersFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsLogHeaders, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsSecurityPlusMetadata$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsSecurityPlusMetadata, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsSecurityPlusMetadata$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsSecurityPlusMetadata$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsSecurityPlusMetadata>;
export declare function getProjectsResponseBodyProjectsSecurityPlusMetadataToJSON(getProjectsResponseBodyProjectsSecurityPlusMetadata: GetProjectsResponseBodyProjectsSecurityPlusMetadata): string;
export declare function getProjectsResponseBodyProjectsSecurityPlusMetadataFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsSecurityPlusMetadata, SDKValidationError>;
/** @internal */
...
export type GetProjectsResponseBodyProjectsSecurity$Outbound = {
    ...
    securityPlus?: boolean | undefined;
    securityPlusMetadata?: GetProjectsResponseBodyProjectsSecurityPlusMetadata$Outbound | undefined;
    pageIntegrityEnabled?: boolean | undefined;
};
/** @internal */
...
/** @internal */
export declare const ResponseBodyFlatRateTier$inboundSchema: z.ZodNativeEnum<typeof ResponseBodyFlatRateTier>;
/** @internal */
export declare const ResponseBodyFlatRateTier$outboundSchema: z.ZodNativeEnum<typeof ResponseBodyFlatRateTier>;
/** @internal */
...
/** @internal */
export declare const GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey$inboundSchema: z.ZodNativeEnum<typeof GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey>;
/** @internal */
export declare const GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey$outboundSchema: z.ZodNativeEnum<typeof GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3ProjectsKey>;
/** @internal */
...
/** @internal */
export type GetProjectsRouteProjectsResponse200ApplicationJSONResponseBodyHas$Outbound = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3Projects1$Outbound | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody3Projects2$Outbound;
/** @internal */
...
/** @internal */
export type GetProjectsRouteProjectsResponse200ApplicationJSONHas$Outbound = GetProjectsHasProjectsResponse200ApplicationJSONResponseBody31$Outbound | GetProjectsHasProjectsResponse200ApplicationJSONResponseBody32$Outbound;
/** @internal */
...
/** @internal */
export type GetProjectsResponseBodyProjectsBlockHistory$Outbound = GetProjectsBlockHistoryProjectsResponse1$Outbound | GetProjectsBlockHistoryProjectsResponse2$Outbound | GetProjectsBlockHistoryProjectsResponse3$Outbound | GetProjectsBlockHistoryProjectsResponse4$Outbound;
/** @internal */
...
/** @internal */
export type GetProjectsInternalRoutesProjectsResponseHas$Outbound = GetProjectsHasProjectsResponse1$Outbound | GetProjectsHasProjectsResponse2$Outbound;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponseEnv$inboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyProjectsResponseEnv>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponseEnv$outboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyProjectsResponseEnv>;
/** @internal */
export declare const ResponseBodySamplingRules$inboundSchema: z.ZodType<ResponseBodySamplingRules, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ResponseBodySamplingRules$outboundSchema: z.ZodType<ResponseBodySamplingRules$Outbound, z.ZodTypeDef, ResponseBodySamplingRules>;
export declare function responseBodySamplingRulesToJSON(responseBodySamplingRules: ResponseBodySamplingRules): string;
export declare function responseBodySamplingRulesFromJSON(jsonString: string): SafeParseResult<ResponseBodySamplingRules, SDKValidationError>;
/** @internal */
export declare const ResponseBodyTracing$inboundSchema: z.ZodType<ResponseBodyTracing, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyTracing$outboundSchema: z.ZodType<ResponseBodyTracing$Outbound, z.ZodTypeDef, ResponseBodyTracing>;
export declare function responseBodyTracingToJSON(responseBodyTracing: ResponseBodyTracing): string;
export declare function responseBodyTracingFromJSON(jsonString: string): SafeParseResult<ResponseBodyTracing, SDKValidationError>;
/** @internal */
...
export type GetProjectsResponseBodyProjects$Outbound = {
    ...
    delegatedProtection?: ResponseBodyDelegatedProtection$Outbound | null | undefined;
    ...
    trustedSources?: GetProjectsResponseBodyProjectsTrustedSources$Outbound | null | undefined;
...
/** @internal */
export declare const GetProjectsContentHintProjects17$inboundSchema: z.ZodType<GetProjectsContentHintProjects17, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsContentHintProjects17$outboundSchema: z.ZodType<GetProjectsContentHintProjects17$Outbound, z.ZodTypeDef, GetProjectsContentHintProjects17>;
export declare function getProjectsContentHintProjects17ToJSON(getProjectsContentHintProjects17: GetProjectsContentHintProjects17): string;
export declare function getProjectsContentHintProjects17FromJSON(jsonString: string): SafeParseResult<GetProjectsContentHintProjects17, SDKValidationError>;
/** @internal */
export declare const GetProjectsContentHintProjects16$inboundSchema: z.ZodType<GetProjectsContentHintProjects16, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsContentHintProjects16$outboundSchema: z.ZodType<GetProjectsContentHintProjects16$Outbound, z.ZodTypeDef, GetProjectsContentHintProjects16>;
export declare function getProjectsContentHintProjects16ToJSON(getProjectsContentHintProjects16: GetProjectsContentHintProjects16): string;
export declare function getProjectsContentHintProjects16FromJSON(jsonString: string): SafeParseResult<GetProjectsContentHintProjects16, SDKValidationError>;
/** @internal */
...
export type GetProjectsResponseBodyEnv$Outbound = {
    ...
    edgeConfigId?: string | null | undefined;
    edgeConfigTokenId?: string | null | undefined;
    contentHint?: GetProjectsContentHintProjects1$Outbound | GetProjectsContentHintProjects2$Outbound | GetProjectsContentHintProjects3$Outbound | GetProjectsContentHintProjects4$Outbound | GetProjectsContentHintProjects5$Outbound | GetProjectsContentHintProjects6$Outbound | GetProjectsContentHintProjects7$Outbound | GetProjectsContentHintProjects8$Outbound | GetProjectsContentHintProjects9$Outbound | GetProjectsContentHintProjects10$Outbound | GetProjectsContentHintProjects11$Outbound | GetProjectsContentHintProjects12$Outbound | GetProjectsContentHintProjects13$Outbound | GetProjectsContentHintProjects14$Outbound | GetProjectsContentHintProjects15$Outbound | GetProjectsContentHintProjects16$Outbound | GetProjectsContentHintProjects17$Outbound | null | undefined;
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks$inboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks$outboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks$Outbound, z.ZodTypeDef, GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks>;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooksToJSON(getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks: GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks): string;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooksFromJSON(jsonString: string): SafeParseResult<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks, SDKValidationError>;
/** @internal */
export declare const GetProjectsLinkProjects6$inboundSchema: z.ZodType<GetProjectsLinkProjects6, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsLinkProjects6$Outbound = {
    ...
    type: "vercel";
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects6DeployHooks$Outbound>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
/** @internal */
export declare const GetProjectsLinkProjects6$outboundSchema: z.ZodType<GetProjectsLinkProjects6$Outbound, z.ZodTypeDef, GetProjectsLinkProjects6>;
export declare function getProjectsLinkProjects6ToJSON(getProjectsLinkProjects6: GetProjectsLinkProjects6): string;
export declare function getProjectsLinkProjects6FromJSON(jsonString: string): SafeParseResult<GetProjectsLinkProjects6, SDKValidationError>;
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks$inboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks$outboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks$Outbound, z.ZodTypeDef, GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks>;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooksToJSON(getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks: GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks): string;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooksFromJSON(jsonString: string): SafeParseResult<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks, SDKValidationError>;
/** @internal */
...
export type GetProjectsLinkProjects5$Outbound = {
    ...
    workspaceUuid: string;
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects5DeployHooks$Outbound>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks$inboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks$outboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks$Outbound, z.ZodTypeDef, GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks>;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooksToJSON(getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks: GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks): string;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooksFromJSON(jsonString: string): SafeParseResult<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks, SDKValidationError>;
/** @internal */
...
export type GetProjectsLinkProjects4$Outbound = {
    ...
    type: "gitlab";
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects4DeployHooks$Outbound>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks$inboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks$outboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks$Outbound, z.ZodTypeDef, GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks>;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooksToJSON(getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks: GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks): string;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooksFromJSON(jsonString: string): SafeParseResult<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks, SDKValidationError>;
/** @internal */
...
export type GetProjectsLinkProjects3$Outbound = {
    ...
    host: string;
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody2Projects3DeployHooks$Outbound>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
/** @internal */
export type GetProjectsResponseBodyLink$Outbound = GetProjectsLinkProjects1$Outbound | GetProjectsLinkProjects2$Outbound | GetProjectsLinkProjects3$Outbound | GetProjectsLinkProjects4$Outbound | GetProjectsLinkProjects5$Outbound | GetProjectsLinkProjects6$Outbound;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom$inboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom>;
/** @internal */
export declare const GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom$outboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyApril2026SecurityIncidentMigrationAppliedFrom>;
/** @internal */
...
/** @internal */
export declare const GetProjectsFromProjectsResponse200Preset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponse200Preset>;
/** @internal */
export declare const GetProjectsFromProjectsResponse200Preset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponse200Preset>;
/** @internal */
export declare const GetProjectsFromProjects2$inboundSchema: z.ZodType<GetProjectsFromProjects2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsFromProjects2$outboundSchema: z.ZodType<GetProjectsFromProjects2$Outbound, z.ZodTypeDef, GetProjectsFromProjects2>;
export declare function getProjectsFromProjects2ToJSON(getProjectsFromProjects2: GetProjectsFromProjects2): string;
export declare function getProjectsFromProjects2FromJSON(jsonString: string): SafeParseResult<GetProjectsFromProjects2, SDKValidationError>;
/** @internal */
export declare const GetProjectsFromProjectsResponsePreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponsePreset>;
/** @internal */
export declare const GetProjectsFromProjectsResponsePreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponsePreset>;
/** @internal */
export declare const GetProjectsFromProjects1$inboundSchema: z.ZodType<GetProjectsFromProjects1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsFromProjects1$outboundSchema: z.ZodType<GetProjectsFromProjects1$Outbound, z.ZodTypeDef, GetProjectsFromProjects1>;
export declare function getProjectsFromProjects1ToJSON(getProjectsFromProjects1: GetProjectsFromProjects1): string;
export declare function getProjectsFromProjects1FromJSON(jsonString: string): SafeParseResult<GetProjectsFromProjects1, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyFrom$inboundSchema: z.ZodType<GetProjectsResponseBodyFrom, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyFrom$Outbound = GetProjectsFromProjects1$Outbound | GetProjectsFromProjects2$Outbound;
/** @internal */
export declare const GetProjectsResponseBodyFrom$outboundSchema: z.ZodType<GetProjectsResponseBodyFrom$Outbound, z.ZodTypeDef, GetProjectsResponseBodyFrom>;
export declare function getProjectsResponseBodyFromToJSON(getProjectsResponseBodyFrom: GetProjectsResponseBodyFrom): string;
export declare function getProjectsResponseBodyFromFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyFrom, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody2ProjectsPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2$inboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJSONResponseBody2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2$outboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJSONResponseBody2$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse200ApplicationJSONResponseBody2>;
export declare function getProjectsToProjectsResponse200ApplicationJSONResponseBody2ToJSON(getProjectsToProjectsResponse200ApplicationJSONResponseBody2: GetProjectsToProjectsResponse200ApplicationJSONResponseBody2): string;
export declare function getProjectsToProjectsResponse200ApplicationJSONResponseBody2FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse200ApplicationJSONResponseBody2, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody2Preset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody1$inboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJSONResponseBody1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody1$outboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJSONResponseBody1$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse200ApplicationJSONResponseBody1>;
export declare function getProjectsToProjectsResponse200ApplicationJSONResponseBody1ToJSON(getProjectsToProjectsResponse200ApplicationJSONResponseBody1: GetProjectsToProjectsResponse200ApplicationJSONResponseBody1): string;
export declare function getProjectsToProjectsResponse200ApplicationJSONResponseBody1FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse200ApplicationJSONResponseBody1, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo$Outbound = GetProjectsToProjectsResponse200ApplicationJSONResponseBody1$Outbound | GetProjectsToProjectsResponse200ApplicationJSONResponseBody2$Outbound;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo>;
export declare function getProjectsResponseBodyProjectsResponse200ApplicationJSONToToJSON(getProjectsResponseBodyProjectsResponse200ApplicationJSONTo: GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo): string;
export declare function getProjectsResponseBodyProjectsResponse200ApplicationJSONToFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsResponse200ApplicationJSONTo, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyCustomAllow$inboundSchema: z.ZodType<GetProjectsResponseBodyCustomAllow, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyCustomAllow$Outbound = {
    ...
    to: GetProjectsToProjectsResponse200ApplicationJSONResponseBody1$Outbound | GetProjectsToProjectsResponse200ApplicationJSONResponseBody2$Outbound;
};
/** @internal */
export declare const GetProjectsResponseBodyCustomAllow$outboundSchema: z.ZodType<GetProjectsResponseBodyCustomAllow$Outbound, z.ZodTypeDef, GetProjectsResponseBodyCustomAllow>;
export declare function getProjectsResponseBodyCustomAllowToJSON(getProjectsResponseBodyCustomAllow: GetProjectsResponseBodyCustomAllow): string;
export declare function getProjectsResponseBodyCustomAllowFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyCustomAllow, SDKValidationError>;
//# sourceMappingURL=getprojectsresponsebodycustomallow.d.ts.map