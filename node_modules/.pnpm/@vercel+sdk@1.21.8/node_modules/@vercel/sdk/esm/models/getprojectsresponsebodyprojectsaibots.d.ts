 ...
 */
export declare const GetProjectsResponseBodySource: {
    readonly Api: "api";
};
/**
 * The origin of this definition. 'api' means created via the API. Undefined means it originated from a deployment (vercel.json).
 */
export type GetProjectsResponseBodySource = ClosedEnum<typeof GetProjectsResponseBodySource>;
...
export type ResponseBodyExpiration = GetProjectsExpiration2 | GetProjectsExpiration1;
...
export type GetProjectsResponseBodyProjectsEnv = {
    ...
    contentHint?: GetProjectsContentHintProjectsResponse1 | GetProjectsContentHintProjectsResponse2 | GetProjectsContentHintProjectsResponse3 | GetProjectsContentHintProjectsResponse4 | GetProjectsContentHintProjectsResponse5 | GetProjectsContentHintProjectsResponse6 | GetProjectsContentHintProjectsResponse7 | GetProjectsContentHintProjectsResponse8 | GetProjectsContentHintProjectsResponse9 | GetProjectsContentHintProjectsResponse10 | GetProjectsContentHintProjectsResponse11 | GetProjectsContentHintProjectsResponse12 | GetProjectsContentHintProjectsResponse13 | GetProjectsContentHintProjectsResponse14 | GetProjectsContentHintProjectsResponse15 | GetProjectsContentHintProjectsResponse16 | GetProjectsContentHintProjectsResponse17 | null | undefined;
    /**
     * Similar to `contentHints`, but should not be exposed to the user.
     */
...
export type GetProjectsLinkProjectsResponse6 = {
    ...
    type: "vercel";
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks>;
...
export type GetProjectsResponseBodyProjectsLink = GetProjectsLinkProjectsResponse1 | GetProjectsLinkProjectsResponse2 | GetProjectsLinkProjectsResponse3 | GetProjectsLinkProjectsResponse4 | GetProjectsLinkProjectsResponse5 | GetProjectsLinkProjectsResponse6;
...
export declare const GetProjectsResponseBodyProjectsResponse200Configuration: {
    readonly SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE";
    readonly WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE";
};
export type GetProjectsResponseBodyProjectsResponse200Configuration = ClosedEnum<typeof GetProjectsResponseBodyProjectsResponse200Configuration>;
export type GetProjectsResponseBodyProjectsResponseBuildQueue = {
    configuration?: GetProjectsResponseBodyProjectsResponse200Configuration | undefined;
};
...
export declare const GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom: {
    readonly Preview: "preview";
    readonly All: "all";
    readonly ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews";
    readonly AllExceptCustomDomains: "all_except_custom_domains";
};
export type GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom = ClosedEnum<typeof GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom>;
export type GetProjectsResponseBodyProjectsSsoProtection = {
    ...
    april2026SecurityIncidentMigrationAppliedFrom?: GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom | null | undefined;
};
export type GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned = number | boolean;
...
export declare const GetProjectsFromProjectsResponse200ApplicationJSONResponseBodyPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsFromProjectsResponse200ApplicationJSONResponseBodyPreset = ClosedEnum<typeof GetProjectsFromProjectsResponse200ApplicationJSONResponseBodyPreset>;
/**
...
export declare const GetProjectsFromProjectsResponse200ApplicationJSONPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsFromProjectsResponse200ApplicationJSONPreset = ClosedEnum<typeof GetProjectsFromProjectsResponse200ApplicationJSONPreset>;
/**
 * The source envs on the trusted project that are allowed to access `to`.
 */
...
export type GetProjectsResponseBodyProjectsFrom = GetProjectsFromProjectsResponse1 | GetProjectsFromProjectsResponse2;
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset>;
/**
...
export type GetProjectsToProjectsResponse200ApplicationJson2 = {
     ...
     */
    slugs?: Array<string> | undefined;
    preset: GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset;
};
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset>;
/**
 * The target envs on the current project that may be accessed.
 */
export type GetProjectsToProjectsResponse200ApplicationJson1 = {
     ...
     */
    slugs: Array<string>;
    preset?: GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset | undefined;
};
export type GetProjectsResponseBodyProjectsResponse200To = GetProjectsToProjectsResponse200ApplicationJson1 | GetProjectsToProjectsResponse200ApplicationJson2;
/**
...
export type GetProjectsResponseBodyProjectsCustomAllow = {
    ...
    to: GetProjectsToProjectsResponse200ApplicationJson1 | GetProjectsToProjectsResponse200ApplicationJson2;
};
...
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset>;
/**
 * The target envs on the current project that may be accessed.
 */
export type GetProjectsToProjectsResponse2002 = {
     ...
     */
    slugs?: Array<string> | undefined;
    preset: GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset;
};
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset: {
    readonly AllCustom: "all-custom";
};
export type GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset = ClosedEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset>;
/**
 * The target envs on the current project that may be accessed.
 */
export type GetProjectsToProjectsResponse2001 = {
     ...
     */
    slugs: Array<string>;
    preset?: GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset | undefined;
};
export type GetProjectsResponseBodyProjectsResponseTo = GetProjectsToProjectsResponse2001 | GetProjectsToProjectsResponse2002;
...
export type GetProjectsResponseBodyProjectsGitProviderOptions = {
     ...
     * Configuration for consolidated git commit status reporting. When enabled, Vercel will post a single consolidated commit status instead of individual statuses for each deployment.
     */
    consolidatedGitCommitStatus?: GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus | undefined;
};
...
/** @internal */
export declare const GetProjectsResponseBodySource$inboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodySource>;
/** @internal */
export declare const GetProjectsResponseBodySource$outboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodySource>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyDelegatedProtection$inboundSchema: z.ZodType<ResponseBodyDelegatedProtection, z.ZodTypeDef, unknown>;
/** @internal */
export type ResponseBodyDelegatedProtection$Outbound = {};
/** @internal */
export declare const ResponseBodyDelegatedProtection$outboundSchema: z.ZodType<ResponseBodyDelegatedProtection$Outbound, z.ZodTypeDef, ResponseBodyDelegatedProtection>;
export declare function responseBodyDelegatedProtectionToJSON(responseBodyDelegatedProtection: ResponseBodyDelegatedProtection): string;
export declare function responseBodyDelegatedProtectionFromJSON(jsonString: string): SafeParseResult<ResponseBodyDelegatedProtection, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetProjectsExpiration2$inboundSchema: z.ZodType<GetProjectsExpiration2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsExpiration2$outboundSchema: z.ZodType<GetProjectsExpiration2$Outbound, z.ZodTypeDef, GetProjectsExpiration2>;
export declare function getProjectsExpiration2ToJSON(getProjectsExpiration2: GetProjectsExpiration2): string;
export declare function getProjectsExpiration2FromJSON(jsonString: string): SafeParseResult<GetProjectsExpiration2, SDKValidationError>;
/** @internal */
export declare const GetProjectsExpiration1$inboundSchema: z.ZodType<GetProjectsExpiration1, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsExpiration1$Outbound = {
    expiresAt: number;
};
/** @internal */
export declare const GetProjectsExpiration1$outboundSchema: z.ZodType<GetProjectsExpiration1$Outbound, z.ZodTypeDef, GetProjectsExpiration1>;
export declare function getProjectsExpiration1ToJSON(getProjectsExpiration1: GetProjectsExpiration1): string;
export declare function getProjectsExpiration1FromJSON(jsonString: string): SafeParseResult<GetProjectsExpiration1, SDKValidationError>;
/** @internal */
export declare const ResponseBodyExpiration$inboundSchema: z.ZodType<ResponseBodyExpiration, z.ZodTypeDef, unknown>;
/** @internal */
export type ResponseBodyExpiration$Outbound = GetProjectsExpiration2$Outbound | GetProjectsExpiration1$Outbound;
/** @internal */
export declare const ResponseBodyExpiration$outboundSchema: z.ZodType<ResponseBodyExpiration$Outbound, z.ZodTypeDef, ResponseBodyExpiration>;
export declare function responseBodyExpirationToJSON(responseBodyExpiration: ResponseBodyExpiration): string;
export declare function responseBodyExpirationFromJSON(jsonString: string): SafeParseResult<ResponseBodyExpiration, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetProjectsContentHintProjectsResponse17$inboundSchema: z.ZodType<GetProjectsContentHintProjectsResponse17, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsContentHintProjectsResponse17$outboundSchema: z.ZodType<GetProjectsContentHintProjectsResponse17$Outbound, z.ZodTypeDef, GetProjectsContentHintProjectsResponse17>;
export declare function getProjectsContentHintProjectsResponse17ToJSON(getProjectsContentHintProjectsResponse17: GetProjectsContentHintProjectsResponse17): string;
export declare function getProjectsContentHintProjectsResponse17FromJSON(jsonString: string): SafeParseResult<GetProjectsContentHintProjectsResponse17, SDKValidationError>;
/** @internal */
export declare const GetProjectsContentHintProjectsResponse16$inboundSchema: z.ZodType<GetProjectsContentHintProjectsResponse16, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsContentHintProjectsResponse16$outboundSchema: z.ZodType<GetProjectsContentHintProjectsResponse16$Outbound, z.ZodTypeDef, GetProjectsContentHintProjectsResponse16>;
export declare function getProjectsContentHintProjectsResponse16ToJSON(getProjectsContentHintProjectsResponse16: GetProjectsContentHintProjectsResponse16): string;
export declare function getProjectsContentHintProjectsResponse16FromJSON(jsonString: string): SafeParseResult<GetProjectsContentHintProjectsResponse16, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyLint$inboundSchema: z.ZodType<ResponseBodyLint, z.ZodTypeDef, unknown>;
/** @internal */
export type ResponseBodyLint$Outbound = {
    targets: Array<string>;
};
/** @internal */
export declare const ResponseBodyLint$outboundSchema: z.ZodType<ResponseBodyLint$Outbound, z.ZodTypeDef, ResponseBodyLint>;
export declare function responseBodyLintToJSON(responseBodyLint: ResponseBodyLint): string;
export declare function responseBodyLintFromJSON(jsonString: string): SafeParseResult<ResponseBodyLint, SDKValidationError>;
/** @internal */
export declare const ResponseBodyTypecheck$inboundSchema: z.ZodType<ResponseBodyTypecheck, z.ZodTypeDef, unknown>;
/** @internal */
export type ResponseBodyTypecheck$Outbound = {
    targets: Array<string>;
};
/** @internal */
export declare const ResponseBodyTypecheck$outboundSchema: z.ZodType<ResponseBodyTypecheck$Outbound, z.ZodTypeDef, ResponseBodyTypecheck>;
export declare function responseBodyTypecheckToJSON(responseBodyTypecheck: ResponseBodyTypecheck): string;
export declare function responseBodyTypecheckFromJSON(jsonString: string): SafeParseResult<ResponseBodyTypecheck, SDKValidationError>;
/** @internal */
export declare const ResponseBodyJobs$inboundSchema: z.ZodType<ResponseBodyJobs, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyJobs$outboundSchema: z.ZodType<ResponseBodyJobs$Outbound, z.ZodTypeDef, ResponseBodyJobs>;
export declare function responseBodyJobsToJSON(responseBodyJobs: ResponseBodyJobs): string;
export declare function responseBodyJobsFromJSON(jsonString: string): SafeParseResult<ResponseBodyJobs, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks$inboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks$outboundSchema: z.ZodType<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks$Outbound, z.ZodTypeDef, GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks>;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooksToJSON(getProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks: GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks): string;
export declare function getProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooksFromJSON(jsonString: string): SafeParseResult<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks, SDKValidationError>;
/** @internal */
export declare const GetProjectsLinkProjectsResponse6$inboundSchema: z.ZodType<GetProjectsLinkProjectsResponse6, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsLinkProjectsResponse6$Outbound = {
    ...
    type: "vercel";
    createdAt?: number | undefined;
    deployHooks: Array<GetProjectsLinkProjectsResponse200ApplicationJSONResponseBody3Projects6DeployHooks$Outbound>;
    gitCredentialId: string;
    updatedAt?: number | undefined;
    sourceless?: boolean | undefined;
    productionBranch: string;
...
/** @internal */
export declare const GetProjectsLinkProjectsResponse6$outboundSchema: z.ZodType<GetProjectsLinkProjectsResponse6$Outbound, z.ZodTypeDef, GetProjectsLinkProjectsResponse6>;
export declare function getProjectsLinkProjectsResponse6ToJSON(getProjectsLinkProjectsResponse6: GetProjectsLinkProjectsResponse6): string;
export declare function getProjectsLinkProjectsResponse6FromJSON(jsonString: string): SafeParseResult<GetProjectsLinkProjectsResponse6, SDKValidationError>;
/** @internal */
...
/** @internal */
export type GetProjectsResponseBodyProjectsLink$Outbound = GetProjectsLinkProjectsResponse1$Outbound | GetProjectsLinkProjectsResponse2$Outbound | GetProjectsLinkProjectsResponse3$Outbound | GetProjectsLinkProjectsResponse4$Outbound | GetProjectsLinkProjectsResponse5$Outbound | GetProjectsLinkProjectsResponse6$Outbound;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200Configuration$inboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyProjectsResponse200Configuration>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200Configuration$outboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyProjectsResponse200Configuration>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom$inboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom$outboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodyProjectsApril2026SecurityIncidentMigrationAppliedFrom>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned$Outbound = number | boolean;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned>;
export declare function getProjectsResponseBodyProjectsResponse200ApplicationJSON3AliasAssignedToJSON(getProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned: GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned): string;
export declare function getProjectsResponseBodyProjectsResponse200ApplicationJSON3AliasAssignedFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsResponse200ApplicationJson3AliasAssigned, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetProjectsFromProjectsResponse200ApplicationJSONResponseBodyPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponse200ApplicationJSONResponseBodyPreset>;
/** @internal */
export declare const GetProjectsFromProjectsResponse200ApplicationJSONResponseBodyPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponse200ApplicationJSONResponseBodyPreset>;
/** @internal */
export declare const GetProjectsFromProjectsResponse2$inboundSchema: z.ZodType<GetProjectsFromProjectsResponse2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsFromProjectsResponse2$outboundSchema: z.ZodType<GetProjectsFromProjectsResponse2$Outbound, z.ZodTypeDef, GetProjectsFromProjectsResponse2>;
export declare function getProjectsFromProjectsResponse2ToJSON(getProjectsFromProjectsResponse2: GetProjectsFromProjectsResponse2): string;
export declare function getProjectsFromProjectsResponse2FromJSON(jsonString: string): SafeParseResult<GetProjectsFromProjectsResponse2, SDKValidationError>;
/** @internal */
export declare const GetProjectsFromProjectsResponse200ApplicationJSONPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponse200ApplicationJSONPreset>;
/** @internal */
export declare const GetProjectsFromProjectsResponse200ApplicationJSONPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsFromProjectsResponse200ApplicationJSONPreset>;
/** @internal */
export declare const GetProjectsFromProjectsResponse1$inboundSchema: z.ZodType<GetProjectsFromProjectsResponse1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsFromProjectsResponse1$outboundSchema: z.ZodType<GetProjectsFromProjectsResponse1$Outbound, z.ZodTypeDef, GetProjectsFromProjectsResponse1>;
export declare function getProjectsFromProjectsResponse1ToJSON(getProjectsFromProjectsResponse1: GetProjectsFromProjectsResponse1): string;
export declare function getProjectsFromProjectsResponse1FromJSON(jsonString: string): SafeParseResult<GetProjectsFromProjectsResponse1, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsFrom$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsFrom, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsFrom$Outbound = GetProjectsFromProjectsResponse1$Outbound | GetProjectsFromProjectsResponse2$Outbound;
/** @internal */
export declare const GetProjectsResponseBodyProjectsFrom$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsFrom$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsFrom>;
export declare function getProjectsResponseBodyProjectsFromToJSON(getProjectsResponseBodyProjectsFrom: GetProjectsResponseBodyProjectsFrom): string;
export declare function getProjectsResponseBodyProjectsFromFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsFrom, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesProjectsPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJson2$inboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJson2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJson2$outboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJson2$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse200ApplicationJson2>;
export declare function getProjectsToProjectsResponse200ApplicationJSON2ToJSON(getProjectsToProjectsResponse200ApplicationJson2: GetProjectsToProjectsResponse200ApplicationJson2): string;
export declare function getProjectsToProjectsResponse200ApplicationJSON2FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse200ApplicationJson2, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsTrustedSourcesPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJson1$inboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJson1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJson1$outboundSchema: z.ZodType<GetProjectsToProjectsResponse200ApplicationJson1$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse200ApplicationJson1>;
export declare function getProjectsToProjectsResponse200ApplicationJSON1ToJSON(getProjectsToProjectsResponse200ApplicationJson1: GetProjectsToProjectsResponse200ApplicationJson1): string;
export declare function getProjectsToProjectsResponse200ApplicationJSON1FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse200ApplicationJson1, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200To$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200To, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsResponse200To$Outbound = GetProjectsToProjectsResponse200ApplicationJson1$Outbound | GetProjectsToProjectsResponse200ApplicationJson2$Outbound;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponse200To$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponse200To$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsResponse200To>;
export declare function getProjectsResponseBodyProjectsResponse200ToToJSON(getProjectsResponseBodyProjectsResponse200To: GetProjectsResponseBodyProjectsResponse200To): string;
export declare function getProjectsResponseBodyProjectsResponse200ToFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsResponse200To, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsCustomAllow$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsCustomAllow, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsCustomAllow$Outbound = {
    from: GetProjectsFromProjectsResponse1$Outbound | GetProjectsFromProjectsResponse2$Outbound;
    to: GetProjectsToProjectsResponse200ApplicationJson1$Outbound | GetProjectsToProjectsResponse200ApplicationJson2$Outbound;
};
/** @internal */
export declare const GetProjectsResponseBodyProjectsCustomAllow$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsCustomAllow$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsCustomAllow>;
export declare function getProjectsResponseBodyProjectsCustomAllowToJSON(getProjectsResponseBodyProjectsCustomAllow: GetProjectsResponseBodyProjectsCustomAllow): string;
export declare function getProjectsResponseBodyProjectsCustomAllowFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsCustomAllow, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponseProjects$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponseProjects, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsResponseProjects$Outbound = {
    label?: string | undefined;
    customAllow?: Array<GetProjectsResponseBodyProjectsCustomAllow$Outbound> | undefined;
};
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponseProjects$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponseProjects$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsResponseProjects>;
export declare function getProjectsResponseBodyProjectsResponseProjectsToJSON(getProjectsResponseBodyProjectsResponseProjects: GetProjectsResponseBodyProjectsResponseProjects): string;
export declare function getProjectsResponseBodyProjectsResponseProjectsFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsResponseProjects, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3ProjectsPreset>;
/** @internal */
export declare const GetProjectsToProjectsResponse2002$inboundSchema: z.ZodType<GetProjectsToProjectsResponse2002, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse2002$outboundSchema: z.ZodType<GetProjectsToProjectsResponse2002$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse2002>;
export declare function getProjectsToProjectsResponse2002ToJSON(getProjectsToProjectsResponse2002: GetProjectsToProjectsResponse2002): string;
export declare function getProjectsToProjectsResponse2002FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse2002, SDKValidationError>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset$inboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset>;
/** @internal */
export declare const GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset$outboundSchema: z.ZodNativeEnum<typeof GetProjectsToProjectsResponse200ApplicationJSONResponseBody3Preset>;
/** @internal */
export declare const GetProjectsToProjectsResponse2001$inboundSchema: z.ZodType<GetProjectsToProjectsResponse2001, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsToProjectsResponse2001$outboundSchema: z.ZodType<GetProjectsToProjectsResponse2001$Outbound, z.ZodTypeDef, GetProjectsToProjectsResponse2001>;
export declare function getProjectsToProjectsResponse2001ToJSON(getProjectsToProjectsResponse2001: GetProjectsToProjectsResponse2001): string;
export declare function getProjectsToProjectsResponse2001FromJSON(jsonString: string): SafeParseResult<GetProjectsToProjectsResponse2001, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponseTo$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponseTo, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsResponseTo$Outbound = GetProjectsToProjectsResponse2001$Outbound | GetProjectsToProjectsResponse2002$Outbound;
/** @internal */
export declare const GetProjectsResponseBodyProjectsResponseTo$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsResponseTo$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsResponseTo>;
export declare function getProjectsResponseBodyProjectsResponseToToJSON(getProjectsResponseBodyProjectsResponseTo: GetProjectsResponseBodyProjectsResponseTo): string;
export declare function getProjectsResponseBodyProjectsResponseToFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsResponseTo, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsOidcProviders$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsOidcProviders, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsResponseBodyProjectsOidcProviders$Outbound = {
    to: GetProjectsToProjectsResponse2001$Outbound | GetProjectsToProjectsResponse2002$Outbound;
    label?: string | undefined;
    claims: {
        [k: string]: Array<string>;
    };
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsOidcProviders$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsOidcProviders$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsOidcProviders>;
export declare function getProjectsResponseBodyProjectsOidcProvidersToJSON(getProjectsResponseBodyProjectsOidcProviders: GetProjectsResponseBodyProjectsOidcProviders): string;
export declare function getProjectsResponseBodyProjectsOidcProvidersFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsOidcProviders, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodyProjectsTrustedSources$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsTrustedSources, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsTrustedSources$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsTrustedSources$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsTrustedSources>;
export declare function getProjectsResponseBodyProjectsTrustedSourcesToJSON(getProjectsResponseBodyProjectsTrustedSources: GetProjectsResponseBodyProjectsTrustedSources): string;
export declare function getProjectsResponseBodyProjectsTrustedSourcesFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsTrustedSources, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus$inboundSchema: z.ZodType<GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus$outboundSchema: z.ZodType<GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus$Outbound, z.ZodTypeDef, GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus>;
export declare function getProjectsResponseBodyProjectsConsolidatedGitCommitStatusToJSON(getProjectsResponseBodyProjectsConsolidatedGitCommitStatus: GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus): string;
export declare function getProjectsResponseBodyProjectsConsolidatedGitCommitStatusFromJSON(jsonString: string): SafeParseResult<GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus, SDKValidationError>;
/** @internal */
...
export type GetProjectsResponseBodyProjectsGitProviderOptions$Outbound = {
    ...
    requireVerifiedCommits?: boolean | undefined;
    gitCommitStatus?: boolean | undefined;
    consolidatedGitCommitStatus?: GetProjectsResponseBodyProjectsConsolidatedGitCommitStatus$Outbound | undefined;
};
/** @internal */
...
//# sourceMappingURL=getprojectsresponsebodyprojectsaibots.d.ts.map