...
export declare const GetProjectsSourcesProjectsProvider: {
    readonly Github: "github";
    readonly Gitlab: "gitlab";
    readonly Bitbucket: "bitbucket";
};
export type GetProjectsSourcesProjectsProvider = ClosedEnum<typeof GetProjectsSourcesProjectsProvider>;
export type GetProjectsSources2 = {
    provider: GetProjectsSourcesProjectsProvider;
    org: string;
    repo: string;
};
export declare const GetProjectsSourcesProvider: {
    readonly Github: "github";
    readonly Gitlab: "gitlab";
    readonly Bitbucket: "bitbucket";
};
export type GetProjectsSourcesProvider = ClosedEnum<typeof GetProjectsSourcesProvider>;
 ...
 */
export declare const GetProjectsResponseBodySources: {
    readonly Git: "git";
    readonly Cli: "cli";
 ...
 * The mechanism that produced a deployment, expressed as values a customer can write in a {@link DeploymentSourcesRule} allowlist. The JSON schema at `packages/deployment-policy/schemas/body.ts` enumerates exactly these values. - `'git'`: a Git provider webhook (GitHub / GitLab / Bitbucket). - `'cli'`: an upload via the Vercel CLI. Covers both the legacy CLI (classic user token, identified by `vercel`/`now` user-agent) and the Sign-In-With-Vercel CLI (a first-party Vercel App token whose `clientId` is the CLI's). The canonical CLI client IDs are tracked in `packages/acl/app-has-all-permissions.ts` (`isVercelCliApp`). - `'rest-api'`: a direct REST API upload — a user or team token POSTing directly. Does NOT cover deploy-hook URLs, Marketplace integration tokens, or first-party Vercel App tokens; those are their own sources. - `'deploy-hook'`: a trigger via a project deploy-hook URL. The URL itself is the credential, so the request has no authenticated principal. - `'integration'`: a **third-party Marketplace** OAuth2 actor — a Marketplace integration token, a user-delegated OAuth flow where a Marketplace integration is acting on a user's behalf, or an unrecognized third-party Vercel App token. First-party Vercel Apps are NEVER `'integration'`. Vercel-owned first-party apps other than the CLI (e.g. v0, Toolbar, Omni Agent) are *not* in this type — they aren't customer-configurable. They classify as `'first-party'` (see `ClassifiedSource` in `@api/deployment-policy/checks`) and are auto-allowed by `checkDeploymentSources`. The split is intentional: a team can permit their own automation and CLI usage while blocking third-party Marketplace integrators — and Vercel's own first-party tooling always works.
 */
export type GetProjectsResponseBodySources = ClosedEnum<typeof GetProjectsResponseBodySources>;
/**
...
/** @internal */
export declare const GetProjectsSourcesProjectsProvider$inboundSchema: z.ZodNativeEnum<typeof GetProjectsSourcesProjectsProvider>;
/** @internal */
export declare const GetProjectsSourcesProjectsProvider$outboundSchema: z.ZodNativeEnum<typeof GetProjectsSourcesProjectsProvider>;
/** @internal */
export declare const GetProjectsSources2$inboundSchema: z.ZodType<GetProjectsSources2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsSources2$outboundSchema: z.ZodType<GetProjectsSources2$Outbound, z.ZodTypeDef, GetProjectsSources2>;
export declare function getProjectsSources2ToJSON(getProjectsSources2: GetProjectsSources2): string;
export declare function getProjectsSources2FromJSON(jsonString: string): SafeParseResult<GetProjectsSources2, SDKValidationError>;
/** @internal */
export declare const GetProjectsSourcesProvider$inboundSchema: z.ZodNativeEnum<typeof GetProjectsSourcesProvider>;
/** @internal */
export declare const GetProjectsSourcesProvider$outboundSchema: z.ZodNativeEnum<typeof GetProjectsSourcesProvider>;
/** @internal */
export declare const GetProjectsSources1$inboundSchema: z.ZodType<GetProjectsSources1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetProjectsSources1$outboundSchema: z.ZodType<GetProjectsSources1$Outbound, z.ZodTypeDef, GetProjectsSources1>;
export declare function getProjectsSources1ToJSON(getProjectsSources1: GetProjectsSources1): string;
export declare function getProjectsSources1FromJSON(jsonString: string): SafeParseResult<GetProjectsSources1, SDKValidationError>;
/** @internal */
export declare const ResponseBodySources$inboundSchema: z.ZodType<ResponseBodySources, z.ZodTypeDef, unknown>;
/** @internal */
export type ResponseBodySources$Outbound = GetProjectsSources2$Outbound | GetProjectsSources1$Outbound;
/** @internal */
export declare const ResponseBodySources$outboundSchema: z.ZodType<ResponseBodySources$Outbound, z.ZodTypeDef, ResponseBodySources>;
export declare function responseBodySourcesToJSON(responseBodySources: ResponseBodySources): string;
export declare function responseBodySourcesFromJSON(jsonString: string): SafeParseResult<ResponseBodySources, SDKValidationError>;
/** @internal */
export declare const ResponseBodyGitSources$inboundSchema: z.ZodType<ResponseBodyGitSources, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyGitSources$outboundSchema: z.ZodType<ResponseBodyGitSources$Outbound, z.ZodTypeDef, ResponseBodyGitSources>;
export declare function responseBodyGitSourcesToJSON(responseBodyGitSources: ResponseBodyGitSources): string;
export declare function responseBodyGitSourcesFromJSON(jsonString: string): SafeParseResult<ResponseBodyGitSources, SDKValidationError>;
/** @internal */
export declare const GetProjectsResponseBodySources$inboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodySources>;
/** @internal */
export declare const GetProjectsResponseBodySources$outboundSchema: z.ZodNativeEnum<typeof GetProjectsResponseBodySources>;
/** @internal */
export declare const ResponseBodyDeploymentSources$inboundSchema: z.ZodType<ResponseBodyDeploymentSources, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyDeploymentSources$outboundSchema: z.ZodType<ResponseBodyDeploymentSources$Outbound, z.ZodTypeDef, ResponseBodyDeploymentSources>;
export declare function responseBodyDeploymentSourcesToJSON(responseBodyDeploymentSources: ResponseBodyDeploymentSources): string;
export declare function responseBodyDeploymentSourcesFromJSON(jsonString: string): SafeParseResult<ResponseBodyDeploymentSources, SDKValidationError>;
/** @internal */
export declare const ResponseBodyDeploymentPolicy$inboundSchema: z.ZodType<ResponseBodyDeploymentPolicy, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyDeploymentPolicy$outboundSchema: z.ZodType<ResponseBodyDeploymentPolicy$Outbound, z.ZodTypeDef, ResponseBodyDeploymentPolicy>;
export declare function responseBodyDeploymentPolicyToJSON(responseBodyDeploymentPolicy: ResponseBodyDeploymentPolicy): string;
export declare function responseBodyDeploymentPolicyFromJSON(jsonString: string): SafeParseResult<ResponseBodyDeploymentPolicy, SDKValidationError>;
/** @internal */
...
//# sourceMappingURL=getprojectsresponsebodytargets.d.ts.map