...
export type GetRedirectsResponseBody = GetRedirectsResponseBody2 | ResponseBody3 | {
    [k: string]: any;
};
/** @internal */
...
/** @internal */
export declare const GetRedirectsResponseBodyRedirects$inboundSchema: z.ZodType<GetRedirectsResponseBodyRedirects, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetRedirectsResponseBodyRedirects$outboundSchema: z.ZodType<GetRedirectsResponseBodyRedirects$Outbound, z.ZodTypeDef, GetRedirectsResponseBodyRedirects>;
export declare function getRedirectsResponseBodyRedirectsToJSON(getRedirectsResponseBodyRedirects: GetRedirectsResponseBodyRedirects): string;
export declare function getRedirectsResponseBodyRedirectsFromJSON(jsonString: string): SafeParseResult<GetRedirectsResponseBodyRedirects, SDKValidationError>;
/** @internal */
export declare const GetRedirectsResponseBodyVersion$inboundSchema: z.ZodType<GetRedirectsResponseBodyVersion, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetRedirectsResponseBodyVersion$outboundSchema: z.ZodType<GetRedirectsResponseBodyVersion$Outbound, z.ZodTypeDef, GetRedirectsResponseBodyVersion>;
export declare function getRedirectsResponseBodyVersionToJSON(getRedirectsResponseBodyVersion: GetRedirectsResponseBodyVersion): string;
export declare function getRedirectsResponseBodyVersionFromJSON(jsonString: string): SafeParseResult<GetRedirectsResponseBodyVersion, SDKValidationError>;
/** @internal */
export declare const GetRedirectsResponseBodyBulkRedirectsPagination$inboundSchema: z.ZodType<GetRedirectsResponseBodyBulkRedirectsPagination, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetRedirectsResponseBodyBulkRedirectsPagination$outboundSchema: z.ZodType<GetRedirectsResponseBodyBulkRedirectsPagination$Outbound, z.ZodTypeDef, GetRedirectsResponseBodyBulkRedirectsPagination>;
export declare function getRedirectsResponseBodyBulkRedirectsPaginationToJSON(getRedirectsResponseBodyBulkRedirectsPagination: GetRedirectsResponseBodyBulkRedirectsPagination): string;
export declare function getRedirectsResponseBodyBulkRedirectsPaginationFromJSON(jsonString: string): SafeParseResult<GetRedirectsResponseBodyBulkRedirectsPagination, SDKValidationError>;
/** @internal */
...
/** @internal */
export type GetRedirectsResponseBody$Outbound = GetRedirectsResponseBody2$Outbound | ResponseBody3$Outbound | {
    [k: string]: any;
};
/** @internal */
