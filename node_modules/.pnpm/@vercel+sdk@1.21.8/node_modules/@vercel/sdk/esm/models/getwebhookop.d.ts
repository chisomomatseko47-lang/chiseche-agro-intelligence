...
export declare const GetWebhookEvents: {
    ...
    readonly DeploymentBuildRequested: "deployment.build-requested";
    readonly DeploymentCleanup: "deployment.cleanup";
    readonly DeploymentError: "deployment.error";
    readonly DeploymentBlocked: "deployment.blocked";
    ...
    readonly FunctionArchivalRequired: "function.archival-required";
    readonly FunctionRemovalRequired: "function.removal-required";
    ...
    readonly FlagSegmentCreated: "flag.segment.created";
    readonly FlagSegmentUpdated: "flag.segment.updated";
    readonly FlagSegmentDeleted: "flag.segment.deleted";
    ...
    readonly CommentUpdated: "comment.updated";
    ...
    readonly CommentReactionAdded: "comment.reaction-added";
    readonly CommentReactionRemoved: "comment.reaction-removed";
    readonly CommentMentioned: "comment.mentioned";
};
/**
 * The webhooks events
 */
