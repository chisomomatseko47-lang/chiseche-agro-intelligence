...
import { Abuse, Abuse$Outbound, Credentials, Credentials$Outbound, EmailNotifications, EmailNotifications$Outbound, OverageMetadata, OverageMetadata$Outbound, OverageUsageAlerts, OverageUsageAlerts$Outbound, PayloadActiveDashboardViews, PayloadActiveDashboardViews$Outbound, PayloadBilling, PayloadBilling$Outbound, PayloadDataCache, PayloadDataCache$Outbound, PayloadDismissedToasts, PayloadDismissedToasts$Outbound, PayloadEnablePreviewFeedback, PayloadFavoriteProjectsAndSpaces, PayloadFavoriteProjectsAndSpaces$Outbound, PayloadFeatureBlocks, PayloadFeatureBlocks$Outbound, PayloadImportFlowGitNamespace, PayloadImportFlowGitNamespace$Outbound, PayloadImportFlowGitNamespaceId, PayloadImportFlowGitNamespaceId$Outbound, PayloadImportFlowGitProvider, PayloadPreferredScopesAndGitNamespaces, PayloadPreferredScopesAndGitNamespaces$Outbound, PayloadResourceConfig, PayloadResourceConfig$Outbound, PayloadSiftRoute, PayloadSiftRoute$Outbound, PayloadSoftBlock, PayloadSoftBlock$Outbound, PreventAutoBlocking, PreventAutoBlocking$Outbound, ResourceLimits, ResourceLimits$Outbound, SecondaryEmails, SecondaryEmails$Outbound, SiftScores, SiftScores$Outbound, Teams, Teams$Outbound, UsageAlerts, UsageAlerts$Outbound, UserEventPayload116Type, UserEventPayloadRemoteCaching, UserEventPayloadRemoteCaching$Outbound, Version } from "./version.js";
/**
 ...
 */
export declare const UserEventPayload116NewOwnerAction: {
 ...
 * The action that occurred
 */
export type UserEventPayload116NewOwnerAction = ClosedEnum<typeof UserEventPayload116NewOwnerAction>;
/**
...
export declare const UserEventPayload113Action: {
    readonly Log: "log";
    readonly Challenge: "challenge";
    readonly Deny: "deny";
};
export type UserEventPayload113Action = ClosedEnum<typeof UserEventPayload113Action>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload112Action: {
    readonly Log: "log";
    readonly Challenge: "challenge";
    readonly Deny: "deny";
};
export type UserEventPayload112Action = ClosedEnum<typeof UserEventPayload112Action>;
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export declare const UserEventPayload107NewEnvVarType: {
    readonly System: "system";
    readonly Encrypted: "encrypted";
    readonly Plain: "plain";
    readonly Sensitive: "sensitive";
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload107NewEnvVarType = ClosedEnum<typeof UserEventPayload107NewEnvVarType>;
/**
 * environments this env variable targets
 */
export declare const UserEventPayload107Target: {
    readonly Production: "production";
    readonly Preview: "preview";
    readonly Development: "development";
};
 ...
 * environments this env variable targets
 */
export type UserEventPayload107Target = ClosedEnum<typeof UserEventPayload107Target>;
...
export declare const UserEventPayload99ToAccountType: {
    readonly User: "user";
    readonly Team: "team";
};
export type UserEventPayload99ToAccountType = ClosedEnum<typeof UserEventPayload99ToAccountType>;
 ...
 */
export declare const UserEventJobPayload70GitHashtagVercel: {
 ...
 * Since February 2022 All the hashtag-vercel tags found in the commit message triggering the deploy. For example, #VERCEL_DO_SOMETHING
 */
export type UserEventJobPayload70GitHashtagVercel = ClosedEnum<typeof UserEventJobPayload70GitHashtagVercel>;
/**
 ...
 */
export declare const UserEventJobPayload70CommitVerification: {
 ...
 * Since 6 Nov 2025 The verification status of the commit. - 'verified' if the commit is verified - 'unverified' if the commit is not verified - 'unknown' if the commit verification status is unknown or not supported
 */
export type UserEventJobPayload70CommitVerification = ClosedEnum<typeof UserEventJobPayload70CommitVerification>;
export declare const UserEventJobPayload708Action: {
    readonly AutoApprovedMember: "auto-approved-member";
    readonly AutoApprovedPendingInvite: "auto-approved-pending-invite";
};
export type UserEventJobPayload708Action = ClosedEnum<typeof UserEventJobPayload708Action>;
/**
...
export declare const UserEventJobPayload708Provider: {
    readonly Vercel: "vercel";
};
export type UserEventJobPayload708Provider = ClosedEnum<typeof UserEventJobPayload708Provider>;
export type Job8 = {
    type: "vercel-push";
    ref: string;
    repo: string;
...
export declare const UserEventJobPayload707Provider: {
    readonly Gitlab: "gitlab";
};
export type UserEventJobPayload707Provider = ClosedEnum<typeof UserEventJobPayload707Provider>;
export type Job7 = {
    createdAt?: number | undefined;
...
export declare const UserEventJobPayload70Action: {
    readonly AutoApprovedMember: "auto-approved-member";
    readonly AutoApprovedPendingInvite: "auto-approved-pending-invite";
};
export type UserEventJobPayload70Action = ClosedEnum<typeof UserEventJobPayload70Action>;
/**
 * Since March 2026 Records a successful NSNB auto-add result so later GitHub PR comments can deterministically explain why this SHA was allowed to deploy.
 */
...
export declare const UserEventJobPayload706Provider: {
    readonly Gitlab: "gitlab";
};
export type UserEventJobPayload706Provider = ClosedEnum<typeof UserEventJobPayload706Provider>;
export type Job6 = {
    type: "gitlab-push";
    authorized?: boolean | undefined;
    authorizedBy?: string | undefined;
...
export declare const UserEventJobPayload70Provider: {
    readonly Github: "github";
    readonly GithubLimited: "github-limited";
    readonly GithubCustomHost: "github-custom-host";
};
export type UserEventJobPayload70Provider = ClosedEnum<typeof UserEventJobPayload70Provider>;
export type Job5 = {
    createdAt?: number | undefined;
    eventful?: boolean | undefined;
    /**
...
/** @internal */
export declare const UserEventPayload116NewOwnerAction$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload116NewOwnerAction>;
/** @internal */
export declare const UserEventPayload116NewOwnerAction$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload116NewOwnerAction>;
/** @internal */
...
export type NewOwner$Outbound = {
    ...
    email: string;
    id: string;
    importFlowGitNamespace?: PayloadImportFlowGitNamespace$Outbound | null | undefined;
    importFlowGitNamespaceId?: PayloadImportFlowGitNamespaceId$Outbound | null | undefined;
...
/** @internal */
export declare const UserEventPayload114Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload114Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload113Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload113Action>;
/** @internal */
export declare const UserEventPayload113Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload113Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload112Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload112Action>;
/** @internal */
export declare const UserEventPayload112Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload112Action>;
/** @internal */
...
/** @internal */
export declare const ConfigVersion$outboundSchema: z.ZodType<ConfigVersion$Outbound, z.ZodTypeDef, ConfigVersion>;
export declare function configVersionToJSON(configVersion: ConfigVersion): string;
...
/** @internal */
export declare const UserEventPayload107NewEnvVarType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload107NewEnvVarType>;
/** @internal */
export declare const UserEventPayload107NewEnvVarType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload107NewEnvVarType>;
/** @internal */
export declare const UserEventPayload107Target$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload107Target>;
/** @internal */
export declare const UserEventPayload107Target$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload107Target>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload99ToAccountType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload99ToAccountType>;
/** @internal */
export declare const UserEventPayload99ToAccountType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload99ToAccountType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload80OldTeam$inboundSchema: z.ZodType<UserEventPayload80OldTeam, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload80OldTeam$Outbound = {
    name: string;
};
/** @internal */
export declare const UserEventPayload80OldTeam$outboundSchema: z.ZodType<UserEventPayload80OldTeam$Outbound, z.ZodTypeDef, UserEventPayload80OldTeam>;
export declare function userEventPayload80OldTeamToJSON(userEventPayload80OldTeam: UserEventPayload80OldTeam): string;
export declare function userEventPayload80OldTeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload80OldTeam, SDKValidationError>;
/** @internal */
export declare const UserEventPayload80NewTeam$inboundSchema: z.ZodType<UserEventPayload80NewTeam, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload80NewTeam$Outbound = {
    name: string;
};
/** @internal */
export declare const UserEventPayload80NewTeam$outboundSchema: z.ZodType<UserEventPayload80NewTeam$Outbound, z.ZodTypeDef, UserEventPayload80NewTeam>;
export declare function userEventPayload80NewTeamToJSON(userEventPayload80NewTeam: UserEventPayload80NewTeam): string;
export declare function userEventPayload80NewTeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload80NewTeam, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload73Deployment$inboundSchema: z.ZodType<UserEventPayload73Deployment, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload73Deployment$outboundSchema: z.ZodType<UserEventPayload73Deployment$Outbound, z.ZodTypeDef, UserEventPayload73Deployment>;
export declare function userEventPayload73DeploymentToJSON(userEventPayload73Deployment: UserEventPayload73Deployment): string;
export declare function userEventPayload73DeploymentFromJSON(jsonString: string): SafeParseResult<UserEventPayload73Deployment, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload708DeployHook$inboundSchema: z.ZodType<UserEventJobPayload708DeployHook, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload708DeployHook$outboundSchema: z.ZodType<UserEventJobPayload708DeployHook$Outbound, z.ZodTypeDef, UserEventJobPayload708DeployHook>;
export declare function userEventJobPayload708DeployHookToJSON(userEventJobPayload708DeployHook: UserEventJobPayload708DeployHook): string;
export declare function userEventJobPayload708DeployHookFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload708DeployHook, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload70GitHashtagVercel$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70GitHashtagVercel>;
/** @internal */
export declare const UserEventJobPayload70GitHashtagVercel$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70GitHashtagVercel>;
/** @internal */
export declare const UserEventJobPayload708GitComments$inboundSchema: z.ZodType<UserEventJobPayload708GitComments, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload708GitComments$outboundSchema: z.ZodType<UserEventJobPayload708GitComments$Outbound, z.ZodTypeDef, UserEventJobPayload708GitComments>;
export declare function userEventJobPayload708GitCommentsToJSON(userEventJobPayload708GitComments: UserEventJobPayload708GitComments): string;
export declare function userEventJobPayload708GitCommentsFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload708GitComments, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload70CommitVerification$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70CommitVerification>;
/** @internal */
export declare const UserEventJobPayload70CommitVerification$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70CommitVerification>;
/** @internal */
export declare const UserEventJobPayload708Action$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload708Action>;
/** @internal */
export declare const UserEventJobPayload708Action$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload708Action>;
/** @internal */
export declare const UserEventJobPayload70NsnbSideEffect$inboundSchema: z.ZodType<UserEventJobPayload70NsnbSideEffect, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70NsnbSideEffect$outboundSchema: z.ZodType<UserEventJobPayload70NsnbSideEffect$Outbound, z.ZodTypeDef, UserEventJobPayload70NsnbSideEffect>;
export declare function userEventJobPayload70NsnbSideEffectToJSON(userEventJobPayload70NsnbSideEffect: UserEventJobPayload70NsnbSideEffect): string;
export declare function userEventJobPayload70NsnbSideEffectFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload70NsnbSideEffect, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload708HeadInfo$inboundSchema: z.ZodType<UserEventJobPayload708HeadInfo, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload708HeadInfo$outboundSchema: z.ZodType<UserEventJobPayload708HeadInfo$Outbound, z.ZodTypeDef, UserEventJobPayload708HeadInfo>;
export declare function userEventJobPayload708HeadInfoToJSON(userEventJobPayload708HeadInfo: UserEventJobPayload708HeadInfo): string;
export declare function userEventJobPayload708HeadInfoFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload708HeadInfo, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload708Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload708Provider>;
/** @internal */
export declare const UserEventJobPayload708Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload708Provider>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload707HeadInfo$inboundSchema: z.ZodType<UserEventJobPayload707HeadInfo, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload707HeadInfo$outboundSchema: z.ZodType<UserEventJobPayload707HeadInfo$Outbound, z.ZodTypeDef, UserEventJobPayload707HeadInfo>;
export declare function userEventJobPayload707HeadInfoToJSON(userEventJobPayload707HeadInfo: UserEventJobPayload707HeadInfo): string;
export declare function userEventJobPayload707HeadInfoFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload707HeadInfo, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload707GitComments$inboundSchema: z.ZodType<UserEventJobPayload707GitComments, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload707GitComments$outboundSchema: z.ZodType<UserEventJobPayload707GitComments$Outbound, z.ZodTypeDef, UserEventJobPayload707GitComments>;
export declare function userEventJobPayload707GitCommentsToJSON(userEventJobPayload707GitComments: UserEventJobPayload707GitComments): string;
export declare function userEventJobPayload707GitCommentsFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload707GitComments, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload707Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload707Provider>;
/** @internal */
export declare const UserEventJobPayload707Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload707Provider>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload706GitComments$inboundSchema: z.ZodType<UserEventJobPayload706GitComments, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload706GitComments$outboundSchema: z.ZodType<UserEventJobPayload706GitComments$Outbound, z.ZodTypeDef, UserEventJobPayload706GitComments>;
export declare function userEventJobPayload706GitCommentsToJSON(userEventJobPayload706GitComments: UserEventJobPayload706GitComments): string;
export declare function userEventJobPayload706GitCommentsFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload706GitComments, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70Action$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70Action>;
/** @internal */
export declare const UserEventJobPayload70Action$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70Action>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70DeployHook$inboundSchema: z.ZodType<UserEventJobPayload70DeployHook, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70DeployHook$outboundSchema: z.ZodType<UserEventJobPayload70DeployHook$Outbound, z.ZodTypeDef, UserEventJobPayload70DeployHook>;
export declare function userEventJobPayload70DeployHookToJSON(userEventJobPayload70DeployHook: UserEventJobPayload70DeployHook): string;
export declare function userEventJobPayload70DeployHookFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload70DeployHook, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload70Project$inboundSchema: z.ZodType<UserEventJobPayload70Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70Project$outboundSchema: z.ZodType<UserEventJobPayload70Project$Outbound, z.ZodTypeDef, UserEventJobPayload70Project>;
export declare function userEventJobPayload70ProjectToJSON(userEventJobPayload70Project: UserEventJobPayload70Project): string;
export declare function userEventJobPayload70ProjectFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload70Project, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload706HeadInfo$inboundSchema: z.ZodType<UserEventJobPayload706HeadInfo, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload706HeadInfo$outboundSchema: z.ZodType<UserEventJobPayload706HeadInfo$Outbound, z.ZodTypeDef, UserEventJobPayload706HeadInfo>;
export declare function userEventJobPayload706HeadInfoToJSON(userEventJobPayload706HeadInfo: UserEventJobPayload706HeadInfo): string;
export declare function userEventJobPayload706HeadInfoFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload706HeadInfo, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload706Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload706Provider>;
/** @internal */
export declare const UserEventJobPayload706Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload706Provider>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70HeadInfo$inboundSchema: z.ZodType<UserEventJobPayload70HeadInfo, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70HeadInfo$outboundSchema: z.ZodType<UserEventJobPayload70HeadInfo$Outbound, z.ZodTypeDef, UserEventJobPayload70HeadInfo>;
export declare function userEventJobPayload70HeadInfoToJSON(userEventJobPayload70HeadInfo: UserEventJobPayload70HeadInfo): string;
export declare function userEventJobPayload70HeadInfoFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload70HeadInfo, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload70GitComments$inboundSchema: z.ZodType<UserEventJobPayload70GitComments, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload70GitComments$outboundSchema: z.ZodType<UserEventJobPayload70GitComments$Outbound, z.ZodTypeDef, UserEventJobPayload70GitComments>;
export declare function userEventJobPayload70GitCommentsToJSON(userEventJobPayload70GitComments: UserEventJobPayload70GitComments): string;
export declare function userEventJobPayload70GitCommentsFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload70GitComments, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload70Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70Provider>;
/** @internal */
export declare const UserEventJobPayload70Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload70Provider>;
/** @internal */
...
//# sourceMappingURL=jobdeployhook.d.ts.map