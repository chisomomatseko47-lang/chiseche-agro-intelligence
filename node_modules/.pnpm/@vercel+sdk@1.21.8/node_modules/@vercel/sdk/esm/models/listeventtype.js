...
/** @internal */
export const Name$outboundSchema = Name$inboundSchema;
/** @internal */
export const ListEventTypeCategories$inboundSchema = z.nativeEnum(ListEventTypeCategories);
/** @internal */
export const ListEventTypeCategories$outboundSchema = ListEventTypeCategories$inboundSchema;
/** @internal */
export const ReplacedBy$inboundSchema = z
    .nativeEnum(ReplacedBy);
/** @internal */
export const ReplacedBy$outboundSchema = ReplacedBy$inboundSchema;
/** @internal */
export const ListEventType$inboundSchema = z.object({
...
/** @internal */
export const ListEventType$outboundSchema = z.object({
...
export function listEventTypeToJSON(listEventType) {
    return JSON.stringify(ListEventType$outboundSchema.parse(listEventType));
}
export function listEventTypeFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ListEventType$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ListEventType' from JSON`);
}
//# sourceMappingURL=listeventtype.js.map