...
/** @internal */
export const UserEventPayload332Names$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload332Names$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload332NamesToJSON(userEventPayload332Names) {
    return JSON.stringify(UserEventPayload332Names$outboundSchema.parse(userEventPayload332Names));
}
export function userEventPayload332NamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload332Names$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload332Names' from JSON`);
}
/** @internal */
export const UserEventPayload332City$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload332Names$inboundSchema),
});
/** @internal */
export const UserEventPayload332City$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload332Names$outboundSchema),
});
export function userEventPayload332CityToJSON(userEventPayload332City) {
    return JSON.stringify(UserEventPayload332City$outboundSchema.parse(userEventPayload332City));
}
export function userEventPayload332CityFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload332City$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload332City' from JSON`);
}
/** @internal */
export const UserEventPayload332GeolocationNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload332GeolocationNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload332GeolocationNamesToJSON(userEventPayload332GeolocationNames) {
    return JSON.stringify(UserEventPayload332GeolocationNames$outboundSchema.parse(userEventPayload332GeolocationNames));
}
export function userEventPayload332GeolocationNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload332GeolocationNames$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload332GeolocationNames' from JSON`);
}
/** @internal */
export const UserEventPayload332Country$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload332GeolocationNames$inboundSchema),
});
/** @internal */
export const UserEventPayload332Country$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload332GeolocationNames$outboundSchema),
});
export function userEventPayload332CountryToJSON(userEventPayload332Country) {
    return JSON.stringify(UserEventPayload332Country$outboundSchema.parse(userEventPayload332Country));
}
export function userEventPayload332CountryFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload332Country$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload332Country' from JSON`);
}
/** @internal */
export const UserEventPayload332GeolocationMostSpecificSubdivisionNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload332GeolocationMostSpecificSubdivisionNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload332GeolocationMostSpecificSubdivisionNamesToJSON(userEventPayload332GeolocationMostSpecificSubdivisionNames) {
    return JSON.stringify(UserEventPayload332GeolocationMostSpecificSubdivisionNames$outboundSchema
        .parse(userEventPayload332GeolocationMostSpecificSubdivisionNames));
}
export function userEventPayload332GeolocationMostSpecificSubdivisionNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload332GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)), `Failed to parse 'UserEventPayload332GeolocationMostSpecificSubdivisionNames' from JSON`);
}
/** @internal */
export const UserEventPayload332MostSpecificSubdivision$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload332GeolocationMostSpecificSubdivisionNames$inboundSchema),
});
/** @internal */
export const UserEventPayload332MostSpecificSubdivision$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload332GeolocationMostSpecificSubdivisionNames$outboundSchema),
});
export function userEventPayload332MostSpecificSubdivisionToJSON(userEventPayload332MostSpecificSubdivision) {
    return JSON.stringify(UserEventPayload332MostSpecificSubdivision$outboundSchema.parse(userEventPayload332MostSpecificSubdivision));
}
export function userEventPayload332MostSpecificSubdivisionFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload332MostSpecificSubdivision$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload332MostSpecificSubdivision' from JSON`);
}
/** @internal */
export const UserEventPayload332Geolocation$inboundSchema = z.object({
    city: types.optional(z.lazy(() => UserEventPayload332City$inboundSchema)),
    country: z.lazy(() => UserEventPayload332Country$inboundSchema),
    most_specific_subdivision: types.optional(z.lazy(() => UserEventPayload332MostSpecificSubdivision$inboundSchema)),
...
/** @internal */
export const UserEventPayload332Geolocation$outboundSchema = z.object({
    city: z.lazy(() => UserEventPayload332City$outboundSchema).optional(),
    country: z.lazy(() => UserEventPayload332Country$outboundSchema),
    mostSpecificSubdivision: z.lazy(() => UserEventPayload332MostSpecificSubdivision$outboundSchema).optional(),
...
export function userEventPayload332GeolocationToJSON(userEventPayload332Geolocation) {
    return JSON.stringify(UserEventPayload332Geolocation$outboundSchema.parse(userEventPayload332Geolocation));
}
export function userEventPayload332GeolocationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload332Geolocation$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload332Geolocation' from JSON`);
}
/** @internal */
export const ThreeHundredAndThirtyTwo$inboundSchema = z.object({
    ...
    geolocation: z.nullable(z.lazy(() => UserEventPayload332Geolocation$inboundSchema)).optional(),
    userAgent: types.optional(types.string()),
    reqId: types.optional(types.string()),
    reqUrl: types.optional(types.string()),
});
/** @internal */
export const ThreeHundredAndThirtyTwo$outboundSchema = z.object({
    deletedCount: z.number(),
    actorTokenId: z.string(),
    ip: z.nullable(z.string()).optional(),
    geolocation: z.nullable(z.lazy(() => UserEventPayload332Geolocation$outboundSchema)).optional(),
    userAgent: z.string().optional(),
    reqId: z.string().optional(),
    reqUrl: z.string().optional(),
});
export function threeHundredAndThirtyTwoToJSON(threeHundredAndThirtyTwo) {
    return JSON.stringify(ThreeHundredAndThirtyTwo$outboundSchema.parse(threeHundredAndThirtyTwo));
}
...
/** @internal */
export const UserEventPayload331Names$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload331Names$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload331NamesToJSON(userEventPayload331Names) {
    return JSON.stringify(UserEventPayload331Names$outboundSchema.parse(userEventPayload331Names));
}
export function userEventPayload331NamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload331Names$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload331Names' from JSON`);
}
/** @internal */
export const UserEventPayload331City$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload331Names$inboundSchema),
});
/** @internal */
export const UserEventPayload331City$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload331Names$outboundSchema),
});
export function userEventPayload331CityToJSON(userEventPayload331City) {
    return JSON.stringify(UserEventPayload331City$outboundSchema.parse(userEventPayload331City));
}
export function userEventPayload331CityFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload331City$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload331City' from JSON`);
}
/** @internal */
export const UserEventPayload331GeolocationNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload331GeolocationNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload331GeolocationNamesToJSON(userEventPayload331GeolocationNames) {
    return JSON.stringify(UserEventPayload331GeolocationNames$outboundSchema.parse(userEventPayload331GeolocationNames));
}
export function userEventPayload331GeolocationNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload331GeolocationNames$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload331GeolocationNames' from JSON`);
}
/** @internal */
export const UserEventPayload331Country$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload331GeolocationNames$inboundSchema),
});
/** @internal */
export const UserEventPayload331Country$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload331GeolocationNames$outboundSchema),
});
export function userEventPayload331CountryToJSON(userEventPayload331Country) {
    return JSON.stringify(UserEventPayload331Country$outboundSchema.parse(userEventPayload331Country));
}
export function userEventPayload331CountryFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload331Country$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload331Country' from JSON`);
}
/** @internal */
export const UserEventPayload331GeolocationMostSpecificSubdivisionNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload331GeolocationMostSpecificSubdivisionNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload331GeolocationMostSpecificSubdivisionNamesToJSON(userEventPayload331GeolocationMostSpecificSubdivisionNames) {
    return JSON.stringify(UserEventPayload331GeolocationMostSpecificSubdivisionNames$outboundSchema
        .parse(userEventPayload331GeolocationMostSpecificSubdivisionNames));
}
export function userEventPayload331GeolocationMostSpecificSubdivisionNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload331GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)), `Failed to parse 'UserEventPayload331GeolocationMostSpecificSubdivisionNames' from JSON`);
}
/** @internal */
export const UserEventPayload331MostSpecificSubdivision$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload331GeolocationMostSpecificSubdivisionNames$inboundSchema),
});
/** @internal */
export const UserEventPayload331MostSpecificSubdivision$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload331GeolocationMostSpecificSubdivisionNames$outboundSchema),
});
export function userEventPayload331MostSpecificSubdivisionToJSON(userEventPayload331MostSpecificSubdivision) {
    return JSON.stringify(UserEventPayload331MostSpecificSubdivision$outboundSchema.parse(userEventPayload331MostSpecificSubdivision));
}
export function userEventPayload331MostSpecificSubdivisionFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload331MostSpecificSubdivision$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload331MostSpecificSubdivision' from JSON`);
}
/** @internal */
export const UserEventPayload331Geolocation$inboundSchema = z.object({
    city: types.optional(z.lazy(() => UserEventPayload331City$inboundSchema)),
    country: z.lazy(() => UserEventPayload331Country$inboundSchema),
    most_specific_subdivision: types.optional(z.lazy(() => UserEventPayload331MostSpecificSubdivision$inboundSchema)),
    regionName: types.optional(types.string()),
}).transform((v) => {
    return remap$(v, {
        "most_specific_subdivision": "mostSpecificSubdivision",
...
/** @internal */
export const UserEventPayload331Geolocation$outboundSchema = z.object({
    city: z.lazy(() => UserEventPayload331City$outboundSchema).optional(),
    country: z.lazy(() => UserEventPayload331Country$outboundSchema),
    mostSpecificSubdivision: z.lazy(() => UserEventPayload331MostSpecificSubdivision$outboundSchema).optional(),
    regionName: z.string().optional(),
}).transform((v) => {
    return remap$(v, {
        mostSpecificSubdivision: "most_specific_subdivision",
...
export function userEventPayload331GeolocationToJSON(userEventPayload331Geolocation) {
    return JSON.stringify(UserEventPayload331Geolocation$outboundSchema.parse(userEventPayload331Geolocation));
}
export function userEventPayload331GeolocationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload331Geolocation$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload331Geolocation' from JSON`);
}
/** @internal */
export const ThreeHundredAndThirtyOne$inboundSchema = z.object({
    ...
    ip: z.nullable(types.string()).optional(),
    geolocation: z.nullable(z.lazy(() => UserEventPayload331Geolocation$inboundSchema)).optional(),
    userAgent: types.optional(types.string()),
    reqId: types.optional(types.string()),
    reqUrl: types.optional(types.string()),
});
/** @internal */
export const ThreeHundredAndThirtyOne$outboundSchema = z.object({
    tokenId: z.string(),
    tokenType: z.string(),
    tokenName: z.string(),
    actorTokenId: z.string(),
    ...
    ip: z.nullable(z.string()).optional(),
    geolocation: z.nullable(z.lazy(() => UserEventPayload331Geolocation$outboundSchema)).optional(),
    userAgent: z.string().optional(),
    reqId: z.string().optional(),
    reqUrl: z.string().optional(),
});
export function threeHundredAndThirtyOneToJSON(threeHundredAndThirtyOne) {
    return JSON.stringify(ThreeHundredAndThirtyOne$outboundSchema.parse(threeHundredAndThirtyOne));
}
...
/** @internal */
export const UserEventPayload330Names$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload330Names$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload330NamesToJSON(userEventPayload330Names) {
    return JSON.stringify(UserEventPayload330Names$outboundSchema.parse(userEventPayload330Names));
}
export function userEventPayload330NamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload330Names$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload330Names' from JSON`);
}
/** @internal */
export const UserEventPayload330City$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload330Names$inboundSchema),
});
/** @internal */
export const UserEventPayload330City$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload330Names$outboundSchema),
});
export function userEventPayload330CityToJSON(userEventPayload330City) {
    return JSON.stringify(UserEventPayload330City$outboundSchema.parse(userEventPayload330City));
}
export function userEventPayload330CityFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload330City$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload330City' from JSON`);
}
/** @internal */
export const UserEventPayload330GeolocationNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload330GeolocationNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload330GeolocationNamesToJSON(userEventPayload330GeolocationNames) {
    return JSON.stringify(UserEventPayload330GeolocationNames$outboundSchema.parse(userEventPayload330GeolocationNames));
}
export function userEventPayload330GeolocationNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload330GeolocationNames$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload330GeolocationNames' from JSON`);
}
/** @internal */
export const UserEventPayload330Country$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload330GeolocationNames$inboundSchema),
});
/** @internal */
export const UserEventPayload330Country$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload330GeolocationNames$outboundSchema),
});
export function userEventPayload330CountryToJSON(userEventPayload330Country) {
    return JSON.stringify(UserEventPayload330Country$outboundSchema.parse(userEventPayload330Country));
}
export function userEventPayload330CountryFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload330Country$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload330Country' from JSON`);
}
/** @internal */
export const UserEventPayload330GeolocationMostSpecificSubdivisionNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload330GeolocationMostSpecificSubdivisionNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload330GeolocationMostSpecificSubdivisionNamesToJSON(userEventPayload330GeolocationMostSpecificSubdivisionNames) {
    return JSON.stringify(UserEventPayload330GeolocationMostSpecificSubdivisionNames$outboundSchema
        .parse(userEventPayload330GeolocationMostSpecificSubdivisionNames));
}
export function userEventPayload330GeolocationMostSpecificSubdivisionNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload330GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)), `Failed to parse 'UserEventPayload330GeolocationMostSpecificSubdivisionNames' from JSON`);
}
/** @internal */
export const UserEventPayload330MostSpecificSubdivision$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload330GeolocationMostSpecificSubdivisionNames$inboundSchema),
});
/** @internal */
export const UserEventPayload330MostSpecificSubdivision$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload330GeolocationMostSpecificSubdivisionNames$outboundSchema),
});
export function userEventPayload330MostSpecificSubdivisionToJSON(userEventPayload330MostSpecificSubdivision) {
    return JSON.stringify(UserEventPayload330MostSpecificSubdivision$outboundSchema.parse(userEventPayload330MostSpecificSubdivision));
}
export function userEventPayload330MostSpecificSubdivisionFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload330MostSpecificSubdivision$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload330MostSpecificSubdivision' from JSON`);
}
/** @internal */
export const UserEventPayload330Geolocation$inboundSchema = z.object({
    city: types.optional(z.lazy(() => UserEventPayload330City$inboundSchema)),
    country: z.lazy(() => UserEventPayload330Country$inboundSchema),
    most_specific_subdivision: types.optional(z.lazy(() => UserEventPayload330MostSpecificSubdivision$inboundSchema)),
    regionName: types.optional(types.string()),
}).transform((v) => {
    return remap$(v, {
        "most_specific_subdivision": "mostSpecificSubdivision",
...
/** @internal */
export const UserEventPayload330Geolocation$outboundSchema = z.object({
    city: z.lazy(() => UserEventPayload330City$outboundSchema).optional(),
    country: z.lazy(() => UserEventPayload330Country$outboundSchema),
    mostSpecificSubdivision: z.lazy(() => UserEventPayload330MostSpecificSubdivision$outboundSchema).optional(),
    regionName: z.string().optional(),
}).transform((v) => {
    return remap$(v, {
        mostSpecificSubdivision: "most_specific_subdivision",
...
export function userEventPayload330GeolocationToJSON(userEventPayload330Geolocation) {
    return JSON.stringify(UserEventPayload330Geolocation$outboundSchema.parse(userEventPayload330Geolocation));
}
export function userEventPayload330GeolocationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload330Geolocation$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload330Geolocation' from JSON`);
}
/** @internal */
export const ThreeHundredAndThirty$inboundSchema = z.object({
    ...
    ip: z.nullable(types.string()).optional(),
    geolocation: z.nullable(z.lazy(() => UserEventPayload330Geolocation$inboundSchema)).optional(),
    userAgent: types.optional(types.string()),
    reqId: types.optional(types.string()),
    reqUrl: types.optional(types.string()),
});
/** @internal */
export const ThreeHundredAndThirty$outboundSchema = z.object({
    tokenId: z.string(),
    ...
    ip: z.nullable(z.string()).optional(),
    geolocation: z.nullable(z.lazy(() => UserEventPayload330Geolocation$outboundSchema)).optional(),
    userAgent: z.string().optional(),
    reqId: z.string().optional(),
    reqUrl: z.string().optional(),
});
export function threeHundredAndThirtyToJSON(threeHundredAndThirty) {
    return JSON.stringify(ThreeHundredAndThirty$outboundSchema.parse(threeHundredAndThirty));
}
...
/** @internal */
export const UserEventPayload329Names$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload329Names$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload329NamesToJSON(userEventPayload329Names) {
    return JSON.stringify(UserEventPayload329Names$outboundSchema.parse(userEventPayload329Names));
}
export function userEventPayload329NamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload329Names$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload329Names' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload329GeolocationNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload329GeolocationNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload329GeolocationNamesToJSON(userEventPayload329GeolocationNames) {
    return JSON.stringify(UserEventPayload329GeolocationNames$outboundSchema.parse(userEventPayload329GeolocationNames));
}
export function userEventPayload329GeolocationNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload329GeolocationNames$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload329GeolocationNames' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload329GeolocationMostSpecificSubdivisionNames$inboundSchema = z.object({
    en: types.string(),
});
/** @internal */
export const UserEventPayload329GeolocationMostSpecificSubdivisionNames$outboundSchema = z.object({
    en: z.string(),
});
export function userEventPayload329GeolocationMostSpecificSubdivisionNamesToJSON(userEventPayload329GeolocationMostSpecificSubdivisionNames) {
    return JSON.stringify(UserEventPayload329GeolocationMostSpecificSubdivisionNames$outboundSchema
        .parse(userEventPayload329GeolocationMostSpecificSubdivisionNames));
}
export function userEventPayload329GeolocationMostSpecificSubdivisionNamesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload329GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)), `Failed to parse 'UserEventPayload329GeolocationMostSpecificSubdivisionNames' from JSON`);
}
/** @internal */
export const UserEventPayloadMostSpecificSubdivision$inboundSchema = z.object({
    names: z.lazy(() => UserEventPayload329GeolocationMostSpecificSubdivisionNames$inboundSchema),
});
/** @internal */
export const UserEventPayloadMostSpecificSubdivision$outboundSchema = z.object({
    names: z.lazy(() => UserEventPayload329GeolocationMostSpecificSubdivisionNames$outboundSchema),
});
...
/** @internal */
export const ThreeHundredAndTwentyNine$outboundSchema = z.object({
...
export function threeHundredAndTwentyNineToJSON(threeHundredAndTwentyNine) {
    return JSON.stringify(ThreeHundredAndTwentyNine$outboundSchema.parse(threeHundredAndTwentyNine));
}
...
/** @internal */
export const ThreeHundredAndTwentyEight$outboundSchema = z.object({
    deploymentId: z.string(),
    projectId: z.string(),
    runId: z.string(),
});
export function threeHundredAndTwentyEightToJSON(threeHundredAndTwentyEight) {
    return JSON.stringify(ThreeHundredAndTwentyEight$outboundSchema.parse(threeHundredAndTwentyEight));
}
...
/** @internal */
export const ThreeHundredAndTwentySeven$outboundSchema = z.object({
    chatId: z.string(),
    chatTitle: z.string().optional(),
    messageId: z.string(),
});
export function threeHundredAndTwentySevenToJSON(threeHundredAndTwentySeven) {
    return JSON.stringify(ThreeHundredAndTwentySeven$outboundSchema.parse(threeHundredAndTwentySeven));
}
...
/** @internal */
export const UserEventPayload322Team$inboundSchema = z.object({
    id: types.string(),
    name: types.string(),
});
/** @internal */
export const UserEventPayload322Team$outboundSchema = z.object({
    id: z.string(),
    name: z.string(),
});
export function userEventPayload322TeamToJSON(userEventPayload322Team) {
    return JSON.stringify(UserEventPayload322Team$outboundSchema.parse(userEventPayload322Team));
}
export function userEventPayload322TeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload322Team$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload322Team' from JSON`);
}
/** @internal */
export const UserEventPayload322Configuration$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload322Configuration$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload322ConfigurationToJSON(userEventPayload322Configuration) {
    return JSON.stringify(UserEventPayload322Configuration$outboundSchema.parse(userEventPayload322Configuration));
}
export function userEventPayload322ConfigurationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload322Configuration$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload322Configuration' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload321Team$inboundSchema = z.object({
    id: types.string(),
    name: types.string(),
});
/** @internal */
export const UserEventPayload321Team$outboundSchema = z.object({
    id: z.string(),
    name: z.string(),
});
export function userEventPayload321TeamToJSON(userEventPayload321Team) {
    return JSON.stringify(UserEventPayload321Team$outboundSchema.parse(userEventPayload321Team));
}
export function userEventPayload321TeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload321Team$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload321Team' from JSON`);
}
/** @internal */
export const UserEventPayload321Configuration$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload321Configuration$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload321ConfigurationToJSON(userEventPayload321Configuration) {
    return JSON.stringify(UserEventPayload321Configuration$outboundSchema.parse(userEventPayload321Configuration));
}
export function userEventPayload321ConfigurationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload321Configuration$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload321Configuration' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload320Team$inboundSchema = z.object({
    id: types.string(),
    name: types.string(),
});
/** @internal */
export const UserEventPayload320Team$outboundSchema = z.object({
    id: z.string(),
    name: z.string(),
});
export function userEventPayload320TeamToJSON(userEventPayload320Team) {
    return JSON.stringify(UserEventPayload320Team$outboundSchema.parse(userEventPayload320Team));
}
export function userEventPayload320TeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload320Team$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload320Team' from JSON`);
}
/** @internal */
export const UserEventPayload320Configuration$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload320Configuration$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload320ConfigurationToJSON(userEventPayload320Configuration) {
    return JSON.stringify(UserEventPayload320Configuration$outboundSchema.parse(userEventPayload320Configuration));
}
export function userEventPayload320ConfigurationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload320Configuration$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload320Configuration' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload312Previous$outboundSchema = z.object({
    enabled: z.boolean(),
    totpVerified: z.boolean(),
});
export function userEventPayload312PreviousToJSON(userEventPayload312Previous) {
    return JSON.stringify(UserEventPayload312Previous$outboundSchema.parse(userEventPayload312Previous));
}
...
/** @internal */
export const UserEventPayload312Next$outboundSchema = z.object({
    enabled: z.boolean(),
    totpVerified: z.boolean(),
});
export function userEventPayload312NextToJSON(userEventPayload312Next) {
    return JSON.stringify(UserEventPayload312Next$outboundSchema.parse(userEventPayload312Next));
}
...
/** @internal */
export const UserEventPayload303Previous$inboundSchema = smartUnion([
    z.lazy(() => Previous1$inboundSchema),
    Previous2$inboundSchema,
]);
/** @internal */
export const UserEventPayload303Previous$outboundSchema = smartUnion([
    z.lazy(() => Previous1$outboundSchema),
    Previous2$outboundSchema,
]);
export function userEventPayload303PreviousToJSON(userEventPayload303Previous) {
    return JSON.stringify(UserEventPayload303Previous$outboundSchema.parse(userEventPayload303Previous));
}
...
/** @internal */
export const UserEventPayload303Next$inboundSchema = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);
/** @internal */
export const UserEventPayload303Next$outboundSchema = smartUnion([z.lazy(() => Next1$outboundSchema), Next2$outboundSchema]);
export function userEventPayload303NextToJSON(userEventPayload303Next) {
    return JSON.stringify(UserEventPayload303Next$outboundSchema.parse(userEventPayload303Next));
}
...
/** @internal */
export const PayloadUpdatedUser$outboundSchema = z.object({
    username: z.string(),
    email: z.string(),
});
export function payloadUpdatedUserToJSON(payloadUpdatedUser) {
    return JSON.stringify(PayloadUpdatedUser$outboundSchema.parse(payloadUpdatedUser));
}
...
/** @internal */
export const UserEventPayload287User$inboundSchema = z.object({
    id: types.string(),
    username: types.string(),
});
/** @internal */
export const UserEventPayload287User$outboundSchema = z.object({
    id: z.string(),
    username: z.string(),
});
export function userEventPayload287UserToJSON(userEventPayload287User) {
    return JSON.stringify(UserEventPayload287User$outboundSchema.parse(userEventPayload287User));
}
export function userEventPayload287UserFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload287User$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload287User' from JSON`);
}
/** @internal */
...
//# sourceMappingURL=payloadenvironment.js.map