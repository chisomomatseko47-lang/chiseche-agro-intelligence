...
/** @internal */
export const PutFirewallConfigLogHeaders$inboundSchema = smartUnion([types.string(), z.array(types.string())]);
/** @internal */
...
export function putFirewallConfigLogHeadersFromJSON(jsonString) {
    return safeParse(jsonString, (x) => PutFirewallConfigLogHeaders$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'PutFirewallConfigLogHeaders' from JSON`);
}
/** @internal */
...
/** @internal */
export const PutFirewallConfigLogHeadersSecurityResponse2$outboundSchema = PutFirewallConfigLogHeadersSecurityResponse2$inboundSchema;
/** @internal */
...
/** @internal */
export const PutFirewallConfigSecurityLogHeaders$outboundSchema = smartUnion([
    z.array(z.string()),
    PutFirewallConfigLogHeaders2$outboundSchema,
]);
export function putFirewallConfigSecurityLogHeadersToJSON(putFirewallConfigSecurityLogHeaders) {
    return JSON.stringify(PutFirewallConfigSecurityLogHeaders$outboundSchema.parse(putFirewallConfigSecurityLogHeaders));
}
