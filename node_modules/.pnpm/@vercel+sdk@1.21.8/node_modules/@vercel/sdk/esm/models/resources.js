...
/** @internal */
export const UserEventPayload80Deployment$inboundSchema = z.object({
    id: types.string(),
    name: types.string(),
...
/** @internal */
export const UserEventPayload80Deployment$outboundSchema = z.object({
    id: z.string(),
    name: z.string(),
    meta: z.record(z.string()),
    url: z.string(),
});
export function userEventPayload80DeploymentToJSON(userEventPayload80Deployment) {
    return JSON.stringify(UserEventPayload80Deployment$outboundSchema.parse(userEventPayload80Deployment));
}
export function userEventPayload80DeploymentFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload80Deployment$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload80Deployment' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventJobPayload778DeployHook$inboundSchema = z.object({
...
/** @internal */
export const UserEventJobPayload778DeployHook$outboundSchema = z.object({
    createdAt: z.number(),
    id: z.string(),
    name: z.string(),
    ref: z.string(),
});
export function userEventJobPayload778DeployHookToJSON(userEventJobPayload778DeployHook) {
    return JSON.stringify(UserEventJobPayload778DeployHook$outboundSchema.parse(userEventJobPayload778DeployHook));
}
export function userEventJobPayload778DeployHookFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload778DeployHook$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload778DeployHook' from JSON`);
}
/** @internal */
export const UserEventJobPayload77GitHashtagVercel$inboundSchema = z.nativeEnum(UserEventJobPayload77GitHashtagVercel);
/** @internal */
export const UserEventJobPayload77GitHashtagVercel$outboundSchema = UserEventJobPayload77GitHashtagVercel$inboundSchema;
/** @internal */
export const UserEventJobPayload778GitComments$inboundSchema = z.object({
    onPullRequest: types.boolean(),
    onCommit: types.boolean(),
});
/** @internal */
export const UserEventJobPayload778GitComments$outboundSchema = z.object({
    onPullRequest: z.boolean(),
    onCommit: z.boolean(),
});
export function userEventJobPayload778GitCommentsToJSON(userEventJobPayload778GitComments) {
    return JSON.stringify(UserEventJobPayload778GitComments$outboundSchema.parse(userEventJobPayload778GitComments));
}
export function userEventJobPayload778GitCommentsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload778GitComments$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload778GitComments' from JSON`);
}
/** @internal */
export const UserEventJobPayload77CommitVerification$inboundSchema = z
    .nativeEnum(UserEventJobPayload77CommitVerification);
/** @internal */
export const UserEventJobPayload77CommitVerification$outboundSchema = UserEventJobPayload77CommitVerification$inboundSchema;
/** @internal */
export const UserEventJobPayload778Action$inboundSchema = z.nativeEnum(UserEventJobPayload778Action);
/** @internal */
export const UserEventJobPayload778Action$outboundSchema = UserEventJobPayload778Action$inboundSchema;
/** @internal */
export const UserEventJobPayload77NsnbSideEffect$inboundSchema = z.object({
    action: UserEventJobPayload778Action$inboundSchema,
    gitUserLogin: types.string(),
});
/** @internal */
export const UserEventJobPayload77NsnbSideEffect$outboundSchema = z.object({
    action: UserEventJobPayload778Action$outboundSchema,
    gitUserLogin: z.string(),
});
export function userEventJobPayload77NsnbSideEffectToJSON(userEventJobPayload77NsnbSideEffect) {
    return JSON.stringify(UserEventJobPayload77NsnbSideEffect$outboundSchema.parse(userEventJobPayload77NsnbSideEffect));
}
export function userEventJobPayload77NsnbSideEffectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload77NsnbSideEffect$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload77NsnbSideEffect' from JSON`);
}
/** @internal */
export const UserEventJobPayload778HeadInfo$inboundSchema = z.object({
    org: types.string(),
    ref: types.string(),
    repo: types.string(),
    sha: types.string(),
...
/** @internal */
export const UserEventJobPayload778HeadInfo$outboundSchema = z.object({
    org: z.string(),
    ref: z.string(),
    repo: z.string(),
    sha: z.string(),
});
export function userEventJobPayload778HeadInfoToJSON(userEventJobPayload778HeadInfo) {
    return JSON.stringify(UserEventJobPayload778HeadInfo$outboundSchema.parse(userEventJobPayload778HeadInfo));
}
export function userEventJobPayload778HeadInfoFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload778HeadInfo$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload778HeadInfo' from JSON`);
}
/** @internal */
export const UserEventJobPayload778Provider$inboundSchema = z.nativeEnum(UserEventJobPayload778Provider);
/** @internal */
export const UserEventJobPayload778Provider$outboundSchema = UserEventJobPayload778Provider$inboundSchema;
/** @internal */
export const Job8$inboundSchema = z
    .object({
    ...
    deployHook: types.optional(z.lazy(() => UserEventJobPayload778DeployHook$inboundSchema)),
    ...
    gitHashtagVercel: types.optional(z.array(UserEventJobPayload77GitHashtagVercel$inboundSchema)),
    connectedProjectCount: types.optional(types.number()),
    prIdOrZero: types.optional(types.number()),
    gitComments: types.optional(z.lazy(() => UserEventJobPayload778GitComments$inboundSchema)),
    isManualGitDeploy: types.optional(types.boolean()),
    commitVerification: types.optional(UserEventJobPayload77CommitVerification$inboundSchema),
    nsnbSideEffect: types.optional(z.lazy(() => UserEventJobPayload77NsnbSideEffect$inboundSchema)),
...
/** @internal */
export const Job8$outboundSchema = z.object({
    ...
    gitHashtagVercel: z.array(UserEventJobPayload77GitHashtagVercel$outboundSchema).optional(),
    ...
    commitVerification: UserEventJobPayload77CommitVerification$outboundSchema
        .optional(),
    nsnbSideEffect: z.lazy(() => UserEventJobPayload77NsnbSideEffect$outboundSchema).optional(),
...
export function job8ToJSON(job8) {
    return JSON.stringify(Job8$outboundSchema.parse(job8));
}
export function job8FromJSON(jsonString) {
    return safeParse(jsonString, (x) => Job8$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Job8' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventJobPayload777HeadInfo$inboundSchema = z.object({
    project: z.lazy(() => UserEventJobPayloadProject$inboundSchema),
    ref: types.string(),
    sha: types.string(),
});
/** @internal */
export const UserEventJobPayload777HeadInfo$outboundSchema = z.object({
    project: z.lazy(() => UserEventJobPayloadProject$outboundSchema),
    ref: z.string(),
    sha: z.string(),
});
export function userEventJobPayload777HeadInfoToJSON(userEventJobPayload777HeadInfo) {
    return JSON.stringify(UserEventJobPayload777HeadInfo$outboundSchema.parse(userEventJobPayload777HeadInfo));
}
export function userEventJobPayload777HeadInfoFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload777HeadInfo$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload777HeadInfo' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventJobPayload777GitComments$inboundSchema = z.object({
    onPullRequest: types.boolean(),
    onCommit: types.boolean(),
});
/** @internal */
export const UserEventJobPayload777GitComments$outboundSchema = z.object({
    onPullRequest: z.boolean(),
    onCommit: z.boolean(),
});
export function userEventJobPayload777GitCommentsToJSON(userEventJobPayload777GitComments) {
    return JSON.stringify(UserEventJobPayload777GitComments$outboundSchema.parse(userEventJobPayload777GitComments));
}
export function userEventJobPayload777GitCommentsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload777GitComments$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload777GitComments' from JSON`);
}
/** @internal */
export const UserEventJobPayload777Provider$inboundSchema = z.nativeEnum(UserEventJobPayload777Provider);
/** @internal */
export const UserEventJobPayload777Provider$outboundSchema = UserEventJobPayload777Provider$inboundSchema;
/** @internal */
export const Job7$inboundSchema = z
    ...
    gitComments: types.optional(z.lazy(() => UserEventJobPayload777GitComments$inboundSchema)),
...
/** @internal */
export const UserEventJobPayload776GitComments$inboundSchema = z.object({
    onPullRequest: types.boolean(),
    onCommit: types.boolean(),
});
/** @internal */
export const UserEventJobPayload776GitComments$outboundSchema = z.object({
    onPullRequest: z.boolean(),
    onCommit: z.boolean(),
});
export function userEventJobPayload776GitCommentsToJSON(userEventJobPayload776GitComments) {
    return JSON.stringify(UserEventJobPayload776GitComments$outboundSchema.parse(userEventJobPayload776GitComments));
}
export function userEventJobPayload776GitCommentsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload776GitComments$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload776GitComments' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventJobPayload77Action$inboundSchema = z.nativeEnum(UserEventJobPayload77Action);
/** @internal */
export const UserEventJobPayload77Action$outboundSchema = UserEventJobPayload77Action$inboundSchema;
/** @internal */
export const UserEventJobPayloadNsnbSideEffect$inboundSchema = z.object({
    action: UserEventJobPayload77Action$inboundSchema,
    gitUserLogin: types.string(),
});
/** @internal */
export const UserEventJobPayloadNsnbSideEffect$outboundSchema = z.object({
    action: UserEventJobPayload77Action$outboundSchema,
    gitUserLogin: z.string(),
});
export function userEventJobPayloadNsnbSideEffectToJSON(userEventJobPayloadNsnbSideEffect) {
    return JSON.stringify(UserEventJobPayloadNsnbSideEffect$outboundSchema.parse(userEventJobPayloadNsnbSideEffect));
}
export function userEventJobPayloadNsnbSideEffectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayloadNsnbSideEffect$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayloadNsnbSideEffect' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventJobPayload77DeployHook$inboundSchema = z.object({
    createdAt: types.number(),
    id: types.string(),
    name: types.string(),
    ref: types.string(),
...
/** @internal */
export const UserEventJobPayload77DeployHook$outboundSchema = z.object({
    createdAt: z.number(),
    id: z.string(),
    name: z.string(),
    ref: z.string(),
});
export function userEventJobPayload77DeployHookToJSON(userEventJobPayload77DeployHook) {
    return JSON.stringify(UserEventJobPayload77DeployHook$outboundSchema.parse(userEventJobPayload77DeployHook));
}
export function userEventJobPayload77DeployHookFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload77DeployHook$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload77DeployHook' from JSON`);
}
/** @internal */
export const UserEventJobPayload77Project$inboundSchema = z.object({
    defaultBranch: z.nullable(types.string()).optional(),
    id: types.string(),
    name: z.nullable(types.string()).optional(),
    namespace: z.nullable(types.string()).optional(),
...
/** @internal */
export const UserEventJobPayload77Project$outboundSchema = z.object({
    defaultBranch: z.nullable(z.string()).optional(),
    id: z.string(),
    name: z.nullable(z.string()).optional(),
    namespace: z.nullable(z.string()).optional(),
...
export function userEventJobPayload77ProjectToJSON(userEventJobPayload77Project) {
    return JSON.stringify(UserEventJobPayload77Project$outboundSchema.parse(userEventJobPayload77Project));
}
export function userEventJobPayload77ProjectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload77Project$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload77Project' from JSON`);
}
/** @internal */
export const UserEventJobPayload776HeadInfo$inboundSchema = z.object({
    project: z.lazy(() => UserEventJobPayload77Project$inboundSchema),
    ref: types.string(),
    sha: types.string(),
});
/** @internal */
export const UserEventJobPayload776HeadInfo$outboundSchema = z.object({
    project: z.lazy(() => UserEventJobPayload77Project$outboundSchema),
    ref: z.string(),
    sha: z.string(),
});
export function userEventJobPayload776HeadInfoToJSON(userEventJobPayload776HeadInfo) {
    return JSON.stringify(UserEventJobPayload776HeadInfo$outboundSchema.parse(userEventJobPayload776HeadInfo));
}
export function userEventJobPayload776HeadInfoFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload776HeadInfo$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload776HeadInfo' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventJobPayload776Provider$inboundSchema = z.nativeEnum(UserEventJobPayload776Provider);
/** @internal */
export const UserEventJobPayload776Provider$outboundSchema = UserEventJobPayload776Provider$inboundSchema;
/** @internal */
export const Job6$inboundSchema = z
    ...
    connectedProjectCount: types.optional(types.number()),
    prIdOrZero: types.optional(types.number()),
    gitComments: types.optional(z.lazy(() => UserEventJobPayload776GitComments$inboundSchema)),
    isManualGitDeploy: types.optional(types.boolean()),
    commitVerification: types.optional(UserEventJobPayloadCommitVerification$inboundSchema),
    nsnbSideEffect: types.optional(z.lazy(() => UserEventJobPayloadNsnbSideEffect$inboundSchema)),
    commit: types.optional(z.lazy(() => Commit$inboundSchema)),
    createdAt: types.optional(types.number()),
    deployHook: types.optional(z.lazy(() => UserEventJobPayload77DeployHook$inboundSchema)),
    deploymentId: types.optional(types.string()),
    eventful: types.optional(types.boolean()),
...
export const Job6$outboundSchema = z.object({
    ...
    commitVerification: UserEventJobPayloadCommitVerification$outboundSchema
        .optional(),
    nsnbSideEffect: z.lazy(() => UserEventJobPayloadNsnbSideEffect$outboundSchema).optional(),
...
/** @internal */
export const UserEventJobPayload77HeadInfo$inboundSchema = z.object({
    org: types.string(),
    ref: types.string(),
    repo: types.string(),
    repoId: types.number(),
...
/** @internal */
export const UserEventJobPayload77HeadInfo$outboundSchema = z.object({
    org: z.string(),
    ref: z.string(),
    repo: z.string(),
    repoId: z.number(),
...
export function userEventJobPayload77HeadInfoToJSON(userEventJobPayload77HeadInfo) {
    return JSON.stringify(UserEventJobPayload77HeadInfo$outboundSchema.parse(userEventJobPayload77HeadInfo));
}
export function userEventJobPayload77HeadInfoFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload77HeadInfo$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload77HeadInfo' from JSON`);
}
/** @internal */
export const UserEventJobPayload77GitComments$inboundSchema = z.object({
    onPullRequest: types.boolean(),
    onCommit: types.boolean(),
});
/** @internal */
export const UserEventJobPayload77GitComments$outboundSchema = z.object({
    onPullRequest: z.boolean(),
    onCommit: z.boolean(),
});
export function userEventJobPayload77GitCommentsToJSON(userEventJobPayload77GitComments) {
    return JSON.stringify(UserEventJobPayload77GitComments$outboundSchema.parse(userEventJobPayload77GitComments));
}
export function userEventJobPayload77GitCommentsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobPayload77GitComments$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobPayload77GitComments' from JSON`);
}
/** @internal */
export const UserEventJobPayload77Provider$inboundSchema = z.nativeEnum(UserEventJobPayload77Provider);
/** @internal */
export const UserEventJobPayload77Provider$outboundSchema = UserEventJobPayload77Provider$inboundSchema;
/** @internal */
export const Job5$inboundSchema = z
    ...
    gitComments: types.optional(z.lazy(() => UserEventJobPayload77GitComments$inboundSchema)),
...
/** @internal */
export const UserEventJobPayloadAction$inboundSchema = z.nativeEnum(UserEventJobPayloadAction);
/** @internal */
export const UserEventJobPayloadAction$outboundSchema = UserEventJobPayloadAction$inboundSchema;
/** @internal */
export const UserEventJobNsnbSideEffect$inboundSchema = z.object({
    action: UserEventJobPayloadAction$inboundSchema,
    gitUserLogin: types.string(),
});
/** @internal */
export const UserEventJobNsnbSideEffect$outboundSchema = z.object({
    action: UserEventJobPayloadAction$outboundSchema,
    gitUserLogin: z.string(),
});
export function userEventJobNsnbSideEffectToJSON(userEventJobNsnbSideEffect) {
    return JSON.stringify(UserEventJobNsnbSideEffect$outboundSchema.parse(userEventJobNsnbSideEffect));
}
export function userEventJobNsnbSideEffectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventJobNsnbSideEffect$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventJobNsnbSideEffect' from JSON`);
}
/** @internal */
...
export const Job4$inboundSchema = z
    ...
    nsnbSideEffect: types.optional(z.lazy(() => UserEventJobNsnbSideEffect$inboundSchema)),
...
/** @internal */
export const UserEventJobAction$inboundSchema = z.nativeEnum(UserEventJobAction);
/** @internal */
export const UserEventJobAction$outboundSchema = UserEventJobAction$inboundSchema;
/** @internal */
export const JobNsnbSideEffect$inboundSchema = z.object({
    action: UserEventJobAction$inboundSchema,
    gitUserLogin: types.string(),
});
/** @internal */
export const JobNsnbSideEffect$outboundSchema = z.object({
    action: UserEventJobAction$outboundSchema,
    gitUserLogin: z.string(),
});
export function jobNsnbSideEffectToJSON(jobNsnbSideEffect) {
    return JSON.stringify(JobNsnbSideEffect$outboundSchema.parse(jobNsnbSideEffect));
}
export function jobNsnbSideEffectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => JobNsnbSideEffect$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'JobNsnbSideEffect' from JSON`);
}
/** @internal */
...
export const Job3$inboundSchema = z
    ...
    nsnbSideEffect: types.optional(z.lazy(() => JobNsnbSideEffect$inboundSchema)),
    committerGitUserId: types.optional(types.number()),
    committerGitUserType: types.optional(types.string()),
    createdAt: types.optional(types.number()),
    forceNew: types.optional(types.boolean()),
...
/** @internal */
export const JobAction$inboundSchema = z
    .nativeEnum(JobAction);
/** @internal */
export const JobAction$outboundSchema = JobAction$inboundSchema;
/** @internal */
export const NsnbSideEffect$inboundSchema = z.object({
    action: JobAction$inboundSchema,
    gitUserLogin: types.string(),
});
/** @internal */
export const NsnbSideEffect$outboundSchema = z.object({
    action: JobAction$outboundSchema,
    gitUserLogin: z.string(),
});
export function nsnbSideEffectToJSON(nsnbSideEffect) {
    return JSON.stringify(NsnbSideEffect$outboundSchema.parse(nsnbSideEffect));
}
export function nsnbSideEffectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => NsnbSideEffect$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'NsnbSideEffect' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventJobPayload771Provider$inboundSchema = z.nativeEnum(UserEventJobPayload771Provider);
/** @internal */
export const UserEventJobPayload771Provider$outboundSchema = UserEventJobPayload771Provider$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayloadAllowListedReadyStateReasonInternal$inboundSchema = z.nativeEnum(UserEventPayloadAllowListedReadyStateReasonInternal);
/** @internal */
export const UserEventPayloadAllowListedReadyStateReasonInternal$outboundSchema = UserEventPayloadAllowListedReadyStateReasonInternal$inboundSchema;
/** @internal */
export const UserEventPayloadDeployment$inboundSchema = z.object({
    ...
    allowListedReadyStateReasonInternal: types.optional(UserEventPayloadAllowListedReadyStateReasonInternal$inboundSchema),
});
/** @internal */
export const UserEventPayloadDeployment$outboundSchema = z.object({
    ...
    allowListedReadyStateReasonInternal: UserEventPayloadAllowListedReadyStateReasonInternal$outboundSchema
        .optional(),
});
...
export const SeventySix$outboundSchema = z.object({
    ...
    target: z.nullable(z.string()).optional(),
    deployment: z.nullable(z.lazy(() => UserEventPayloadDeployment$outboundSchema)).optional(),
    url: z.string(),
    forced: z.boolean().optional(),
    deploymentId: z.string().optional(),
...
/** @internal */
export const UserEventPayload74Project$inboundSchema = z.object({
    name: types.string(),
});
/** @internal */
export const UserEventPayload74Project$outboundSchema = z.object({
    name: z.string(),
});
export function userEventPayload74ProjectToJSON(userEventPayload74Project) {
    return JSON.stringify(UserEventPayload74Project$outboundSchema.parse(userEventPayload74Project));
}
export function userEventPayload74ProjectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload74Project$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload74Project' from JSON`);
}
/** @internal */
...
/** @internal */
export const SubjectType$inboundSchema = z
    .nativeEnum(SubjectType);
/** @internal */
export const SubjectType$outboundSchema = SubjectType$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload62Team$inboundSchema = z.object({
    id: types.string(),
    name: types.string(),
});
/** @internal */
export const UserEventPayload62Team$outboundSchema = z.object({
    id: z.string(),
    name: z.string(),
});
export function userEventPayload62TeamToJSON(userEventPayload62Team) {
    return JSON.stringify(UserEventPayload62Team$outboundSchema.parse(userEventPayload62Team));
}
export function userEventPayload62TeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload62Team$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload62Team' from JSON`);
}
/** @internal */
export const UserEventPayload62Configuration$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload62Configuration$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload62ConfigurationToJSON(userEventPayload62Configuration) {
    return JSON.stringify(UserEventPayload62Configuration$outboundSchema.parse(userEventPayload62Configuration));
}
export function userEventPayload62ConfigurationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload62Configuration$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload62Configuration' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload61Configuration$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload61Configuration$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload61ConfigurationToJSON(userEventPayload61Configuration) {
    return JSON.stringify(UserEventPayload61Configuration$outboundSchema.parse(userEventPayload61Configuration));
}
export function userEventPayload61ConfigurationFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload61Configuration$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload61Configuration' from JSON`);
}
/** @internal */
export const UserEventPayload61Project$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload61Project$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload61ProjectToJSON(userEventPayload61Project) {
    return JSON.stringify(UserEventPayload61Project$outboundSchema.parse(userEventPayload61Project));
}
export function userEventPayload61ProjectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload61Project$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload61Project' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload60Project$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload60Project$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload60ProjectToJSON(userEventPayload60Project) {
    return JSON.stringify(UserEventPayload60Project$outboundSchema.parse(userEventPayload60Project));
}
export function userEventPayload60ProjectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload60Project$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload60Project' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload59Team$inboundSchema = z.object({
    id: types.string(),
    name: types.string(),
});
/** @internal */
export const UserEventPayload59Team$outboundSchema = z.object({
    id: z.string(),
    name: z.string(),
});
export function userEventPayload59TeamToJSON(userEventPayload59Team) {
    return JSON.stringify(UserEventPayload59Team$outboundSchema.parse(userEventPayload59Team));
}
export function userEventPayload59TeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload59Team$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload59Team' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload59Project$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload59Project$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload59ProjectToJSON(userEventPayload59Project) {
    return JSON.stringify(UserEventPayload59Project$outboundSchema.parse(userEventPayload59Project));
}
export function userEventPayload59ProjectFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload59Project$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload59Project' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload47Action$inboundSchema = z.nativeEnum(UserEventPayload47Action);
/** @internal */
export const UserEventPayload47Action$outboundSchema = UserEventPayload47Action$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload46Action$inboundSchema = z.nativeEnum(UserEventPayload46Action);
/** @internal */
export const UserEventPayload46Action$outboundSchema = UserEventPayload46Action$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload45Action$inboundSchema = z.nativeEnum(UserEventPayload45Action);
/** @internal */
export const UserEventPayload45Action$outboundSchema = UserEventPayload45Action$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload35Type$inboundSchema = z.nativeEnum(UserEventPayload35Type);
/** @internal */
export const UserEventPayload35Type$outboundSchema = UserEventPayload35Type$inboundSchema;
/** @internal */
export const UserEventPayload35ResourcesType$inboundSchema = z.nativeEnum(UserEventPayload35ResourcesType);
/** @internal */
export const UserEventPayload35ResourcesType$outboundSchema = UserEventPayload35ResourcesType$inboundSchema;
/** @internal */
