...
/** @internal */
export const SegmentCmpOptions$outboundSchema = z.object({
    ignoreCase: z.boolean().optional(),
});
export function segmentCmpOptionsToJSON(segmentCmpOptions) {
    return JSON.stringify(SegmentCmpOptions$outboundSchema.parse(segmentCmpOptions));
}
