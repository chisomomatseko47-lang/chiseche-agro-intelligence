...
/** @internal */
export const RequestBody14$inboundSchema = z.object({
    action: types.string(),
    id: types.optional(types.string()),
    value: types.optional(z.any()),
});
/** @internal */
export const RequestBody14$outboundSchema = z.object({
    action: z.string(),
    id: z.string().optional(),
    value: z.any().optional(),
});
export function requestBody14ToJSON(requestBody14) {
    return JSON.stringify(RequestBody14$outboundSchema.parse(requestBody14));
}
export function requestBody14FromJSON(jsonString) {
    return safeParse(jsonString, (x) => RequestBody14$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'RequestBody14' from JSON`);
}
/** @internal */
...
/** @internal */
export const UpdateFirewallConfigRequestBodyLogHeaders$inboundSchema = smartUnion([types.string(), z.array(types.string())]);
/** @internal */
export const UpdateFirewallConfigRequestBodyLogHeaders$outboundSchema = smartUnion([z.string(), z.array(z.string())]);
export function updateFirewallConfigRequestBodyLogHeadersToJSON(updateFirewallConfigRequestBodyLogHeaders) {
    return JSON.stringify(UpdateFirewallConfigRequestBodyLogHeaders$outboundSchema.parse(updateFirewallConfigRequestBodyLogHeaders));
}
export function updateFirewallConfigRequestBodyLogHeadersFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UpdateFirewallConfigRequestBodyLogHeaders$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UpdateFirewallConfigRequestBodyLogHeaders' from JSON`);
}
/** @internal */
