...
/** @internal */
export declare const UpdateFlagSegmentCmpOptions$inboundSchema: z.ZodType<UpdateFlagSegmentCmpOptions, z.ZodTypeDef, unknown>;
/** @internal */
export type UpdateFlagSegmentCmpOptions$Outbound = {
    ignoreCase?: boolean | undefined;
};
/** @internal */
export declare const UpdateFlagSegmentCmpOptions$outboundSchema: z.ZodType<UpdateFlagSegmentCmpOptions$Outbound, z.ZodTypeDef, UpdateFlagSegmentCmpOptions>;
export declare function updateFlagSegmentCmpOptionsToJSON(updateFlagSegmentCmpOptions: UpdateFlagSegmentCmpOptions): string;
export declare function updateFlagSegmentCmpOptionsFromJSON(jsonString: string): SafeParseResult<UpdateFlagSegmentCmpOptions, SDKValidationError>;
/** @internal */
