...
export type UpdateSharedEnvVariableRequestBody = {
     ...
     */
    updates: {
        [k: string]: UpdateSharedEnvVariableUpdates;
    };
};
...
/** @internal */
export declare const UpdateSharedEnvVariableUpdates$inboundSchema: z.ZodType<UpdateSharedEnvVariableUpdates, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UpdateSharedEnvVariableUpdates$outboundSchema: z.ZodType<UpdateSharedEnvVariableUpdates$Outbound, z.ZodTypeDef, UpdateSharedEnvVariableUpdates>;
export declare function updateSharedEnvVariableUpdatesToJSON(updateSharedEnvVariableUpdates: UpdateSharedEnvVariableUpdates): string;
export declare function updateSharedEnvVariableUpdatesFromJSON(jsonString: string): SafeParseResult<UpdateSharedEnvVariableUpdates, SDKValidationError>;
/** @internal */
...
export type UpdateSharedEnvVariableRequestBody$Outbound = {
    updates: {
        [k: string]: UpdateSharedEnvVariableUpdates$Outbound;
    };
};
/** @internal */
