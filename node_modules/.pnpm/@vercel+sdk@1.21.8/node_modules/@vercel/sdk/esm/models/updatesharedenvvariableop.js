...
/** @internal */
export const UpdateSharedEnvVariableUpdates$inboundSchema = z.object({
...
/** @internal */
export const UpdateSharedEnvVariableUpdates$outboundSchema = z.object({
...
export function updateSharedEnvVariableUpdatesToJSON(updateSharedEnvVariableUpdates) {
    return JSON.stringify(UpdateSharedEnvVariableUpdates$outboundSchema.parse(updateSharedEnvVariableUpdates));
}
export function updateSharedEnvVariableUpdatesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UpdateSharedEnvVariableUpdates$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UpdateSharedEnvVariableUpdates' from JSON`);
}
/** @internal */
...
export const UpdateSharedEnvVariableRequestBody$outboundSchema = z.object({
    updates: z.record(z.lazy(() => UpdateSharedEnvVariableUpdates$outboundSchema)),
});
