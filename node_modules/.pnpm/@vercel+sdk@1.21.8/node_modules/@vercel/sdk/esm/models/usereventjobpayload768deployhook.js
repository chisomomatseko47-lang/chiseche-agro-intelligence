...
import { Abuse$inboundSchema, Abuse$outboundSchema, AnalyticsUsage$inboundSchema, AnalyticsUsage$outboundSchema, Artifacts$inboundSchema, Artifacts$outboundSchema, Bandwidth$inboundSchema, Bandwidth$outboundSchema, BlobTotalAdvancedRequests$inboundSchema, BlobTotalAdvancedRequests$outboundSchema, BlobTotalAvgSizeInBytes$inboundSchema, BlobTotalAvgSizeInBytes$outboundSchema, BlobTotalGetResponseObjectSizeInBytes$inboundSchema, BlobTotalGetResponseObjectSizeInBytes$outboundSchema, BlobTotalSimpleRequests$inboundSchema, BlobTotalSimpleRequests$outboundSchema, ConnectDataTransfer$inboundSchema, ConnectDataTransfer$outboundSchema, Credentials$inboundSchema, Credentials$outboundSchema, DataCacheRead$inboundSchema, DataCacheRead$outboundSchema, DataCacheWrite$inboundSchema, DataCacheWrite$outboundSchema, EdgeConfigRead$inboundSchema, EdgeConfigRead$outboundSchema, EdgeConfigWrite$inboundSchema, EdgeConfigWrite$outboundSchema, EdgeFunctionExecutionUnits$inboundSchema, EdgeFunctionExecutionUnits$outboundSchema, EdgeMiddlewareInvocations$inboundSchema, EdgeMiddlewareInvocations$outboundSchema, EdgeRequest$inboundSchema, EdgeRequest$outboundSchema, EdgeRequestAdditionalCpuDuration$inboundSchema, EdgeRequestAdditionalCpuDuration$outboundSchema, ElasticConcurrencyBuildSlots$inboundSchema, ElasticConcurrencyBuildSlots$outboundSchema, EmailNotifications$inboundSchema, EmailNotifications$outboundSchema, FastDataTransfer$inboundSchema, FastDataTransfer$outboundSchema, FastOriginTransfer$inboundSchema, FastOriginTransfer$outboundSchema, FluidCpuDuration$inboundSchema, FluidCpuDuration$outboundSchema, PayloadActiveDashboardViews$inboundSchema, PayloadActiveDashboardViews$outboundSchema, PayloadBilling$inboundSchema, PayloadBilling$outboundSchema, PayloadDataCache$inboundSchema, PayloadDataCache$outboundSchema, PayloadDismissedToasts$inboundSchema, PayloadDismissedToasts$outboundSchema, PayloadFavoriteProjectsAndSpaces$inboundSchema, PayloadFavoriteProjectsAndSpaces$outboundSchema, PayloadImportFlowGitNamespace$inboundSchema, PayloadImportFlowGitNamespace$outboundSchema, PayloadImportFlowGitNamespaceId$inboundSchema, PayloadImportFlowGitNamespaceId$outboundSchema, PayloadImportFlowGitProvider$inboundSchema, PayloadImportFlowGitProvider$outboundSchema, PayloadPreferredScopesAndGitNamespaces$inboundSchema, PayloadPreferredScopesAndGitNamespaces$outboundSchema, PayloadResourceConfig$inboundSchema, PayloadResourceConfig$outboundSchema, PayloadSiftRoute$inboundSchema, PayloadSiftRoute$outboundSchema, PayloadSoftBlock$inboundSchema, PayloadSoftBlock$outboundSchema, PreventAutoBlocking$inboundSchema, PreventAutoBlocking$outboundSchema, ResourceLimits$inboundSchema, ResourceLimits$outboundSchema, SecondaryEmails$inboundSchema, SecondaryEmails$outboundSchema, SiftScores$inboundSchema, SiftScores$outboundSchema, Teams$inboundSchema, Teams$outboundSchema, UsageAlerts$inboundSchema, UsageAlerts$outboundSchema, UserEventPayload122Type$inboundSchema, UserEventPayload122Type$outboundSchema, UserEventPayloadRemoteCaching$inboundSchema, UserEventPayloadRemoteCaching$outboundSchema, } from "./fluidcpuduration.js";
/**
...
export const OverageUsageAlerts$inboundSchema = z.object({
    ...
    blobTotalAdvancedRequests: types.optional(BlobTotalAdvancedRequests$inboundSchema),
    blobTotalAvgSizeInBytes: types.optional(BlobTotalAvgSizeInBytes$inboundSchema),
    blobTotalGetResponseObjectSizeInBytes: types.optional(BlobTotalGetResponseObjectSizeInBytes$inboundSchema),
    blobTotalSimpleRequests: types.optional(BlobTotalSimpleRequests$inboundSchema),
    ...
    edgeFunctionExecutionUnits: types.optional(EdgeFunctionExecutionUnits$inboundSchema),
    edgeMiddlewareInvocations: types.optional(EdgeMiddlewareInvocations$inboundSchema),
    edgeRequestAdditionalCpuDuration: types.optional(EdgeRequestAdditionalCpuDuration$inboundSchema),
    edgeRequest: types.optional(EdgeRequest$inboundSchema),
    elasticConcurrencyBuildSlots: types.optional(ElasticConcurrencyBuildSlots$inboundSchema),
...
export const OverageUsageAlerts$outboundSchema = z.object({
    ...
    blobTotalGetResponseObjectSizeInBytes: BlobTotalGetResponseObjectSizeInBytes$outboundSchema.optional(),
    ...
    edgeMiddlewareInvocations: EdgeMiddlewareInvocations$outboundSchema
        .optional(),
    edgeRequestAdditionalCpuDuration: EdgeRequestAdditionalCpuDuration$outboundSchema.optional(),
...
/** @internal */
export const UserEventPayload122BlockReason$inboundSchema = z.nativeEnum(UserEventPayload122BlockReason);
/** @internal */
export const UserEventPayload122BlockReason$outboundSchema = UserEventPayload122BlockReason$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload122NewOwnerBlockReason$inboundSchema = z.nativeEnum(UserEventPayload122NewOwnerBlockReason);
/** @internal */
export const UserEventPayload122NewOwnerBlockReason$outboundSchema = UserEventPayload122NewOwnerBlockReason$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksBlockReason$inboundSchema = z.nativeEnum(UserEventPayload122NewOwnerFeatureBlocksBlockReason);
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksBlockReason$outboundSchema = UserEventPayload122NewOwnerFeatureBlocksBlockReason$inboundSchema;
/** @internal */
export const PayloadSourceImages$inboundSchema = z.object({
    updatedAt: types.number(),
    blockedFrom: types.optional(types.number()),
    blockedUntil: types.optional(types.number()),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksBlockReason$inboundSchema,
});
/** @internal */
export const PayloadSourceImages$outboundSchema = z.object({
    ...
    blockedFrom: z.number().optional(),
    blockedUntil: z.number().optional(),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema = z.nativeEnum(UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason);
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$outboundSchema = UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema;
/** @internal */
export const MicrofrontendsRequest$inboundSchema = z.object({
    updatedAt: types.number(),
    blockedFrom: types.optional(types.number()),
    blockedUntil: types.optional(types.number()),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema,
});
/** @internal */
export const MicrofrontendsRequest$outboundSchema = z.object({
    ...
    blockedFrom: z.number().optional(),
    blockedUntil: z.number().optional(),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema = z.nativeEnum(UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason);
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason$outboundSchema = UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema;
/** @internal */
export const WorkflowStorage$inboundSchema = z.object({
    updatedAt: types.number(),
    blockedFrom: types.optional(types.number()),
    blockedUntil: types.optional(types.number()),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema,
});
/** @internal */
export const WorkflowStorage$outboundSchema = z.object({
    ...
    blockedFrom: z.number().optional(),
    blockedUntil: z.number().optional(),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema = z.nativeEnum(UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason);
/** @internal */
export const UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason$outboundSchema = UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema;
/** @internal */
export const WorkflowStep$inboundSchema = z.object({
    updatedAt: types.number(),
    blockedFrom: types.optional(types.number()),
    blockedUntil: types.optional(types.number()),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema,
});
/** @internal */
export const WorkflowStep$outboundSchema = z.object({
    ...
    blockedFrom: z.number().optional(),
    blockedUntil: z.number().optional(),
    blockReason: UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload122NewOwnerAction$inboundSchema = z.nativeEnum(UserEventPayload122NewOwnerAction);
/** @internal */
export const UserEventPayload122NewOwnerAction$outboundSchema = UserEventPayload122NewOwnerAction$inboundSchema;
/** @internal */
...
export const NewOwner$outboundSchema = z.object({
    ...
    favoriteProjectsAndSpaces: z.array(PayloadFavoriteProjectsAndSpaces$outboundSchema).optional(),
    email: z.string(),
    id: z.string(),
    importFlowGitNamespace: z.nullable(PayloadImportFlowGitNamespace$outboundSchema).optional(),
    importFlowGitNamespaceId: z.nullable(PayloadImportFlowGitNamespaceId$outboundSchema).optional(),
    importFlowGitProvider: z.nullable(PayloadImportFlowGitProvider$outboundSchema)
        .optional(),
    preferredScopesAndGitNamespaces: z.array(PayloadPreferredScopesAndGitNamespaces$outboundSchema).optional(),
...
/** @internal */
export const UserEventPayload120Action$inboundSchema = z.nativeEnum(UserEventPayload120Action);
/** @internal */
export const UserEventPayload120Action$outboundSchema = UserEventPayload120Action$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload119Action$inboundSchema = z.nativeEnum(UserEventPayload119Action);
/** @internal */
export const UserEventPayload119Action$outboundSchema = UserEventPayload119Action$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload118Action$inboundSchema = z.nativeEnum(UserEventPayload118Action);
/** @internal */
export const UserEventPayload118Action$outboundSchema = UserEventPayload118Action$inboundSchema;
/** @internal */
...
/** @internal */
export const ConfigVersion$outboundSchema = smartUnion([z.string(), z.number()]);
export function configVersionToJSON(configVersion) {
...
/** @internal */
export const UserEventPayload113NewEnvVarType$inboundSchema = z.nativeEnum(UserEventPayload113NewEnvVarType);
/** @internal */
export const UserEventPayload113NewEnvVarType$outboundSchema = UserEventPayload113NewEnvVarType$inboundSchema;
/** @internal */
export const UserEventPayload113Target$inboundSchema = z.nativeEnum(UserEventPayload113Target);
/** @internal */
export const UserEventPayload113Target$outboundSchema = UserEventPayload113Target$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload110Team$inboundSchema = z.object({
    id: types.string(),
    name: types.optional(types.string()),
});
/** @internal */
export const UserEventPayload110Team$outboundSchema = z.object({
    id: z.string(),
    name: z.string().optional(),
});
export function userEventPayload110TeamToJSON(userEventPayload110Team) {
    return JSON.stringify(UserEventPayload110Team$outboundSchema.parse(userEventPayload110Team));
}
export function userEventPayload110TeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload110Team$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload110Team' from JSON`);
}
/** @internal */
...
/** @internal */
export const UserEventPayload105ToAccountType$inboundSchema = z.nativeEnum(UserEventPayload105ToAccountType);
/** @internal */
export const UserEventPayload105ToAccountType$outboundSchema = UserEventPayload105ToAccountType$inboundSchema;
/** @internal */
...
/** @internal */
export const UserEventPayload86OldTeam$inboundSchema = z.object({
    name: types.string(),
});
/** @internal */
export const UserEventPayload86OldTeam$outboundSchema = z.object({
    name: z.string(),
});
export function userEventPayload86OldTeamToJSON(userEventPayload86OldTeam) {
    return JSON.stringify(UserEventPayload86OldTeam$outboundSchema.parse(userEventPayload86OldTeam));
}
export function userEventPayload86OldTeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload86OldTeam$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload86OldTeam' from JSON`);
}
/** @internal */
export const UserEventPayload86NewTeam$inboundSchema = z.object({
    name: types.string(),
});
/** @internal */
export const UserEventPayload86NewTeam$outboundSchema = z.object({
    name: z.string(),
});
export function userEventPayload86NewTeamToJSON(userEventPayload86NewTeam) {
    return JSON.stringify(UserEventPayload86NewTeam$outboundSchema.parse(userEventPayload86NewTeam));
}
export function userEventPayload86NewTeamFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload86NewTeam$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload86NewTeam' from JSON`);
}
/** @internal */
export const EightySix$inboundSchema = z.object({
    name: types.string(),
    oldTeam: types.optional(z.lazy(() => UserEventPayload86OldTeam$inboundSchema)),
    newTeam: types.optional(z.lazy(() => UserEventPayload86NewTeam$inboundSchema)),
});
/** @internal */
...
/** @internal */
export const UserEventPayload79Deployment$inboundSchema = z.object({
    id: types.string(),
    name: types.string(),
...
/** @internal */
export const UserEventPayload79Deployment$outboundSchema = z.object({
    id: z.string(),
    name: z.string(),
    meta: z.record(z.string()),
    url: z.string(),
});
export function userEventPayload79DeploymentToJSON(userEventPayload79Deployment) {
    return JSON.stringify(UserEventPayload79Deployment$outboundSchema.parse(userEventPayload79Deployment));
}
export function userEventPayload79DeploymentFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UserEventPayload79Deployment$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEventPayload79Deployment' from JSON`);
}
/** @internal */
...
//# sourceMappingURL=usereventjobpayload768deployhook.js.map