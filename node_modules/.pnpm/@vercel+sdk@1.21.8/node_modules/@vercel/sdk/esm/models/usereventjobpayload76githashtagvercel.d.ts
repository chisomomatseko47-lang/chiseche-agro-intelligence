...
import { Abuse, Abuse$Outbound, AnalyticsUsage, AnalyticsUsage$Outbound, Artifacts, Artifacts$Outbound, Bandwidth, Bandwidth$Outbound, BlobTotalAdvancedRequests, BlobTotalAdvancedRequests$Outbound, BlobTotalAvgSizeInBytes, BlobTotalAvgSizeInBytes$Outbound, BlobTotalGetResponseObjectSizeInBytes, BlobTotalGetResponseObjectSizeInBytes$Outbound, BlobTotalSimpleRequests, BlobTotalSimpleRequests$Outbound, ConnectDataTransfer, ConnectDataTransfer$Outbound, Credentials, Credentials$Outbound, DataCacheRead, DataCacheRead$Outbound, DataCacheWrite, DataCacheWrite$Outbound, EdgeConfigRead, EdgeConfigRead$Outbound, EdgeConfigWrite, EdgeConfigWrite$Outbound, EdgeFunctionExecutionUnits, EdgeFunctionExecutionUnits$Outbound, EdgeMiddlewareInvocations, EdgeMiddlewareInvocations$Outbound, EdgeRequest, EdgeRequest$Outbound, EdgeRequestAdditionalCpuDuration, EdgeRequestAdditionalCpuDuration$Outbound, ElasticConcurrencyBuildSlots, ElasticConcurrencyBuildSlots$Outbound, EmailNotifications, EmailNotifications$Outbound, FastDataTransfer, FastDataTransfer$Outbound, FastOriginTransfer, FastOriginTransfer$Outbound, FluidCpuDuration, FluidCpuDuration$Outbound, FluidDuration, FluidDuration$Outbound, PayloadActiveDashboardViews, PayloadActiveDashboardViews$Outbound, PayloadBilling, PayloadBilling$Outbound, PayloadDataCache, PayloadDataCache$Outbound, PayloadDismissedToasts, PayloadDismissedToasts$Outbound, PayloadFavoriteProjectsAndSpaces, PayloadFavoriteProjectsAndSpaces$Outbound, PayloadImportFlowGitNamespace, PayloadImportFlowGitNamespace$Outbound, PayloadImportFlowGitNamespaceId, PayloadImportFlowGitNamespaceId$Outbound, PayloadImportFlowGitProvider, PayloadPreferredScopesAndGitNamespaces, PayloadPreferredScopesAndGitNamespaces$Outbound, PayloadResourceConfig, PayloadResourceConfig$Outbound, PayloadSiftRoute, PayloadSiftRoute$Outbound, PayloadSoftBlock, PayloadSoftBlock$Outbound, PreventAutoBlocking, PreventAutoBlocking$Outbound, ResourceLimits, ResourceLimits$Outbound, SecondaryEmails, SecondaryEmails$Outbound, SiftScores, SiftScores$Outbound, Teams, Teams$Outbound, UsageAlerts, UsageAlerts$Outbound, UserEventPayload122Type, UserEventPayloadRemoteCaching, UserEventPayloadRemoteCaching$Outbound } from "./fluidduration.js";
...
export declare const UserEventPayload122BlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
    readonly HardBlocked: "hard_blocked";
};
export type UserEventPayload122BlockReason = ClosedEnum<typeof UserEventPayload122BlockReason>;
...
export declare const UserEventPayload122NewOwnerBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
    readonly HardBlocked: "hard_blocked";
};
export type UserEventPayload122NewOwnerBlockReason = ClosedEnum<typeof UserEventPayload122NewOwnerBlockReason>;
...
export declare const UserEventPayload122NewOwnerFeatureBlocksBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
    readonly HardBlocked: "hard_blocked";
};
export type UserEventPayload122NewOwnerFeatureBlocksBlockReason = ClosedEnum<typeof UserEventPayload122NewOwnerFeatureBlocksBlockReason>;
...
export declare const UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
    readonly HardBlocked: "hard_blocked";
};
export type UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason = ClosedEnum<typeof UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason>;
export type MicrofrontendsRequest = {
    updatedAt: number;
    blockedFrom?: number | undefined;
    blockedUntil?: number | undefined;
    blockReason: UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason;
};
export declare const UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
    readonly HardBlocked: "hard_blocked";
};
export type UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason = ClosedEnum<typeof UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason>;
export type WorkflowStorage = {
    updatedAt: number;
    blockedFrom?: number | undefined;
    blockedUntil?: number | undefined;
    blockReason: UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason;
};
export declare const UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
    readonly HardBlocked: "hard_blocked";
};
export type UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason = ClosedEnum<typeof UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason>;
 ...
 */
export declare const UserEventPayload122NewOwnerAction: {
 ...
 * The action that occurred
 */
export type UserEventPayload122NewOwnerAction = ClosedEnum<typeof UserEventPayload122NewOwnerAction>;
/**
...
export declare const UserEventPayload120Action: {
    readonly Enable: "enable";
    readonly Disable: "disable";
};
export type UserEventPayload120Action = ClosedEnum<typeof UserEventPayload120Action>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload119Action: {
    readonly Log: "log";
    readonly Challenge: "challenge";
    readonly Deny: "deny";
};
export type UserEventPayload119Action = ClosedEnum<typeof UserEventPayload119Action>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload118Action: {
    readonly Log: "log";
    readonly Challenge: "challenge";
    readonly Deny: "deny";
};
export type UserEventPayload118Action = ClosedEnum<typeof UserEventPayload118Action>;
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export declare const UserEventPayload113NewEnvVarType: {
    readonly System: "system";
    readonly Encrypted: "encrypted";
    readonly Plain: "plain";
    readonly Sensitive: "sensitive";
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload113NewEnvVarType = ClosedEnum<typeof UserEventPayload113NewEnvVarType>;
/**
 * environments this env variable targets
 */
export declare const UserEventPayload113Target: {
    readonly Production: "production";
    readonly Preview: "preview";
    readonly Development: "development";
};
 ...
 * environments this env variable targets
 */
export type UserEventPayload113Target = ClosedEnum<typeof UserEventPayload113Target>;
...
export declare const UserEventPayload105ToAccountType: {
    readonly User: "user";
    readonly Team: "team";
};
export type UserEventPayload105ToAccountType = ClosedEnum<typeof UserEventPayload105ToAccountType>;
...
/** @internal */
export declare const UserEventPayload122BlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122BlockReason>;
/** @internal */
export declare const UserEventPayload122BlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122BlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122NewOwnerBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerBlockReason>;
/** @internal */
export declare const UserEventPayload122NewOwnerBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksBlockReason>;
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason>;
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason>;
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksWorkflowStorageBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason>;
/** @internal */
export declare const UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerFeatureBlocksWorkflowStepBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122NewOwnerAction$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerAction>;
/** @internal */
export declare const UserEventPayload122NewOwnerAction$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload122NewOwnerAction>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload120Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload120Action>;
/** @internal */
export declare const UserEventPayload120Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload120Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload119Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload119Action>;
/** @internal */
export declare const UserEventPayload119Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload119Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload118Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload118Action>;
/** @internal */
export declare const UserEventPayload118Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload118Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload113NewEnvVarType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload113NewEnvVarType>;
/** @internal */
export declare const UserEventPayload113NewEnvVarType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload113NewEnvVarType>;
/** @internal */
export declare const UserEventPayload113Target$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload113Target>;
/** @internal */
export declare const UserEventPayload113Target$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload113Target>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload110Team$inboundSchema: z.ZodType<UserEventPayload110Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload110Team$outboundSchema: z.ZodType<UserEventPayload110Team$Outbound, z.ZodTypeDef, UserEventPayload110Team>;
export declare function userEventPayload110TeamToJSON(userEventPayload110Team: UserEventPayload110Team): string;
export declare function userEventPayload110TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload110Team, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload105ToAccountType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload105ToAccountType>;
/** @internal */
export declare const UserEventPayload105ToAccountType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload105ToAccountType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload86OldTeam$inboundSchema: z.ZodType<UserEventPayload86OldTeam, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload86OldTeam$Outbound = {
    name: string;
};
/** @internal */
export declare const UserEventPayload86OldTeam$outboundSchema: z.ZodType<UserEventPayload86OldTeam$Outbound, z.ZodTypeDef, UserEventPayload86OldTeam>;
export declare function userEventPayload86OldTeamToJSON(userEventPayload86OldTeam: UserEventPayload86OldTeam): string;
export declare function userEventPayload86OldTeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload86OldTeam, SDKValidationError>;
/** @internal */
export declare const UserEventPayload86NewTeam$inboundSchema: z.ZodType<UserEventPayload86NewTeam, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload86NewTeam$Outbound = {
    name: string;
};
/** @internal */
export declare const UserEventPayload86NewTeam$outboundSchema: z.ZodType<UserEventPayload86NewTeam$Outbound, z.ZodTypeDef, UserEventPayload86NewTeam>;
export declare function userEventPayload86NewTeamToJSON(userEventPayload86NewTeam: UserEventPayload86NewTeam): string;
export declare function userEventPayload86NewTeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload86NewTeam, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload79Deployment$inboundSchema: z.ZodType<UserEventPayload79Deployment, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload79Deployment$outboundSchema: z.ZodType<UserEventPayload79Deployment$Outbound, z.ZodTypeDef, UserEventPayload79Deployment>;
export declare function userEventPayload79DeploymentToJSON(userEventPayload79Deployment: UserEventPayload79Deployment): string;
export declare function userEventPayload79DeploymentFromJSON(jsonString: string): SafeParseResult<UserEventPayload79Deployment, SDKValidationError>;
/** @internal */
...
//# sourceMappingURL=usereventjobpayload76githashtagvercel.d.ts.map