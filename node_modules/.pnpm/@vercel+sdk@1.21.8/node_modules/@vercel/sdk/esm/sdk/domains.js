...
export class Domains extends ClientSDK {
     ...
     */
    async getDomainVerificationRecord(request, options) {
        return unwrapAsync(domainsGetDomainVerificationRecord(this, request, options));
    }
    /**
     ...
     */
    async claimDomainOwnership(request, options) {
        return unwrapAsync(domainsClaimDomainOwnership(this, request, options));
    }
    /**
