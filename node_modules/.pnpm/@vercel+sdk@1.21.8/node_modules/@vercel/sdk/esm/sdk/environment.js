...
export class Environment extends ClientSDK {
     ...
     */
    async getProjectsByIdOrNameCustomEnvironments(request, options) {
        return unwrapAsync(environmentGetProjectsByIdOrNameCustomEnvironments(this, request, options));
    }
    /**
