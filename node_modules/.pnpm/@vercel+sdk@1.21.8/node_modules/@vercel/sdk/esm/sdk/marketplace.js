...
export class Marketplace extends ClientSDK {
     ...
     * When the user enabled Edge Config syncing, then this endpoint can be used by the partner to fetch the contents of the Edge Config.
     */
    async getInstallationsByIntegrationConfigurationIdResourcesByResourceIdExperimentationEdgeConfig(request, options) {
        return unwrapAsync(marketplaceGetInstallationsByIntegrationConfigurationIdResourcesByResourceIdExperimentationEdgeConfig(this, request, options));
    }
    /**
